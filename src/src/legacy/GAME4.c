...
LABEL_37:
	...
	if (*(uint32_t*)(a1 + 136) && nox_crypt_IsReadOnly() == 1 &&
...
int nox_xxx_XFerAmmo_4F6B20(int* a1) {
	...
	LABEL_17:
		if (a1[34] && nox_crypt_IsReadOnly() == 1 && !nox_xxx_xfer_4F3E30(v16, (int)a1, a1[34])) {
			return 0;
		}
		a1[34] = v17;
		result = 1;
...
int nox_xxx_XFerTeam_4F6D20(int* a1) {
	...
	if (result) {
		...
		if (!a1[34] || nox_crypt_IsReadOnly() != 1 || (result = nox_xxx_xfer_4F3E30(v9, (int)a1, a1[34])) != 0) {
			a1[34] = v10;
			result = 1;
		}
	}
...
int nox_xxx_XFerObelisk_4F6F60(int* a1) {
	...
	if (result) {
		...
		if (!v1[34] || nox_crypt_IsReadOnly() != 1 || (result = nox_xxx_xfer_4F3E30(v8, (int)v1, v1[34])) != 0) {
			v1[34] = v3;
			result = 1;
		}
	}
	...
	if ((short)v23 <= 63) {
		...
		if ((short)v23 > 0) {
			if (nox_xxx_mapReadWriteObjData_4F4530(a1, (short)v23)) {
				...
				if (!a1[34] || nox_crypt_IsReadOnly() != 1 || nox_xxx_xfer_4F3E30(v23, (int)a1, a1[34])) {
					a1[34] = v24;
					return 1;
				}
			}
	...
	if (!(*(uint8_t*)(*(uint32_t*)(v3 + 276) + 3680) & 3)) {
		...
		if (v4) {
			...
			*(uint32_t*)(v3 + 4 * *(unsigned char*)(v3 + 180) + 168) =
			...
			nox_xxx_createAt_4DAA50(*(uint32_t*)(v3 + 4 * *(unsigned char*)(v3 + 180) + 168), a1, *(unaligned_float*)&a2,
									*(unaligned_float*)&a3);
		}
	}
}
				...
				if (*(unsigned short*)(v9 + 4) == dword_5d4594_1568868 && sub_4F7CE0(v9, v16)) {
					...
					for (i = nox_xxx_getFirstPlayerUnit_4DA7C0(); i; i = nox_xxx_getNextPlayerUnit_4DA7F0(i)) {
						if (i != a2 && nox_xxx_unitIsEnemyTo_5330C0(a2, i)) {
							v11 = *(unaligned_float*)(v9 + 56) - *(unaligned_float*)(i + 56);
							v12 = *(unaligned_float*)(v9 + 60) - *(unaligned_float*)(i + 60);
							v13 = v12 * v12 + v11 * v11;
							if (v13 < v15) {
								v15 = v13;
							}
	...
	if (a1) {
		...
		if (!nox_common_gameFlags_check_40A5C0(4096) || (v1 = (char*)v3[137]) == 0) {
			...
			if (!dword_5d4594_2650652 || *(uint32_t*)(v2 + 58)) {
				nox_xxx_respawnPlayerImpl_53FBC0((unaligned_float*)(a1 + 56), *(short*)(a1 + 124));
			}
			v5 = *(unaligned_float*)(a1 + 60);
			v9.field_0 = *(unaligned_float*)(a1 + 56);
			v9.field_4 = v5;
...
int sub_4F9AB0(nox_object_t* a1p) {
	...
	v7.field_0 = *(unaligned_float*)(v2 + 56) - *(unaligned_float*)(a1 + 56);
	v4 = *(unaligned_float*)(v2 + 60) - *(unaligned_float*)(a1 + 60);
	v7.field_4 = v4;
	if (v4 * v7.field_4 + v7.field_0 * v7.field_0 >= 100.0) {
		*(uint16_t*)(a1 + 126) = nox_xxx_math_509ED0(&v7);
		...
		v5 = 8 * *(short*)(a1 + 126);
		*(unaligned_float*)(a1 + 88) = *getMemFloatPtr(0x587000, 194136 + v5) * *(unaligned_float*)(a1 + 544) + *(unaligned_float*)(a1 + 88);
		v6 = *getMemFloatPtr(0x587000, 194140 + v5) * *(unaligned_float*)(a1 + 544);
		result = 1;
		*(unaligned_float*)(a1 + 92) = v6 + *(unaligned_float*)(a1 + 92);
	} else {
...
int nox_xxx_unitGetStrength_4F9FD0(int a1) {
	...
	v1 = *(uint32_t*)(a1 + 8);
	if (v1 & 4) {
		return *(unaligned_u32*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) + 2239);
	}
	if (!(v1 & 2)) {
		return 0;
	}
...
int nox_xxx_playerDoSchedSpell_4FB0E0(nox_object_t* a1p, nox_object_t* a2p) {
	...
	v7[0] = a2;
	*(unaligned_float*)&v7[1] = (double)*(int*)(v3 + 220);
	*(unaligned_float*)&v7[2] = (double)*(int*)(v3 + 224);
	if (a1) {
...
int nox_xxx_playerDoSchedSpellQueue_4FB1D0(nox_object_t* a1p, nox_object_t* a2p) {
	...
	v5[0] = a2;
	*(unaligned_float*)&v5[1] = (double)*(int*)(v3 + 220);
	*(unaligned_float*)&v5[2] = (double)*(int*)(v3 + 224);
	if (a1) {
		nox_xxx_netInformTextMsg_4DA0F0(*(unsigned char*)(*(uint32_t*)(v3 + 276) + 2064), 0, &a1);
		nox_xxx_aud_501960(231, (int)v2, 0, 0);
	} else {
...
uint32_t* nox_xxx_createSpellFly_4FDDA0(nox_object_t* a1p, nox_object_t* a2p, int a3) {
	...
	v3 = a1;
	a2a = *(unaligned_float*)(a1 + 176) + 4.0;
	if (!a2) {
		if (*(uint8_t*)(v3 + 8) & 4) {
			v4 = *(uint32_t*)(v3 + 748);
			*(unaligned_float*)&v21.field_0 = (double)*(int*)(*(uint32_t*)(v4 + 276) + 2284);
			*(unaligned_float*)&v21.field_4 = (double)*(int*)(*(uint32_t*)(v4 + 276) + 2288);
	...
	v22.field_0 = *(unaligned_float*)(v3 + 56);
	v9 = v8 + *(unaligned_float*)(v3 + 56);
	v10 = a2a * *getMemFloatPtr(0x587000, 194140 + v6);
	v22.field_4 = v7;
	v22.field_C = v10 + *(unaligned_float*)(v3 + 60);
	v22.field_8 = v9 + *(unaligned_float*)(v3 + 80);
	v22.field_C = v22.field_C + *(unaligned_float*)(v3 + 84);
	...
	if (result) {
		...
		if (result) {
			...
			*v13 = v3;
			...
			v15 = *((short*)v12 + 62);
			*((unaligned_float*)v12 + 20) = *getMemFloatPtr(0x587000, 194136 + 8 * v15) * *((unaligned_float*)v12 + 136);
			*((unaligned_float*)v12 + 21) = *getMemFloatPtr(0x587000, 194140 + 8 * v15) * *((unaligned_float*)v12 + 136);
			*((unaligned_float*)v12 + 20) = *((unaligned_float*)v12 + 20) + *(unaligned_float*)(v3 + 80);
			*((unaligned_float*)v12 + 21) = *((unaligned_float*)v12 + 21) + *(unaligned_float*)(v3 + 84);
...
int nox_xxx_spellGetPhoneme_4FE1C0(int a1, char a2) {
	...
	} else if ((((uint32_t*)nox_xxx_netSpriteByCodeDynamic_45A6F0(a1))[28] & 4) == 0) {
		switch (a2) {
		case 0:
			return 193;
		case 1:
	...
	if (dword_5d4594_1569672) {
		...
		do {
			...
			if (((*(uint8_t*)(v4 + 8) & 4) != 4 || !nox_xxx_servCompareTeams_419150(v3 + 48, v4 + 48)) &&
				(v5 = *(uint32_t*)(v2 + 4), v6 = *(unaligned_float*)(v5 + 56) - *(unaligned_float*)(v3 + 56),
				 v7 = *(unaligned_float*)(v5 + 60) - *(unaligned_float*)(v3 + 60), sqrt(v7 * v7 + v6 * v6) + 0.1 < a2) &&
...
int sub_4FEA70(int a1, float2* a2) {
	...
	v2 = a2->field_0 - *(unaligned_float*)(a1 + 56);
	if (v2 < 0.0) {
		v2 = -v2;
	}
	v5 = v2;
	v3 = a2->field_4 - *(unaligned_float*)(a1 + 60);
	if (v3 < 0.0) {
		v3 = -v3;
	}
...
void nox_xxx_updateUnitBuffs_4FF620(nox_object_t* a1p) {
	...
	if (*(uint32_t*)(a1 + 340)) {
		...
		if (nox_xxx_testUnitBuffs_4FF350(a1, 9)) {
			*(unaligned_float*)(a1 + 544) = *(unaligned_float*)(a1 + 544) * 1.25;
		}
	}
}
...
int nox_xxx_summonStart_500DA0(int a1) {
	...
	uint16_t nameId = nox_xxx_getNameId_4E3AA0(v6);
	memcpy(v17, &nameId, 2);
	uint16_t fxId = (*getMemU16Ptr(0x5D4594, 1570276))++;
	if (*getMemU16Ptr(0x5D4594, 1570276) >= 0xFDE8u) {
		*getMemU16Ptr(0x5D4594, 1570276) = 0;
	}
	memcpy(&v17[11], &fxId, 2);
	v17[13] = 0;

	uint32_t tmp32;
	memcpy(&tmp32, &v17[0], 4);
	*(uint32_t*)(a1 + 72) = tmp32;
	memcpy(&tmp32, &v17[4], 4);
	*(uint32_t*)(a1 + 76) = tmp32;
	memcpy(&tmp32, &v17[8], 4);
	*(uint32_t*)(a1 + 80) = tmp32;
	uint16_t tmp16;
	memcpy(&tmp16, &v17[12], 2);
	*(uint16_t*)(a1 + 84) = tmp16;
...
LABEL_22:
	...
	*(uint32_t*)(a1 + 68) = v13;
	int16_t fxIdParam = 0;
	memcpy(&fxIdParam, &v17[11], 2);
	int16_t nameIdParam = 0;
	memcpy(&nameIdParam, v17, 2);
	nox_xxx_sendSummonStartFX_5236F0(fxIdParam, (unaligned_float*)&v17[2], v14, nameIdParam, v16);
	return 0;
}
...
int sub_500F40(int a1, float a2) {
	...
	if (*(uint8_t*)(v3 + 8) & 4) {
		...
		v19.field_8 = *(unaligned_float*)(a1 + 52);
		v19.field_C = v6;
		v7 = v19.field_8 - v19.field_0;
		v19.field_4 = v5;
		v8 = v6 - v5;
		*(unaligned_float*)&a1 = v8;
		v9 = sqrt(v8 * *(unaligned_float*)&a1 + v7 * v7);
		a2 = v9;
		if (v9 > 50.0) {
			v19.field_8 = v7 * 50.0 / a2 + v19.field_0;
			v19.field_C = *(unaligned_float*)&a1 * 50.0 / a2 + v19.field_4;
		}
		if (nox_xxx_mapTraceRay_535250(&v19, 0, 0, 9) && !nox_xxx_mapTileAllowTeleport_411A90((float2*)&v19.field_8)) {
			v10 = v19.field_C;
			uint32_t val8 = LODWORD(v19.field_8);
			memcpy((void*)LODWORD(v4), &val8, 4);
			memcpy((void*)(LODWORD(v4) + 4), &v10, 4);
			return 1;
		}
		v12 = v2[4];
		if (*(uint8_t*)(v12 + 8) & 4) {
	...
	v19.field_0 = *(unaligned_float*)(v3 + 56);
	v14 = *(unaligned_float*)(v3 + 60);
	v15 = *(unaligned_float*)(a1 + 52);
	v16 = *(unaligned_float*)(a1 + 56);
	v19.field_4 = v14;
	v19.field_8 = v15;
	v19.field_C = v16;
	if (nox_xxx_mapTraceRay_535250(&v19, 0, 0, 9)) {
		memcpy((void*)LODWORD(v4), &v2[13], 4);
		memcpy((void*)(LODWORD(v4) + 4), &v2[14], 4);
		result = 1;
	} else {
		v17 = v2[4];
		uint32_t val56 = *(uint32_t*)(v17 + 56);
		memcpy((void*)LODWORD(v4), &val56, 4);
		v18 = *(uint32_t*)(v17 + 60);
		result = 1;
		memcpy((void*)(LODWORD(v4) + 4), &v18, 4);
	}
	return result;
}
...
void nox_xxx_netUpdateRemotePlr_501CA0(nox_object_t* a1p) {
	...
	if (!(*(uint8_t*)(v3 + 3680) & 3) || (v4 = *(uint32_t*)(v3 + 3628)) == 0) {
		...
		v6 = nox_float2int(*(unaligned_float*)(*(uint32_t*)(v3 + 3628) + 56));
		v7 = *(uint32_t*)(v2 + 276);
		v17.field_0 = v6;
		v17.field_4 = nox_float2int(*(unaligned_float*)(*(uint32_t*)(v7 + 3628) + 60));
		...
		if (result) {
			...
			if (v8 == -889266515) {
				while (1) {
					...
					*(unaligned_float*)(dword_5d4594_1599576 + 76 * dword_5d4594_1599596 + 64) = v9;
					*(unaligned_float*)(dword_5d4594_1599576 + 76 * (dword_5d4594_1599596)++ + 68) = v10;
...
double sub_502E70(int a1) {
	...
	if (a1 < 0 || a1 >= *(int*)&dword_5d4594_1599596) {
		...
		result = *(unaligned_float*)(dword_5d4594_1599576 + 76 * a1 + 64);
	}
	return result;
}
...
double sub_502EA0(int a1) {
	...
	if (a1 < 0 || a1 >= *(int*)&dword_5d4594_1599596) {
		...
		result = *(unaligned_float*)(dword_5d4594_1599576 + 76 * a1 + 68);
	}
	return result;
}
...
int sub_503B30(float2* a1) {
	...
	if (result) {
		...
		v13.field_0 = *(unaligned_float*)(dword_5d4594_1599576 + 76 * v2 + 64) + a1->field_0;
		v13.field_4 = *(unaligned_float*)(dword_5d4594_1599576 + 76 * v2 + 68) + a1->field_4;
		nox_xxx_mapGenFixCoords_4D3D90(&v13, &v14);
		v18[4] = (long long)v14.field_0;
		v18[5] = (long long)v14.field_4;
		v3 = *(unaligned_float*)(dword_5d4594_1599576 + 76 * dword_5d4594_3835396 + 64) + a1->field_0;
		...
		v13.field_0 = v4;
		v13.field_4 = *(unaligned_float*)(dword_5d4594_1599576 + 76 * dword_5d4594_3835396 + 68) + a1->field_4;
		nox_xxx_mapGenFixCoords_4D3D90(&v13, &v14);
	...
	if (result) {
		...
		*v4 = v5;
		if (v5) {
			...
			*((unaligned_float*)v4 + 1) = v6;
			v8 = (double)a2 * 46.0;
			*((unaligned_float*)v4 + 2) = v8;
			result = v4;
			if (v7) {
				*((unaligned_float*)v4 + 1) = v6 + 23.0;
			} else {
				*((unaligned_float*)v4 + 2) = v8 + 23.0;
			}
		} else {
			free(v4);
			result = 0;
...
int nox_xxx_tileInit_504150(int a1, int a2) {
	...
	if (dword_5d4594_1599556) {
		...
		v10 = (double)a2;
		do {
			a1a.field_0 = v9 + *(unaligned_float*)(v5 + 4);
			a1a.field_4 = v10 + *(unaligned_float*)(v5 + 8);
	...
	if (result) {
		...
		*v4 = v5;
		if (v5) {
			...
			*(uint32_t*)*v4 = a1;
			*(unaligned_float*)(*v4 + 8) = a2;
			*(unaligned_float*)(*v4 + 12) = a3;
			*(uint32_t*)(*v4 + 488) = 0;
			v6 = (uint32_t*)v4[1];
			if (v6) {
				*(uint32_t*)(*v4 + 484) = *v6;
...
int sub_504560(int a1, int a2) {
	...
	if (dword_5d4594_1599548) {
		...
		v5 = (double)a2;
		do {
			*(unaligned_float*)(*v2 + 8) = v4 + *(unaligned_float*)(*v2 + 8);
			*(unaligned_float*)(*v2 + 12) = v5 + *(unaligned_float*)(*v2 + 12);
			sub_579E90(*v2);
			v2 = (int*)v2[1];
		} while (v2);
	}
...
int sub_504910(int a1, int a2) {
	...
	if (dword_5d4594_1599540) {
		...
		v5 = (double)a2;
		do {
			*(unaligned_float*)(*v2 + 56) = v4 + *(unaligned_float*)(*v2 + 56);
			*(unaligned_float*)(*v2 + 60) = v5 + *(unaligned_float*)(*v2 + 60);
			nox_xxx_createAt_4DAA50(*v2, 0, *(unaligned_float*)(*v2 + 56), *(unaligned_float*)(*v2 + 60));
...
int nox_server_mapRWWaypoints_506260(uint32_t* a1) {
	...
	v19 = 0;
	v2 = (unaligned_float*)nox_xxx_waypointGetList_579860();
	if (v2) {
		do {
			v3 = a1;
			if (!a1 ||
			...
			v2 = (unaligned_float*)nox_xxx_waypointNext_579870((int)v2);
		} while (v2);
	} else {
		v3 = a1;
	}
	...
	do {
		if (!v3 || (v26.field_0 = (long long)*((unaligned_float*)v4 + 2), v26.field_4 = (long long)*((unaligned_float*)v4 + 3),
...
int sub_5096F0() {
	...
	do {
		v5 = *(uint32_t*)(v4 + 748);
		if (v5) {
			*(uint16_t*)&v6[1] = (long long)*(unaligned_float*)(*(uint32_t*)(v5 + 276) + 3632);
			*(uint16_t*)&v6[3] = (long long)*(unaligned_float*)(*(uint32_t*)(v5 + 276) + 3636);
