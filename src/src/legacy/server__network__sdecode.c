...
int nox_xxx_netOnPacketRecvServ_51BAD0_net_sdecode_switch(int a1, unsigned char* data, int dsz, nox_playerInfo* v8p, nox_object_t* unitp, void* v10p) {
	...
	case 0x40u: // MSG_PLAYER_SET_WAYPOINT
		v84 = (double)*(unaligned_uint16*)(data + 5);
		v83 = (double)*(unaligned_uint16*)(data + 3);
		nox_xxx_playerSetCustomWP_4F79A0(unit, SLODWORD(v83), SLODWORD(v84));
		return 7;
	case 0x72u: // MSG_TRY_DROP
		v19 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		...
		if (!(*(uint8_t*)(v7 + 3680) & 3) && !*(uint32_t*)(v85 + 280) && !*(uint32_t*)(v85 + 284) &&
			...
			if (v20) {
				v21 = *(unaligned_uint16*)(data + 5);
				v94.field_0 = (double)*(unaligned_uint16*)(data + 3);
	...
	case 0x73u: // MSG_TRY_GET
		v22 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		if (!nox_xxx_gameGet_4DB1B0()) {
			...
			if (!((*(uint8_t*)(v7 + 3680) & 3) || (*(uint32_t*)(v85 + 280)) || (*(uint32_t*)(v85 + 284)) ||
				...
				if (v23) {
					...
					if (v24 + *(unsigned char*)(v23 + 488) <= *(unaligned_uint16*)(unit + 490)) {
	...
	case 0x74u: // MSG_TRY_USE
		v26 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		if (!nox_xxx_gameGet_4DB1B0()) {
	...
	case 0x75u: // MSG_TRY_EQUIP
		v15 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		if (!nox_xxx_gameGet_4DB1B0()) {
	...
	case 0x76u: // MSG_TRY_DEQUIP
		v17 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		if (!(*(uint8_t*)(*(uint32_t*)(v85 + 276) + 3680) & 3)) {
	...
	case 0x78: // MSG_TRY_CREATURE_COMMAND
		v31 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		v7 = v85;
		if (!(*(uint8_t*)(*(uint32_t*)(v85 + 276) + 3680) & 1)) {
			if (*(unaligned_uint16*)(data + 1)) {
	...
	case 0x7Bu: // MSG_TRY_COLLIDE
		v28 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		v7 = v85;
	...
	case 0xA5u: // MSG_NEW_ALIAS
		...
		*(uint16_t*)(v8 + 8 * data[1] + 18) = *((uint16_t*)data + 2);
		v14 = data[1];
		v7 = *(unaligned_uint32*)(data + 6);
		*(uint32_t*)(v8 + 8 * v14 + 20) = v7;
		return 10;
	case 0xE0u: // MSG_REPORT_SECONDARY_WEAPON
		v58 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
		if (*(unaligned_uint16*)(data + 1)) {
	...
	case 0xE2u: // MSG_INFO_BOOK_DATA
		v60 = nox_xxx_packetDynamicUnitCode_578B40(*(unaligned_uint16*)(data + 1));
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
			nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		}
	...
	case 0xC9u: // MSG_TRADE
		...
		case 0xEu:
			...
			return 2;
		case 0xFu:
			v67 = nox_xxx_packetDynamicUnitCode_578B40(*((unaligned_uint16*)data + 1));
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
				nox_xxx_netTestHighBit_578B70(*((unaligned_uint16*)data + 1));
			}
			...
			if (v68) {
				...
				if (v69) {
					if (nox_xxx_tradeP2PAddOffer2_50F820_trade(v69, unit, (int)v68) == 1) {
						sub_4ED0C0(unit, v68);
					}
				}
			}
			...
			return 4;
		case 0x10u:
			v70 = nox_xxx_packetDynamicUnitCode_578B40(*((unaligned_uint16*)data + 1));
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG)) {
				nox_xxx_netTestHighBit_578B70(*((unaligned_uint16*)data + 1));
			}
		...
		case 0x15u:
			if (!nox_xxx_gameGet_4DB1B0() && !(*(uint8_t*)(v10[69] + 3680) & 3)) {
				v64 = nox_xxx_packetDynamicUnitCode_578B40(*((unaligned_uint16*)data + 1));
		...
		case 0x16u:
			v72 = (uint32_t*)v10[70];
			if (v72) {
				sub_5100C0_trade(unit, v72, *((unaligned_uint16*)data + 1));
			}
			return 4;
		case 0x17u:
			v73 = v10[70];
			if (v73) {
				sub_510640_trade(unit, v73, *((unaligned_uint16*)data + 1), (unaligned_float*)data[4]);
			}
			return 5;
		case 0x18u:
			v74 = v10[70];
			if (v74) {
				sub_510BE0_trade((int*)unit, v74, (uint32_t*)*((unaligned_uint16*)data + 1));
			}
			return 4;
		case 0x19u:
			v76 = v10[70];
			if (v76) {
				sub_510D10((int*)unit, v76, *((unaligned_uint16*)data + 1), data[4]);
			}
			return 5;
		case 0x1Au:
			v75 = v10[70];
			if (v75) {
				sub_510AE0((int*)unit, v75, (uint32_t*)*((unaligned_uint16*)data + 1));
			}
			return 4;
		case 0x1Cu:
			v77 = v10[70];
			if (v77) {
				sub_5109C0_trade((int*)unit, v77, (uint32_t*)*((unaligned_uint16*)data + 1));
			}
			return 4;
		case 0x1Eu:
			v78 = v10[70];
			if (v78) {
				sub_5108D0(unit, v78, *((unaligned_uint16*)data + 1));
			}
			return 4;
		default:
			return -1;
	...
	case 0xF1u: // MSG_INVENTORY_FAIL
		v63 = (uint32_t*)nox_xxx_equipedItemByCode_4F7920(unit, *(unaligned_uint16*)(data + 1));
		if (v63) {
