...
#define uint32_t unaligned_uint32
#define int32_t  unaligned_int32
#define uint16_t unaligned_uint16
#define int16_t  unaligned_int16
#define uint64_t unaligned_uint64
#define int64_t  unaligned_int64
#endif
...
int nox_xxx_netOnPacketRecvCli_48EA70_switch(int a1, int op, unsigned char* data, int sz) {
	...
	wchar2_t v386[256];      // [esp+F0h] [ebp-1660h] (was 20, caused stack overflow)
	wchar2_t v387[256];      // [esp+118h] [ebp-1638h] (was 20, nox_wcsncpy copies 256 elements into it!)
	...
	case 47: // MSG_SIMPLE_OBJ
		...
		if (nox_client_isConnected_43C700()) {
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ADDITIONAL_NETWORK_TEST)) {
				nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
			}
			LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), *(unaligned_uint16*)(data + 1),
													  *(unaligned_uint16*)(data + 5), *(unaligned_uint16*)(data + 7));
			if ((uint32_t)v5) {
				k = gameFrame();
	...
	case 48: // MSG_COMPLEX_OBJ
		...
		if (*(uint16_t*)(data + 3) || *(uint16_t*)(data + 1)) {
			...
			if (*(unaligned_uint16*)(data + 1) == nox_player_netCode_85319C && sub_416120(9u)) {
				nox_xxx_cliUpdateCameraPos_435600(*(unaligned_uint16*)(data + 5), *(unaligned_uint16*)(data + 7));
			}
		} else {
			nox_xxx_cliUpdateCameraPos_435600(*(unaligned_uint16*)(data + 5), *(unaligned_uint16*)(data + 7));
	...
	case 50: // MSG_OBJECT_OUT_OF_SIGHT
		...
		LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1))
		...
		v53 = nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1));
		v331 = v51;
		if (v53) {
	...
	case 55: // MSG_ENABLE_OBJECT
		...
		if (nox_client_isConnected_43C700()) {
			...
			if (nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1))) {
	...
	case 65: // MSG_REPORT_HEALTH
		...
		if (!nox_xxx_unitSpriteCheckAlly_4951F0(*(unaligned_uint16*)(data + 1))) {
			return 4;
		}
		sub_495150(*(unaligned_uint16*)(data + 1), 2 * *(unsigned char*)(data + 3));
		return 4;
	case 66: // MSG_REPORT_HEALTH_DELTA
		...
		nox_xxx_cliAddHealthChange_49A650(*(unaligned_uint16*)(data + 1), *(uint16_t*)(data + 3));
		return 5;
	case 67: // MSG_REPORT_PLAYER_HEALTH
		if (nox_client_isConnected_43C700()) {
			sub_470CB0(*(unaligned_int16*)(data + 1));
		}
		return 3;
	...
	case 69: // MSG_REPORT_MANA
		...
		nox_xxx_cliSetMana_470D10(*(unaligned_uint16*)(data + 3));
		return 5;
	...
	case 72: // MSG_REPORT_STATS
		...
		if (nox_client_isConnected_43C700()) {
			...
			if (v100 == nox_player_netCode_85319C) {
				...
				if (!v101 && v99) {
					*(unaligned_u32*)(v99 + 2247) = *(unaligned_uint16*)(data + 3);
					*(unaligned_u32*)(v99 + 2243) = *(unaligned_uint16*)(data + 5);
					LOWORD(v101) = *(uint16_t*)(data + 9);
					v332 = (double)v101;
					*(unaligned_u32*)(v99 + 2235) = nox_float2int(v332);
					*(unaligned_u32*)(v99 + 2239) = *(unaligned_uint16*)(data + 11);
	...
	case 75: // MSG_REPORT_PICKUP
		...
		*(uint32_t*)&v381[8] = 0;
		*(uint32_t*)&v381[12] = 0;
		if (nox_xxx_spritePickup_461660(v104, *(unaligned_uint16*)(data + 3), v381)) {
			return 5;
		}
	...
	case 76: // MSG_REPORT_MODIFIABLE_PICKUP
		...
		*(uint16_t*)&v385[16] = -1;
		*(uint16_t*)&v385[18] = -1;
		if (nox_xxx_spritePickup_461660(v106, *(unaligned_uint16*)(data + 3), v385)) {
			return 9;
		}
	...
	case 80: // MSG_REPORT_MUNDANE_WEAPON_EQUIP
		...
		*(uint16_t*)(data + 1) = v5 & 0x7FFF;
		if ((((unsigned int)v5 >> 15) & 1) == 1) {
			nox_xxx_clientEquipWeaponArmor_417AA0(*(uint8_t*)data, *(unaligned_uint16*)(data + 1),
												  *(uint32_t*)(data + 3), (int)&v367);
		} else {
			nox_xxx_clientEquip_49A3D0(*(uint8_t*)data, *(unaligned_uint16*)(data + 1), *(uint32_t*)(data + 3),
									   (int)&v367);
		}
		return 7;
	...
	case 84: // MSG_REPORT_WEAPON_DEQUIP
		...
		sub_417B80(*(uint8_t*)data, *(unaligned_uint16*)(data + 1), *(uint32_t*)(data + 3));
		return 7;
		...
		if (nox_client_isConnected_43C700()) {
			...
			if (v142) {
				if (!nox_common_gameFlags_check_40A5C0(1) && gameFrame() > *((uint32_t*)v142 + 540)) {
					HIWORD(v5) = 0;
					*((uint32_t*)v142 + 538) = *(unaligned_uint16*)(data + 3);
	...
	case 86: // MSG_REPORT_FLAG_BALL_WINNER
		v144 = nox_xxx_getTeamByID_418AB0(*(unaligned_uint16*)(data + 1));
		if (!nox_client_isConnected_43C700()) {
			return 8;
		}
	...
	case 87: // MSG_REPORT_FLAG_WINNER
		v172 = nox_xxx_getTeamByID_418AB0(*(unaligned_uint16*)(data + 1));
		if (!nox_client_isConnected_43C700()) {
			return 8;
		}
	...
	case 89: // MSG_REPORT_DEATHMATCH_TEAM_WINNER
		v160 = nox_xxx_getTeamByID_418AB0(*(unaligned_uint16*)(data + 1));
		if (!nox_client_isConnected_43C700()) {
			return 8;
		}
		k = dword_5d4594_1200804;
	...
	case 93: // MSG_REPORT_LIGHT_INTENSITY
		...
		nox_xxx_spriteChangeIntensity_484D70_light_intensity(v5 + 136, *(unaligned_float*)(data + 3));
		return 7;
	...
	case 104: // MSG_REPORT_STAT_MODIFIER
		...
		if (v83 == nox_player_netCode_85319C) {
			...
			sub_467470(k, *(unaligned_float*)(data + 3));
		}
		return 8;
	case 105: // MSG_REPORT_NPC
		if (nox_client_isConnected_43C700()) {
			...
			*(uint16_t*)(data + 1) = v285;
			...
			if (v288) {
				nox_init_npc(v288, *(unaligned_uint16*)(data + 1));
			} else {
				v288 = nox_new_npc(*(unaligned_uint16*)(data + 1));
			}
			if (v288) {
				k = (int)(v288 + 8);
				v289 = (uint8_t*)(data + 4);
	...
	case 106: // MSG_REPORT_CLIENT_STATUS
		v119 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 1));
		if (!v119) {
			return 7;
		}
		if (!nox_common_gameFlags_check_40A5C0(1)) {
		...
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING) ||
			(HIDWORD(v5) = *(unaligned_uint16*)(data + 1), WORD2(v5) != nox_player_netCode_85319C)) {
			return 7;
		}
	...
	case 108: // MSG_REPORT_ACQUIRE_CREATURE
		...
		*(uint16_t*)(data + 3) = v186;
		nox_xxx_cliSummonCreat_4C2E50(*(unaligned_uint16*)(data + 1), v186, v187 & 0x8000);
		if (nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1))) {
			v188 = nox_xxx_netSpriteByCodeStatic_45A720(v185);
		} else {
			v188 = nox_xxx_netSpriteByCodeDynamic_45A6F0(v185);
		}
		if (v188 || (v188 = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), v185, 0, 0)) != 0) {
			sub_459DD0((int)v188, 1);
		}
		sub_495060(*(unaligned_uint16*)(data + 1), 0, 0);
		return 5;
	case 109: // MSG_REPORT_LOSE_CREATURE
		...
		*(uint16_t*)(data + 1) = v191;
		...
		sub_4950C0(*(unaligned_uint16*)(data + 1));
		v337 = v190;
		if (!nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 1))) {
	...
	case 142: // MSG_FX_CHAIN_LIGHTNING_BOLT
		...
		HIWORD(k) = 0;
		v379.field_0 = *(unaligned_uint16*)(data + 1);
		v379.field_4 = *(unaligned_uint16*)(data + 3);
		...
		if (*(uint8_t*)data == 140 || (uint8_t)v5 == 142) {
			...
			nox_xxx_drawEnergyBolt_499710(*(unaligned_uint16*)(data + 5), *(unaligned_uint16*)(data + 7), 10,
	...
	case 0x7Eu: // MSG_FX_SUMMON
		if (nox_client_isConnected_43C700()) {
			nox_xxx_netHandleSummonPacket_4B7C40(*(uint16_t*)(data + 5), (unaligned_uint16*)(data + 1),
	...
	case 0x80u: // MSG_FX_SHIELD
		if (nox_client_isConnected_43C700()) {
			nox_xxx_fxShield_4B8090(*(unaligned_uint16*)(data + 1), *(unsigned char*)(data + 3));
		}
		return 4;
	case 0x81u: // MSG_FX_BLUE_SPARKS
		...
		nox_xxx_makePointFxCli_499610(*(int*)&dword_5d4594_1200776, 50, 1000, 30, *(unaligned_int16*)(data + 1),
									  *(unaligned_int16*)(data + 3));
		return 5;
	case 0x82u: // MSG_FX_YELLOW_SPARKS
		if (!nox_client_isConnected_43C700()) {
			return 5;
		}
		nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200780), 25, 500, 25, *(unaligned_int16*)(data + 1),
									  *(unaligned_int16*)(data + 3));
		return 5;
	case 0x83u: // MSG_FX_CYAN_SPARKS
		...
		nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200784), 25, 500, 25, *(unaligned_int16*)(data + 1),
									  *(unaligned_int16*)(data + 3));
		return 5;
	case 0x84u: // MSG_FX_VIOLET_SPARKS
		if (nox_client_isConnected_43C700()) {
			nox_xxx_makePointFxCli_499610(*(int*)&dword_5d4594_1200796, 25, 500, 25, *(unaligned_int16*)(data + 1),
										  *(unaligned_int16*)(data + 3));
		}
		return 5;
	...
	case 0xA3u: // MSG_FX_MANA_BOMB_CANCEL
		if (nox_client_isConnected_43C700()) {
			...
			case 133:
				...
				v258 = *(unaligned_int16*)(data + 3);
				LODWORD(v5) = nox_xxx_spriteLoadAdd_45A360_drawable(v257, *(unaligned_int16*)(data + 1), v258);
				if ((uint32_t)v5) {
			...
			case 138:
				...
				v259 = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200900), *(unaligned_int16*)(data + 1),
															 *(unaligned_int16*)(data + 3));
				if (v259) {
				...
				v260 = 6;
				do {
					v341 = *(unaligned_int16*)(data + 3) + nox_common_randomIntMinMax_415FF0(
					...
					v262 = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200896),
																 *(unaligned_int16*)(data + 1) + v261, v341);
					if (v262) {
			...
			case 163:
				...
				for (i = v252 >> 2;; v253 = i) {
					...
					LODWORD(v5) = nox_xxx_spriteLoadAdd_45A360_drawable(
						...
						*(unaligned_int16*)(data + 1) + v254 * *getMemIntPtr(0x587000, 192088 + 8 * v255) / 16,
						*(unaligned_int16*)(data + 3) + v254 * *getMemIntPtr(0x587000, 192092 + 8 * v255) / 16);
					v256 = v5;
					if ((uint32_t)v5) {
	...
	case 0x93u: // MSG_FX_SPARK_EXPLOSION
		...
		v378.field_0 = *(unaligned_int16*)(data + 1);
		v378.field_4 = *(unaligned_int16*)(data + 3);
		...
		LODWORD(v5) = nox_xxx_spriteLoadAdd_45A360_drawable(v235, *(unaligned_int16*)(data + 1), *(unaligned_int16*)(data + 3));
		if ((uint32_t)v5) {
			nox_xxx_sprite_45A110_drawable((uint32_t*)v5);
		}
		return 6;
		...
		if (nox_client_isConnected_43C700()) {
			...
			if (nox_common_randomIntMinMax_415FF0(0, 100, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4987) <
				...
				if (*getMemU32Ptr(0x852978, 8)) {
					v225 = *(unaligned_uint16*)(data + 5) - *(uint32_t*)(*getMemU32Ptr(0x852978, 8) + 12);
					v226 = nox_double2int(
						sqrt((double)(v225 * v225 + (*(unaligned_uint16*)(data + 7) -
													 *(uint32_t*)(*getMemU32Ptr(0x852978, 8) + 16)) *
														(*(unaligned_uint16*)(data + 7) -
														 *(uint32_t*)(*getMemU32Ptr(0x852978, 8) + 16)))));
					if (v226 < 600) {
			...
			if (!nox_xxx_checkGameFlagPause_413A50()) {
				v227 = *(unaligned_uint16*)(data + 5) - *(unaligned_uint16*)(data + 1);
				v228 = *(unaligned_uint16*)(data + 7) - *(unaligned_uint16*)(data + 3);
				v229 = nox_double2int(sqrt((double)(v227 * v227 + v228 * v228)));
				if (!v229) {
					v229 = 1;
				}
				v230 = *(unaligned_uint16*)(data + 5) - 4 * v227 / v229;
				v231 = *(unaligned_uint16*)(data + 7) - 4 * v228 / v229;
		...
		if (nox_client_isConnected_43C700()) {
			...
			do {
				LODWORD(v5) = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200860),
																	*(unaligned_int16*)(data + 1), *(unaligned_int16*)(data + 3));
				v240 = v5;
				if ((uint32_t)v5) {
					if ((uint32_t)v5 != (uint32_t)-432) {
						*(uint32_t*)(v5 + 432) = *(uint32_t*)(v5 + 12) << 12;
	...
	case 0x98u: // MSG_FX_GREEN_BOLT
		...
		if (nox_client_isConnected_43C700()) {
			LODWORD(v5) = nox_xxx_spriteLoadAdd_45A360_drawable(
							  ...
							  *(unaligned_uint16*)(data + 1) +
								  (*(unaligned_uint16*)(data + 5) - *(unaligned_uint16*)(data + 1)) / 2,
							  *(unaligned_uint16*)(data + 3) +
								  (*(unaligned_uint16*)(data + 7) - *(unaligned_uint16*)(data + 3)) / 2) +
						  432;
			*(uint8_t*)v5 = 0;
			*(uint32_t*)(v5 + 5) = *(uint32_t*)(data + 1);
			HIDWORD(v5) = *(uint32_t*)(data + 5);
			*(uint32_t*)(v5 + 9) = HIDWORD(v5);
			k = *(unaligned_uint16*)(data + 9);
			*(uint32_t*)(v5 + 1) = k;
		}
		return 11;
	...
	case 0xA0u: // MSG_FX_TURN_UNDEAD
		...
		nox_xxx_fxDrawTurnUndead_499880((unaligned_int16*)(data + 1));
		return 5;
	case 0xA1u: // MSG_FX_ARROW_TRAP
		...
		v251 = *(unaligned_int16*)(data + 1);
		v339 = *(unaligned_int16*)(data + 3);
		if (*(uint8_t*)(data + 5) == 1) {
	...
	case 0xA7u: // MSG_AUDIO_PLAYER_EVENT
		...
		v338 = *(char*)(data + 1);
		v321 = (*(unaligned_uint16*)(data + 2) >> 9) & 0x7E;
	...
	case 0xB5u: // MSG_CLIENT_PREDICT_LINEAR
		if (nox_client_isConnected_43C700() &&
			(v329 = *(unaligned_uint16*)(data + 7), v320 = *(unaligned_uint16*)(data + 5),
			 v31 = nox_xxx_netClearHighBit_578B30(*(uint16_t*)(data + 1)),
			 LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), v31, v320, v329),
			 (uint32_t)v5)) {
			*(uint16_t*)(v5 + 508) = *(uint16_t*)(data + 9);
			*(unaligned_float*)(v5 + 468) = (double)*(char*)(data + 12) * 0.0625;
			*(unaligned_float*)(v5 + 472) = (double)*(char*)(data + 13) * 0.0625;
			*(unaligned_float*)(v5 + 476) = (double)*(char*)(data + 11) * 0.0625;
			*(uint32_t*)(v5 + 316) = gameFrame();
			*(uint32_t*)(v5 + 324) = *(unaligned_uint16*)(data + 5);
			v32 = *(unaligned_uint16*)(data + 7);
	...
	case 0xC3u: // MSG_PLAYER_OBJ
		...
		if (*(uint16_t*)(data + 3) || *(uint16_t*)(data + 1)) {
			v27 = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), *(unaligned_uint16*)(data + 1),
											  *(unaligned_uint16*)(data + 5), *(unaligned_uint16*)(data + 7));
			if (v27) {
				v27[72] = gameFrame();
			...
			HIDWORD(v5) = *(unaligned_uint16*)(data + 1);
	...
	case 0xC4u: // MSG_TEAM_MSG
		...
		case 0u:
			...
			unsigned int v386_len = *(unsigned char*)(data + 15);
			if (v386_len > 255) v386_len = 255;
			memcpy(v386, (const void*)(data + 18), 2 * v386_len);
			v386[v386_len] = 0;
			if (*(uint8_t*)(data + 17)) {
		...
		case 1u:
			...
			v275 = v274;
			if (nox_client_isConnected_43C700()) {
				if (nox_xxx_netTestHighBit_578B70(*(unaligned_uint16*)(data + 6))) {
					LODWORD(v5) = nox_xxx_netSpriteByCodeStatic_45A720(v275);
				} else {
					LODWORD(v5) = nox_xxx_netSpriteByCodeDynamic_45A6F0(v275);
				}
				if (!(uint32_t)v5) {
					LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 8), v275, 0, 0);
				}
				v276 = v5 + 24;
				if ((uint32_t)v5 != (uint32_t)-24) {
					...
					v277 = v5;
					if ((uint32_t)v5) {
						nox_xxx_createAtImpl_4191D0(*(uint8_t*)(v5 + 57), v276, 0, *(unaligned_uint16*)(data + 6), 0);
						sub_4571A0(*(unaligned_uint16*)(data + 6), *(unsigned char*)(v277 + 57));
					}
				}
			}
			return 10;
		...
		case 3u:
			if (nox_client_isConnected_43C700()) {
				v278 = nox_xxx_objGetTeamByNetCode_418C80(*(unaligned_uint16*)(data + 6));
				if (v278) {
					LODWORD(v5) = nox_xxx_getTeamByID_418AB0(*(uint32_t*)(data + 2));
					v279 = v5;
					if ((uint32_t)v5) {
						if (sub_4196D0((int)v278, v5, *(unaligned_uint16*)(data + 6), 0)) {
							sub_4571A0(*(unaligned_uint16*)(data + 6), *(unsigned char*)(v279 + 57));
						}
					}
				}
			}
		...
		case 0xCu:
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 2));
				if ((uint32_t)v5) {
	...
	case 0xC9u: // MSG_SERVER_QUIT_ACK
		...
		case 8u:
			if (nox_client_isConnected_43C700()) {
				sub_479300(*(unaligned_uint16*)(data + 2), *(unaligned_uint16*)(data + 4), *(uint32_t*)(data + 6),
		...
		case 9u:
			...
			sub_479480(*(unaligned_uint16*)(data + 2));
			return 4;
		case 0xCu:
			if (nox_client_isConnected_43C700()) {
		...
		case 0x1Bu:
			...
			sub_479520(*(unaligned_uint16*)(data + 2));
			return 4;
		case 0x1Du:
			if (nox_client_isConnected_43C700()) {
				sub_4795E0(*(unaligned_uint16*)(data + 2), *(uint32_t*)(data + 4));
			}
			return 8;
		case 0x1Fu:
			if (!nox_client_isConnected_43C700()) {
			...
			sub_479740(*(unaligned_uint16*)(data + 2), *(uint32_t*)(data + 4));
			return 8;
		default:
			return -1;
		}
	...
	case 0xCAu: // MSG_CHAT_KILL
		if (nox_client_isConnected_43C700()) {
			if (*(unaligned_int16*)(data + 1) == -8531) {
				sub_48E940();
			} else {
				sub_48E8E0(*(unaligned_uint16*)(data + 1));
			}
		}
		return 3;
	...
	case 0xD2u: // MSG_INTERESTING_ID
		...
		if (*(uint8_t*)(data + 5) == 1) {
			if ((uint32_t)v5 ||
				(LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), v282, 0, 0),
				 (uint32_t)v5)) {
	...
	case 0xD7u: // MSG_REPORT_ALL_LATENCY
		LODWORD(v5) = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 1));
		if ((uint32_t)v5) {
	...
	case 0xDBu: // MSG_REPORT_MONITOR_CREATURE
		...
		if (nox_client_isConnected_43C700()) {
			...
			if (v195 || (v195 = nox_xxx_spriteCreate_48E970(*(unaligned_uint16*)(data + 3), v194, 0, 0)) != 0) {
	...
	case 0xDDu: // MSG_REPORT_TOTAL_HEALTH
		...
		if (v91 == nox_player_netCode_85319C) {
			nox_xxx_cliSetTotalHealth_470C80(*(unaligned_uint16*)(data + 3), *(unaligned_uint16*)(data + 5));
			return 7;
		} else if (nox_xxx_unitSpriteCheckAlly_4951F0(*(unaligned_uint16*)(data + 1))) {
			sub_495120(*(unaligned_uint16*)(data + 1), *(uint16_t*)(data + 3), *(uint16_t*)(data + 5));
			return 7;
		}
		return 7;
	case 0xDEu: // MSG_REPORT_TOTAL_HEALTH
		...
		nox_xxx_cliSetManaAndMax_470CE0(*(unaligned_uint16*)(data + 3), *(unaligned_uint16*)(data + 5));
		return 7;
	...
	case 0xE8u: // MSG_PLAYER_DIED
		if (nox_client_isConnected_43C700()) {
			...
			if ((uint32_t)v5) {
				...
				v112 = nox_xxx_netSpriteByCodeDynamic_45A6F0(*(unaligned_uint16*)(data + 1));
				if (v112) {
	...
	case 0xF0u: // MSG_GAUNTLET
		...
		case 1u:
			if (nox_client_isConnected_43C700() == 1) {
				...
				v299 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 2));
				if (v299) {
					if (!nox_common_gameFlags_check_40A5C0(1)) {
		...
		case 2u:
			if (nox_client_isConnected_43C700() == 1) {
				sub_49B4B0((unaligned_uint16*)data);
			}
			return 14;
		case 4u:
			if (nox_client_isConnected_43C700()) {
				v300 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 3));
				if (v300) {
					v300[4816] = *(uint8_t*)(data + 2);
				}
				HIDWORD(v5) = *(unaligned_uint16*)(data + 3);
		...
		case 0xFu:
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netSpriteByCodeStatic_45A720(*(unaligned_uint16*)(data + 2));
				if ((uint32_t)v5) {
					*(uint8_t*)(v5 + 432) = 0;
				}
			}
		...
		case 0x10u:
			...
			if (nox_client_isConnected_43C700()) {
				v301 = nox_xxx_spriteLoadAdd_45A360_drawable(
					*getMemIntPtr(0x5D4594, 1200904), *(unaligned_uint16*)(data + 6), *(unaligned_uint16*)(data + 8));
				*(uint8_t*)(v301 + 432) = 0;
				*(uint32_t*)(v301 + 437) = *(uint32_t*)(data + 2);
				*(uint32_t*)(v301 + 441) = *(uint32_t*)(data + 6);
				*(uint32_t*)(v301 + 433) = *(unaligned_uint16*)(data + 10);
				nox_xxx_spriteTransparentDecay_49B950((uint32_t*)v301, *(unaligned_uint16*)(data + 10));
			}
			return 12;
		case 0x11u:
			if (nox_client_isConnected_43C700()) {
				sub_45D320(*(unaligned_uint16*)(data + 2));
			}
			return 4;
		case 0x12u:
			if (!nox_client_isConnected_43C700()) {
			...
			nox_xxx_clientQuestDisableAbility_45D4A0(*(unaligned_uint16*)(data + 2));
			return 4;
		case 0x13u:
			if (!nox_client_isConnected_43C700()) {
				return 4;
			}
			sub_45D400(*(unaligned_uint16*)(data + 2));
			return 4;
		case 0x14u:
		...
		case 0x15u:
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 6));
				if ((uint32_t)v5) {
		...
		case 0x16u:
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 3));
				if ((uint32_t)v5) {
		...
		case 0x19u:
			...
			v302 = (uint32_t*)nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200912),
																	*(unaligned_int16*)(data + 2), *(unaligned_int16*)(data + 4));
			if (v302) {
				nox_xxx_sprite_45A110_drawable(v302);
			}
			if (nox_client_isConnected_43C700()) {
				v380.field_0 = *(unaligned_int16*)(data + 2);
				v380.field_4 = *(unaligned_int16*)(data + 4);
				sub_49A150(&v380, *getMemIntPtr(0x5D4594, 1200908), *(uint8_t*)(data + 6));
			}
			return 7;
		case 0x1Au:
			if (nox_client_isConnected_43C700()) {
				nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200788), 25, 500, 25, *(unaligned_int16*)(data + 2),
											  *(unaligned_int16*)(data + 4));
			}
			return 6;
		case 0x1Cu:
			if (nox_client_isConnected_43C700()) {
		...
		case 0x1Du:
			if (nox_client_isConnected_43C700()) {
				sub_465DE0(*(unaligned_uint16*)(data + 2));
				return 4;
			}
			return 4;
		case 0x1Eu:
			v303 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 3));
			...
			return 5;
		case 0x1Fu:
			v306 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 3));
			...
			return 5;
		case 0x20u:
			v309 = nox_common_playerInfoGetByID_417040(*(unaligned_uint16*)(data + 3));
