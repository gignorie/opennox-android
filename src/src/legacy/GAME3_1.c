...
void sub_4BA670(int a1, int a2, int a3, int a4, int a5) {
	...
	a2a.field_0 = a4;
	a2a.field_4 = v5;
	*(unaligned_float*)&dword_5d4594_1313880 = v12;
	v26 = sqrt(v12 * *(unaligned_float*)&dword_5d4594_1313880 + v11 * v11) + 0.0099999998;
	*getMemFloatPtr(0x5D4594, 1313876) = v11 / v26;
	v13 = *(unaligned_float*)&dword_5d4594_1313880 / v26;
	*(unaligned_float*)&dword_5d4594_1313880 = v13;
...
void sub_4BEAD0(int2* a1, int2* a2, int2* a3, int2* a4, int a5, int a6) {
	...
	*getMemFloatPtr(0x587000, 180484) = v7;
	...
	v17 = 0;
	*(unaligned_float*)&dword_587000_180480 = v7 * v7;
	*(unaligned_float*)&dword_587000_180476 = v7 * v7 * v7;
	*getMemFloatPtr(0x587000, 180496) = *(unaligned_float*)&dword_587000_180480 + *(unaligned_float*)&dword_587000_180480;
	v18 = *(unaligned_float*)&dword_587000_180476 * 6.0;
	...
	*getMemFloatPtr(0x587000, 180508) = v18;
	...
	v46 = (double)v40[0];
	do {
		v25 = v22 * *((unaligned_float*)v16 - 2);
		v26 = v21 * *((unaligned_float*)v16 - 1);
		v16 += 16;
		*(unaligned_float*)((char*)&v40[0] + v17 * 4) = v25 + v26 + v20 * *((unaligned_float*)v16 - 4) + v19 * *((unaligned_float*)v16 - 3);
		++v17;
		*(unaligned_float*)&v40[v17 + 3] =
			v46 * *((unaligned_float*)v16 - 6) + v43 * *((unaligned_float*)v16 - 5) + v24 * *((unaligned_float*)v16 - 4) + v23 * *((unaligned_float*)v16 - 3);
	} while ((int)v16 < (int)getMemAt(0x587000, 180532));
	if (a5 > 0) {
		v47 = a5;
		do {
			*(unaligned_float*)v40 = *(unaligned_float*)v40 + *(unaligned_float*)&v40[1];
			*(unaligned_float*)&v40[1] = *(unaligned_float*)&v40[2] + *(unaligned_float*)&v40[1];
			*(unaligned_float*)&v40[2] = *(unaligned_float*)&v40[3] + *(unaligned_float*)&v40[2];
			*(unaligned_float*)&v40[4] = *(unaligned_float*)&v40[4] + *(unaligned_float*)&v40[5];
			*(unaligned_float*)&v40[5] = *(unaligned_float*)&v40[6] + *(unaligned_float*)&v40[5];
			*(unaligned_float*)&v40[6] = *(unaligned_float*)&v40[7] + *(unaligned_float*)&v40[6];
			v27 = nox_float2int(*(unaligned_float*)v40);
			v28 = nox_float2int(*(unaligned_float*)&v40[4]);
...
int sub_4C3A60(uint32_t* a1, unsigned int a2, unsigned int a3, int a4) {
	if (a2 < 0x13 || a2 > 0x14) {
		return nox_xxx_wndListboxProcWithoutData10_4A28E0(a1, a2, a3, a4);
	} else {
		return 0;
	}
}
...
int sub_4C3FC0(unsigned int a1) {
	const wchar2_t* v6 = nox_xxx_keybind_titleByKeyZero_42EA00(a1);
	if (!v6) {
		return 0;
	}
	if (!dword_5d4594_1321252) {
	...
	if (*(uint16_t*)(v8 + 44) > 0) {
		do {
			const wchar2_t* v9 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1321244, 16406, v7, 0);
			if (!nox_wcscmp(v9, v6)) {
...
int sub_4C4100(unsigned int a1) {
	...
	if (*(uint16_t*)(v3 + 44) > 0) {
		do {
			v4 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1321244, 16406, v2, 0);
			if (!nox_wcscmp(v4, (const wchar2_t*)v1)) {
	...
	if (*(uint16_t*)(v6 + 44) > 0) {
		do {
			v7 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1321248, 16406, v5, 0);
			if (!nox_wcscmp(v7, (const wchar2_t*)v1)) {
		...
		if (!(v15 & 0x40000000) && !(v15 & 1) && (a2[112] & 0x80u) != 0) {
			...
			if (v18 < 0x18u && v18 && (v18 < 8u || v18 > 0x10u)) {
				...
				if (sub_4C5630(v26, v26, v25 - 5)) {
					...
					a1a.field_4 -= 2;
					a2a.field_4 = v27;
				} else if (sub_4C5630(v26, v26, v25 + 5)) {
					v27 = a2a.field_4 + 2;
					a1a.field_4 += 2;
					a2a.field_4 = v27;
				}
			}
			if (!sub_4C42A0(&a1a, &a2a, &a3a, &a4)) {
				return;
			}
		}
	}
	...
	*getMemU32Ptr(0x5D4594, 1321512) = v31;
	...
	if (*((uint32_t*)a2 + 120)) {
		...
		if (*((uint32_t*)v3 + 27) == dword_5d4594_1321520) {
			...
			if (*((uint32_t*)v3 + 30) & 0x4000000) {
				v63 = v38 >> 1;
			}
			nox_client_drawEnableAlpha_434560(1);
			nox_client_drawSetAlpha_434580(v63);
		}
	} else if (*((uint32_t*)a2 + 27) == dword_5d4594_1321520) {
...
int nox_xxx_sprite_4CA540(uint32_t* a1, int a2) {
	...
	v2 = (uint32_t*)a2;
	v3 = 0.0;
	v4 = *(unaligned_float*)(a2 + 468);
	v5 = *(unaligned_float*)(a2 + 472);
	v6 = 0.0;
	v7 = gameFrame() - *(uint32_t*)(a2 + 316) + 1;
	do {
		--v7;
		v13 = -(v5 * *(unaligned_float*)(a2 + 476));
		v4 = v4 - v4 * *(unaligned_float*)(a2 + 476);
		v5 = v5 + v13;
		v3 = v3 + v4;
		v6 = v6 + v5;
	} while (v7);
...
int sub_4CC280(unsigned int a1) {
	...
	if (*(uint16_t*)(v8 + 44) > 0) {
		do {
			const wchar2_t* v9 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1522624, 16406, v7, 0);
			if (!nox_wcscmp(v9, v6)) {
...
int sub_4CC3C0(unsigned int a1) {
	...
	if (*(uint16_t*)(v3 + 44) > 0) {
		do {
			v4 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1522624, 16406, v2, 0);
			if (!nox_wcscmp(v4, (const wchar2_t*)v1)) {
	...
	if (*(uint16_t*)(v6 + 44) > 0) {
		do {
			v7 = (const wchar2_t*)nox_window_call_field_94(*(int*)&dword_5d4594_1522628, 16406, v5, 0);
			if (!nox_wcscmp(v7, (const wchar2_t*)v1)) {
...
int sub_4CCD00(int a1, int a2) {
	...
	for (i = *(uint32_t*)(a2 + 432); i < gameFrame(); ++i) {
		if (*(unaligned_float*)(a2 + 436) > 0.0) {
			*(unaligned_float*)(a2 + 436) = *(unaligned_float*)(a2 + 440) + *(unaligned_float*)(a2 + 436);
			*(unaligned_float*)(a2 + 440) = *(unaligned_float*)(a2 + 440) - 1.0;
		}
		if (*(unaligned_float*)(a2 + 436) <= 0.0) {
			*(uint32_t*)(a2 + 436) = 0;
			*(uint32_t*)(a2 + 440) = 0;
	...
	*(uint16_t*)(a2 + 104) = (long long)*(unaligned_float*)(a2 + 436);
	*(uint8_t*)(a2 + 296) = (long long)*(unaligned_float*)(a2 + 440);
...
int nox_xxx_updDrawFist_4CCDB0(int a1, int a2) {
	...
	for (i = *(uint32_t*)(a2 + 432); i < gameFrame(); ++i) {
		v3 = *(unaligned_float*)(a2 + 436) + *(unaligned_float*)(a2 + 440);
		*(unaligned_float*)(a2 + 436) = v3;
		if (v3 >= 0.0) {
			*(unaligned_float*)(a2 + 440) = *(unaligned_float*)(a2 + 440) - 0.5;
		} else {
			v4 = -*(unaligned_float*)(a2 + 440) * *(unaligned_float*)(a2 + 444);
			*(uint32_t*)(a2 + 436) = 0;
			v5 = v4 * 0.1;
			*(unaligned_float*)(a2 + 440) = v5;
			if (v5 < 2.0) {
				*(uint32_t*)(a2 + 436) = 0;
				*(uint32_t*)(a2 + 440) = 0;
			}
