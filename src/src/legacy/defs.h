...
typedef float __attribute__((aligned(1))) unaligned_float;
typedef double __attribute__((aligned(1))) unaligned_double;
typedef uint32_t __attribute__((aligned(1))) unaligned_uint32;
typedef int32_t __attribute__((aligned(1))) unaligned_int32;
typedef uint16_t __attribute__((aligned(1))) unaligned_uint16;
typedef int16_t __attribute__((aligned(1))) unaligned_int16;
...
typedef double unaligned_double;
...
typedef int64_t unaligned_int64;
#endif
...
typedef int32_t unaligned_i32 __attribute__((aligned(1)));
typedef uint32_t unaligned_u32 __attribute__((aligned(1)));
typedef int16_t unaligned_i16 __attribute__((aligned(1)));
...
static float COERCE_FLOAT(uint32_t x) { return *(unaligned_float*)&x; }
...
typedef struct nox_thing {
	char* name;                                 // 0, 0x0
	wchar2_t* pretty_name;                       // 1, 0x4, 4
	wchar2_t* desc;                              // 2, 0x8, 8
...
#pragma pack(push, 1)
typedef struct {
	wchar2_t name[25]; // 2185 (+0) // TODO: size is a guess
