...
int nox_xxx_interesting_xfer_4D0010(uint32_t* a1, int a2) {
	...
	while (1) {
		...
		if (v5 == nox_xxx_XFerElevator_4F53D0) {
			...
			*(unaligned_float*)(v17 + 80) = (double)(int)(*a1 - 23 * *(uint32_t*)v18) + *(unaligned_float*)(v17 + 80);
			*(unaligned_float*)(v17 + 84) = (double)(int)(a1[1] - 23 * *((uint32_t*)v18 + 1)) + *(unaligned_float*)(v17 + 84);
			...
			*(unaligned_float*)(v22 + 28) = (double)(int)(*a1 - 23 * *(uint32_t*)v23) + *(unaligned_float*)(v22 + 28);
			*(unaligned_float*)(v22 + 32) = (double)(int)(a1[1] - 23 * *((uint32_t*)v23 + 1)) + *(unaligned_float*)(v22 + 32);
		}
		...
		if (nox_xxx_mapGen_InPrefab2_5266F0((int)getMemAt(0x5D4594, 1549796))) {
			...
			if (*getMemU32Ptr(0x5D4594, 1549980)) {
				...
				for (i = (char*)nox_xxx_mapGenGetTopRoom_521710(); i; i = (char*)sub_521720((int)i)) {
					sub_521BC0((int)v4, (float2*)(i + 20), *((unaligned_float*)i + 7), *((unaligned_float*)i + 8));
				}
...
float* nox_xxx_mapgen_Doors_4D4790() {
	...
	do {
		...
		v2 = 0;
	LABEL_117:
		result = (unaligned_float*)sub_521720((int)v1);
		v1 = result;
	} while (result);
	return result;
}
...
float* nox_xxx_mapGenMkSmallRoom_4D4F40(uint32_t* a1) {
	...
	LABEL_5:
				...
				while (1) {
					...
					*((uint32_t*)result + 4) = 5;
					...
					if (v15 >= 8) {
						...
						result = (unaligned_float*)v30[v18 - 1];
		...
		if (result) {
			...
			result = *(unaligned_float**)&dword_5d4594_1550916;
		...
		while (1) {
			...
			if (v23) {
				if (nox_xxx_mapGenCheckRoomType_5238F0(v23) || *(uint8_t*)(v24 + 52) & 2 || v24 == a5 ||
					...
					!sub_523A10((int)v18, (unaligned_float*)v24)) {
					sub_521A10(v18);
				} else {
...
int sub_4D5630(int a1, int a2, int a3, int a4, int a5) {
	...
	if (a3 >= *getMemIntPtr(0x5D4594, 1549816) || (v6 = sub_4D5D20((uint32_t*)a1), v45 = v6, v6 == 1)) {
		...
		while (1) {
			...
			case 2:
				...
				v9 = *(unaligned_float*)(a1 + 24) - v8[8];
				a2a.field_4 = v9;
				break;
			case 3:
				a2a.field_0 = sub_521B60((int)v8, a1);
				v9 = *(unaligned_float*)(a1 + 32) + *(unaligned_float*)(a1 + 24);
				a2a.field_4 = v9;
				break;
			case 4:
				v10 = *(unaligned_float*)(a1 + 28) + *(unaligned_float*)(a1 + 20);
				a2a.field_0 = v10;
				v9 = sub_521B90((int)v8, a1);
				a2a.field_4 = v9;
				break;
			case 5:
				v10 = *(unaligned_float*)(a1 + 20) - v8[7];
				a2a.field_0 = v10;
				v9 = sub_521B90((int)v8, a1);
				a2a.field_4 = v9;
				break;
	...
	switch (*(uint32_t*)a1) {
	case 2:
		v15 = *(unaligned_float*)(a1 + 20) - v13[7];
		a2a.field_4 = *(unaligned_float*)(a1 + 24);
		a2a.field_0 = v15;
		break;
	case 3:
		a2a.field_0 = *(unaligned_float*)(a1 + 28) + *(unaligned_float*)(a1 + 20);
		v16 = *(unaligned_float*)(a1 + 32) + *(unaligned_float*)(a1 + 24) - v13[8];
		a2a.field_4 = v16;
		break;
	case 4:
		a2a.field_0 = *(unaligned_float*)(a1 + 28) + *(unaligned_float*)(a1 + 20) - v13[7];
		v16 = *(unaligned_float*)(a1 + 24) - v13[8];
		a2a.field_4 = v16;
		break;
	case 5:
		v16 = *(unaligned_float*)(a1 + 32) + *(unaligned_float*)(a1 + 24);
...
LABEL_43:
	...
	switch (*(uint32_t*)v5) {
	case 2:
		v23 = *(unaligned_float*)(v5 + 28) + *(unaligned_float*)(v5 + 20);
		a2a.field_4 = *(unaligned_float*)(v5 + 24);
		a2a.field_0 = v23;
		break;
	case 3:
		a2a.field_0 = *(unaligned_float*)(v5 + 20) - v22[7];
		v24 = *(unaligned_float*)(v5 + 32) + *(unaligned_float*)(v5 + 24);
		v25 = v24 - v22[8];
		a2a.field_4 = v25;
		break;
	case 4:
		a2a.field_0 = *(unaligned_float*)(v5 + 28) + *(unaligned_float*)(v5 + 20) - v22[7];
		v25 = *(unaligned_float*)(v5 + 32) + *(unaligned_float*)(v5 + 24);
		a2a.field_4 = v25;
		break;
	case 5:
		v24 = *(unaligned_float*)(v5 + 24);
		a2a.field_0 = *(unaligned_float*)(v5 + 20);
		v25 = v24 - v22[8];
		a2a.field_4 = v25;
		break;
	default:
...
LABEL_71:
	if (v43 || v44) {
		...
		if (v31) {
			switch (*(uint32_t*)v5) {
			case 2:
				v33 = *(unaligned_float*)(v5 + 24);
				a2a.field_0 = *(unaligned_float*)(v5 + 20);
				a2a.field_4 = v33 - v31[8];
				break;
			case 3:
				v34 = *(unaligned_float*)(v5 + 32) + *(unaligned_float*)(v5 + 24);
				a2a.field_0 = *(unaligned_float*)(v5 + 20);
				a2a.field_4 = v34;
				break;
			case 4:
				v35 = *(unaligned_float*)(v5 + 28) + *(unaligned_float*)(v5 + 20);
				a2a.field_4 = *(unaligned_float*)(v5 + 24);
				a2a.field_0 = v35;
				break;
			case 5:
				v36 = *(unaligned_float*)(v5 + 20) - v31[7];
				a2a.field_4 = *(unaligned_float*)(v5 + 24);
				a2a.field_0 = v36;
				break;
			default:
...
char nox_xxx_servSendStats_4D8990(int a1, int a2, char a3) {
	...
	if (result & 4) {
		...
		*(uint16_t*)&v8[5] = *(uint16_t*)(v4 + 8);
		v7 = *(uint16_t*)(a2 + 490);
		*(unaligned_u16*)&v8[3] = *(uint16_t*)(v6 + 4);
		*(unaligned_u16*)&v8[7] = v7;
		*(unaligned_u16*)&v8[9] = *(unaligned_u16*)(*(uint32_t*)(v4 + 276) + 2235);
		*(unaligned_u16*)&v8[11] = *(unaligned_u16*)(*(uint32_t*)(v4 + 276) + 2239);
		v8[13] = a3;
...
int nox_xxx_netReportUnitHeight_4D9020(int a1, nox_object_t* a2p) {
	...
	if (*(uint8_t*)(a2 + 20) & 0x20) {
		v3 = *(uint16_t*)(a2 + 36);
		v15[0] = -97;
		v4 = *(unaligned_float*)(a2 + 104);
		*(uint16_t*)&v15[1] = v3;
		v5 = (long long)v4;
		v6 = *(unaligned_float*)(a2 + 108);
		v15[3] = v5;
		v7 = (long long)v6;
		v8 = *(unaligned_float*)(a2 + 116);
		v15[4] = v7;
		v15[5] = (long long)v8;
		result = nox_netlist_addToMsgListCli_40EBC0(a1, 1, v15, 6);
	} else {
		v14 = (uint32_t*)a2;
		if (*(unaligned_float*)(a2 + 104) < 0.0) {
			LOBYTE(a2) = 95;
			v12 = nox_xxx_netGetUnitCodeServ_578AC0(v14);
			v13 = *(unaligned_float*)(v2 + 104);
			*(uint16_t*)((char*)&a2 + 1) = v12;
			v11 = -v13;
		} else {
			LOBYTE(a2) = 94;
			v10 = nox_xxx_netGetUnitCodeServ_578AC0(v14);
			v11 = *(unaligned_float*)(v2 + 104);
...
int nox_xxx_earthquakeSend_4D9110(float* a1, int a2) {
	...
	for (i = result; result; i = result) {
		...
		v5 = *a1 - *(unaligned_float*)(v4 + 3632);
		v6 = a1[1] - *(unaligned_float*)(v4 + 3636);
		v7 = v6 * v6 + v5 * v5;
		if (v7 < 90000.0) {
...
void nox_xxx_playerReportAnything_4D9900(int a1) {
	...
	if (a1 && *(uint8_t*)(a1 + 8) & 4) {
		...
		v15 = *(uint16_t**)(a1 + 556);
		v16 = *(int*)(v2 + 228);
		if (*(unaligned_float*)(v2 + 232) != *(unaligned_float*)&v16) {
...
void nox_xxx_effectSpeedEngage_4DFC30(int a1, int a2) {
	...
	if (a2) {
		if (*(uint8_t*)(a2 + 8) & 4) {
			...
			*(unaligned_float*)&v5 = *(unaligned_float*)(a1 + 120) + *(unaligned_float*)(a2 + 552);
			*(unaligned_float*)(v2 + 552) = *(unaligned_float*)&v5;
...
void nox_xxx_effectSpeedDisengage_4DFCA0(int a1, int a2) {
	...
	if (a2 && *(uint8_t*)(a2 + 8) & 4) {
		...
		v3 = *(uint32_t*)(a2 + 748);
		*(unaligned_float*)&v4 = *(unaligned_float*)(a2 + 552) - *(unaligned_float*)(a1 + 120);
		*(unaligned_float*)(v2 + 552) = *(unaligned_float*)&v4;
...
float* sub_4E0380(int a1, int a2, int a3, int a4, int a5, float* a6) {
	...
	result = a6;
	*a6 = (1.0 - *(unaligned_float*)(a1 + 80) + 1.0) * *a6;
	return result;
}
...
void nox_xxx_recoilEffect_4E0640(int a1, int a2, int a3, int a4) {
	if (a2) {
		if (a4) {
			nox_xxx_objectApplyForce_52DF80(a2 + 56, a4, *(unaligned_float*)(a1 + 56));
		}
	}
}
...
void nox_xxx_lightngEffect_4E06F0(int a1, int a2, int a3, int a4) {
	if (a4) {
		(*(void (**)(int, int, int, uint32_t, int))(a4 + 716))(a4, a3, a2, (long long)*(unaligned_float*)(a1 + 56), 9);
...
void nox_xxx_drainMEffect_4E0740(int a1, int a2, int a3, int a4, int* a5) {
	...
	if (a3 && a4 && *(uint8_t*)(a4 + 8) & 6) {
		v5 = (long long)(*(unaligned_float*)(a1 + 68) * (double)*a5);
		if (!v5) {
			v5 = 1;
		}
		...
		if (a4) {
			...
			if (v5 & 6) {
				if (!(v5 & 2) || !(*(uint8_t*)(a4 + 12) & 0x40)) {
					v6 = (long long)((double)*a5 * *(unaligned_float*)(a1 + 68));
					if (!v6) {
						v6 = 1;
					}
...
int nox_xxx_effectProjectileSpeed_4E09B0(int a1, int a2, int a3, int a4, int a5) {
	...
	result = a5;
	*(unaligned_float*)(a5 + 544) = *(unaligned_float*)(a1 + 44) * *(unaligned_float*)(a5 + 544);
	return result;
}
...
int nox_xxx_projectileReflect_4E0A70(int a1, int a2) {
	...
	result = a1;
	v3 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a2 + 56);
	v4 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a2 + 60);
	*(uint16_t*)(a1 + 124) += 128;
	v5 = *(uint16_t*)(a1 + 124);
	v11 = -v4;
	v13 = sqrt(v4 * v4 + v3 * v3) + 0.1;
	v6 = (v4 * *(unaligned_float*)(result + 84) + v3 * *(unaligned_float*)(result + 80)) / v13;
	v9 = v6 * v3 / v13;
	v10 = v6 * v4 / v13;
	v7 = (v11 * *(unaligned_float*)(result + 80) + v3 * *(unaligned_float*)(result + 84)) / v13;
	v12 = v7 * v11 / v13;
	*(unaligned_float*)(result + 80) = v12 - v9;
	*(unaligned_float*)(result + 84) = v3 * v7 / v13 - v10;
	if (v5 >= 256) {
...
LABEL_87:
	...
	*(uint32_t*)(a1 + 536) = gameFrame();
	...
	if (v10 && *(uint8_t*)(a1 + 8) & 6 && nox_xxx_testUnitBuffs_4FF350(v10, 13)) {
		...
		v45[0] = nox_float2int(*(unaligned_float*)(v10 + 56));
		v33 = nox_float2int(*(unaligned_float*)(v10 + 60));
		v34 = *(unaligned_float*)(a1 + 56);
		v45[1] = v33;
		v35 = nox_float2int(v34);
		v36 = *(unaligned_float*)(a1 + 60);
		v45[2] = v35;
