...
LABEL_14:
	...
	if (!(v16 & 0x2000000)) {
		...
		v69 = 1.0;
		v70 = *(unaligned_float*)(&dword_8531A0_2576);
	...
	LABEL_51:
		...
		if (*(uint32_t*)LODWORD(v68) &&
			*(float* (**)(int, int, int, int, float*))(v27 + 40) == nox_xxx_effectDamageMultiplier_4E04C0) {
			v69 = *(unaligned_float*)(v27 + 44);
		}
		v28 = nox_xxx_calcBoltDamage_4EF1E0(*(unaligned_u32*)(LODWORD(v70) + 2239), (int)v26);
		v29 = v26[1];
		v70 = v28 * v69 + v71 + v72;
	...
	v17 = (unaligned_float*)nox_xxx_equipClothFindDefByTT_413270(*(uint32_t*)(dword_5d4594_1063116 + 108));
	v18 = 1.0;
	v19 = *(uint32_t*)(dword_5d4594_1063116 + 432);
	if (v19 && *(float* (**)(int, int, int, int, int, float*))(v19 + 76) == sub_4E0370) {
		v18 = *(unaligned_float*)(v19 + 80);
	}
...
void nox_client_makePlayerStatsDlg_463880(int* a1) {
	...
	float v54 = (double)(int)(90 * *(unaligned_u32*)(v4 + 2247)) / *v70;
	...
	if (v69 >= 0.0) {
		if (v69 > 0.0) {
			*(unaligned_float*)&v68 = COERCE_FLOAT(nox_float2int(v69));
			if (v67 + v68 > 90) {
				v68 = 90 - v67;
			}
			nox_client_drawSetColor_434460(nox_color_yellow_2589772);
	...
	*(unaligned_float*)&v68 = v69 * 100.0 * 0.011111111;
	float v63 = v70[2] * 100.0 / v71[2];
	int v64 = nox_float2int(v63);
	float v47 = (double)*(unaligned_i32*)(v4 + 2235) * 100.0 / v71[2] + *(unaligned_float*)&v68 + 0.5;
	...
	nox_xxx_drawSetTextColor_434390(nox_color_white_2523948);
	float v65 = (double)*(unaligned_i32*)(v4 + 2235) * 100.0 / v71[2] + *(unaligned_float*)&v68 + 0.5;
