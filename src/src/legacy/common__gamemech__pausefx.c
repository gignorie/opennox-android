...
void sub_57AF30(int a1, int a2) {
	...
	if (v3) {
		if (v2) {
			nox_xxx_createAt_4DAA50((int)v3, 0, *(unaligned_float*)(v2 + 56), *(unaligned_float*)(v2 + 60));
		} else {
	...
	if (!a2) {
		...
		v4 =
			nox_strman_loadString_40F1D0("expLevel.c:LevelUP", 0, "C:\\NoxPost\\src\\common\\GameMech\\PauseFX.c", 109);
