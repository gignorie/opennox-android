...
int sub_50D2A0(int a1, int a2) {
	...
	v2[92] = *(uint32_t*)a2;
	v2[93] = *(uint32_t*)(a2 + 4);
	result = sub_547F20(a1, (unaligned_float*)a2);
	v2[74] = result;
	v2[91] = 0;
	return result;
}
...
int sub_50D2E0(int a1) {
	...
	if (v2 && !*(uint32_t*)(v1 + 8)) {
		...
		v5 = *(unaligned_float*)(v4 + 8) - *(unaligned_float*)(a1 + 56);
		v6 = *(unaligned_float*)(v4 + 12) - *(unaligned_float*)(a1 + 60);
		if (v6 * v6 + v5 * v5 < 64.0) {
			if (v3 == v2 - 1) {
				*(uint32_t*)(v1 + 296) = 0;
				return 1;
	...
	return nox_xxx_creatureActuallyMove_50D3B0((unaligned_float*)a1) && *(uint8_t*)(v1 + 284) == 2;
}
...
int nox_xxx_creatureActuallyMove_50D3B0(float* a1) {
	...
	if (*(uint32_t*)(v1 + 8)) {
		...
		*(uint32_t*)(v1 + 268) = v2;
		v20 = *(unaligned_float*)(v1 + 8 * v2 + 12) - a1[14];
		v11 = *(unaligned_float*)(v1 + 8 * v2 + 16) - a1[15];
		v21 = v11;
		v24 = sqrt(v11 * v21 + v20 * v20) + *getMemDoublePtr(0x581450, 10288);
		if (v2 <= 0) {
			v22.field_0 = *(unaligned_float*)(v1 + 20) - *(unaligned_float*)(v1 + 12);
			v12 = *(unaligned_float*)(v1 + 24) - *(unaligned_float*)(v1 + 16);
		} else {
			v22.field_0 = *(unaligned_float*)(v1 + 8 * v2 + 12) - *(unaligned_float*)(v1 + 8 * v2 + 4);
			v12 = *(unaligned_float*)(v1 + 8 * v2 + 16) - *(unaligned_float*)(v1 + 8 * v2 + 8);
		}
		v22.field_4 = v12;
		...
		*((uint16_t*)v10 + 63) = v13;
		...
		if (v14 & 0x4000) {
			v15 = *(unaligned_float*)(*(uint32_t*)(v1 + 484) + 96) * v10[136];
		} else {
			v15 = v10[136];
		}
		v10[22] = v15 * v20 / v24;
...
int nox_xxx_creatureSetMovePath_50D5A0(int a1) {
	...
	v1 = *(uint32_t*)(a1 + 748);
	v2 = *(unaligned_float*)(v1 + 24 * *(char*)(v1 + 544) + 556) - *(unaligned_float*)(a1 + 56);
	v3 = (unaligned_float*)(v1 + 24 * *(char*)(v1 + 544) + 556);
	v4 = *(unaligned_float*)(v1 + 24 * *(char*)(v1 + 544) + 560) - *(unaligned_float*)(a1 + 60);
	if (sqrt(v4 * v4 + v2 * v2) + *getMemDoublePtr(0x581450, 10288) <= 8.0) {
		return 1;
	}
	v6 = *(unaligned_float*)(a1 + 60);
	v14.field_0 = *(unaligned_float*)(a1 + 56);
	v14.field_4 = v6;
	v14.field_8 = *v3;
	...
	if (v8) {
		if (!v9) {
			if (!*(uint32_t*)(v1 + 296) || (unsigned int)(gameFrame() - *(uint32_t*)(v1 + 280)) > 0xA &&
											   (v12 = *(unaligned_float*)(v1 + 368) - *v3, v13 = *(unaligned_float*)(v1 + 372) - v3[1],
			...
			nox_xxx_creatureSetDetailedPath_50D220(a1, (int)v3);
						  ...
						  (v10 = *(unaligned_float*)(v1 + 272) - *v3, v11 = *(unaligned_float*)(v1 + 276) - v3[1],
	...
	if (*(uint32_t*)(v1 + 8) && nox_xxx_creatureActuallyMove_50D3B0((unaligned_float*)a1)) {
		*(uint32_t*)(v1 + 8) = 0;
		return 1;
	}
	return 0;
		...
		do {
			...
			*getMemU32Ptr(0x5D4594, 2386232 + 4 * *(unsigned char*)(*(uint32_t*)(v1 + 276) + 2064)) = 0;
			...
			if (*(uint32_t*)(v2 + 4792)) {
				...
				a2.field_0 = *(unaligned_float*)(v0 + 56) - (double)*(unsigned short*)(v2 + 10) - 100.0;
				a2.field_4 = *(unaligned_float*)(v0 + 60) - (double)*(unsigned short*)(*(uint32_t*)(v1 + 276) + 12) - 100.0;
				a2.field_8 = (double)*(unsigned short*)(*(uint32_t*)(v1 + 276) + 10) + *(unaligned_float*)(v0 + 56) + 100.0;
				a2.field_C = (double)*(unsigned short*)(*(uint32_t*)(v1 + 276) + 12) + *(unaligned_float*)(v0 + 60) + 100.0;
				if (dword_5d4594_2386212) {
					do {
						if (sub_428220((float2*)(*v3 + 56), &a2)) {
							v39.field_0 = *(unaligned_float*)(v0 + 56);
							v39.field_4 = *(unaligned_float*)(v0 + 60);
							v4 = *v3;
							v39.field_8 = *(unaligned_float*)(*v3 + 56);
							v39.field_C = *(unaligned_float*)(v4 + 60);
							if (nox_xxx_mapTraceRay_535250(&v39, 0, 0, 69)) {
								...
								*(unaligned_float*)&v5[*(unsigned char*)(*(uint32_t*)(v1 + 276) + 2064) + 3] =
...
int sub_50DE80(int a1, float* a2) {
	...
	while (1) {
		...
		v5 = *(uint32_t*)(v4 + 276);
		if (*(uint32_t*)(v5 + 4792)) {
			a2a.field_0 = *(unaligned_float*)(v3 + 56) - (double)*(unsigned short*)(v5 + 10) - 100.0;
			a2a.field_4 = *(unaligned_float*)(v3 + 60) - (double)*(unsigned short*)(*(uint32_t*)(v4 + 276) + 12) - 100.0;
			a2a.field_8 = (double)*(unsigned short*)(*(uint32_t*)(v4 + 276) + 10) + *(unaligned_float*)(v3 + 56) + 100.0;
			a2a.field_C = (double)*(unsigned short*)(*(uint32_t*)(v4 + 276) + 12) + *(unaligned_float*)(v3 + 60) + 100.0;
...
void sub_50DFB0(float* a1, int a2) {
	...
	if ((uint8_t)a1[2] & 2 && !((uint32_t)a1[4] & 0x20) &&
		...
		v2 = *(unaligned_float*)(a2 + 56);
		v3 = a1[14];
		v5.field_4 = *(unaligned_float*)(a2 + 60);
		v5.field_0 = v2;
		v4 = a1[15];
		v5.field_8 = v3;
		v5.field_C = v4;
...
int nox_xxx_shopGetItemCost_50E3D0(int a1, int a2, int a3) {
	int v3;              // ebp
	int v4;              // edi
	int v5;              // ebx
	int v6;              // eax
	...
	if (v7 & 0x100) {
		v8 = *(uint32_t*)(v3 + 12);
		if (v8 & 1) {
			if (*(uint8_t**)(v3 + 736) && **(uint8_t**)(v3 + 736)) {
				v9 = (double)(unsigned short)nox_xxx_spellPrice_424C40(**(uint8_t**)(v3 + 736));
				v31 = v9;
			}
			goto LABEL_17;
		}
		if (v8 & 2) {
			if (*(char**)(v3 + 736)) {
				int worth = nox_objectTypeGetWorth(*(char**)(v3 + 736));
				if (worth >= 0) {
					v31 = (double)worth;
				}
			}
...
LABEL_17:
	if (*(uint32_t*)(v3 + 8) & 0x13001000) {
		v11 = *(uint32_t*)(v3 + 692);
		if (v11) {
			v12 = 4;
			do {
				if (*(uint32_t*)v11 && *(int*)(*(uint32_t*)v11 + 20)) {
					*(unaligned_float*)&v29 = (double)*(int*)(*(uint32_t*)v11 + 20);
					if (nox_common_gameFlags_check_40A5C0(4096)) {
						v13 = nox_xxx_gamedataGetFloat_419D40("QuestModifierWorthMultiplier") * *(unaligned_float*)&v29;
					} else {
						v13 = *(unaligned_float*)&v29;
					}
					v31 = v13 + v31;
				}
				v11 += 4;
	...
	v14 = *(uint32_t*)(v3 + 8);
	v30 = v31;
	if (v14 & 0x1000000 && *(uint8_t*)(v3 + 12) & 0x82) {
		v15 = *(uint8_t**)(v3 + 736);
		if (v15 && !v15[2] && *v15) {
			if (nox_common_gameFlags_check_40A5C0(4096)) {
		...
		if (*(uint32_t*)(v3 + 12) & 0x47F0000) {
			v20 = *(uint32_t*)(v3 + 736);
			if (v20 && *(uint8_t*)(v20 + 109)) {
				v4 = v27;
	...
	if (v4 && v5 && *(uint32_t*)(v5 + 16) && a1) {
		v31 = v31 * *(unaligned_float*)(v4 + 1716);
		v30 = v30 * *(unaligned_float*)(v4 + 1716);
	}
	v21 = *(unsigned short**)(v3 + 556);
	if (v21 && v21[2]) {
	...
	if (v4 && !a1) {
		v22 = nox_common_gameFlags_check_40A5C0(4096) ? nox_xxx_gamedataGetFloat_419D40("QuestSellMultiplier")
													  : *(unaligned_float*)(v4 + 1720);
		v23 = *(unsigned short*)(v3 + 4);
	...
	if (nox_common_gameFlags_check_40A5C0(4096) && !a1 && (*(uint32_t*)(v3 + 8) & 0x3001000) &&
		*(uint32_t*)(v3 + 748) && (*(uint8_t*)(*(uint32_t*)(v3 + 748) + 4) & 1)) {
		v30 = 0.0;
	} else if (v31 >= 1.0) {
		goto LABEL_64;
	}
...
//----- (0050EE00) --------------------------------------------------------
float* nox_xxx_addItemToShopSession_50EE00(int a1, int a2) {
	float* result;   // eax
	float* v3;       // esi
	unsigned int v4; // ebx
	int v5;          // edi
	...
	result = (unaligned_float*)nox_alloc_class_new_obj_zero(*(uint32_t**)&nox_alloc_tradeItems_2386496);
	v3 = result;
	if (result) {
		*(uint32_t*)result = a2;
		*((uint32_t*)result + 1) = nox_xxx_shopGetItemCost_50E3D0(1, a1, a2);
		v4 = sub_50EEC0((uint32_t*)v3);
		if (*(uint32_t*)(a1 + 20)) {
			if (v4 <= sub_50EEC0(*(uint32_t**)(a1 + 20))) {
				v3[3] = 0.0;
				v3[2] = *(unaligned_float*)(a1 + 20);
...
int sub_50F2B0(int a1, uint32_t* a2) {
	...
	*(uint32_t*)&v9[6] = v3;
	...
	if ((*(uint32_t*)(v2 + 8) & 0x13001000) && v5) {
		for (i = 0; i < 4; ++i) {
			if (*(uint32_t*)v5) {
...
void sub_50F790(int a1, int a2, int* a3) {
	...
	for (i = a3; i; i = (int*)i[2]) {
		if (*(uint8_t*)(a2 + 8) & 4) {
			...
			v4 = nox_xxx_addItemToShopSession_50EE00(a1, *i);
			if (v4) {
				v5 = *(uint32_t*)(a1 + 8);
				if (*(uint8_t*)(v5 + 8) & 4) {
					sub_50F2B0(v5, v4);
...
int nox_xxx_tradeP2PAddOfferMB_50FE20(int a1, int a2) {
	...
	if (*(uint8_t*)(v3 + 8) & 4) {
		...
		v5 = nox_xxx_addItemToShopSession_50EE00(a1, *v2);
		if (v5) {
			v6 = *(uint32_t*)(a1 + 8);
			if (!(*(uint8_t*)(v6 + 8) & 4)) {
				v6 = *(uint32_t*)(a1 + 12);
	...
	*(uint16_t*)&v11[2] = a3;
	if (result) {
		...
		if (v9 && (v10 = v9[2], *v9 != v10) && v10 || v3) {
			*(uint32_t*)&v11[4] = nox_xxx_shopGetItemCost_50E3D0(2, a2, (int)result);
...
uint32_t* sub_510AE0(int* a1, int a2, uint32_t* a3) {
	...
	if (v4) {
		...
		v6 = nox_xxx_shopGetItemCost_50E3D0(2, a2, (int)v4);
...
void sub_510D10(int* a1, int a2, int a3, unsigned int a4) {
	...
	if (a4) {
		while (1) {
			...
			v8 = nox_xxx_shopGetItemCost_50E3D0(0, a2, (int)v7);
...
signed int nox_xxx_updateSentryGlobe_510E60(int a1) {
	...
	if (*(uint32_t*)(a1 + 16) & 0x1000000) {
		v3 = *(unaligned_float*)(a1 + 60);
		a1a.field_0 = *(unaligned_float*)(a1 + 56);
		a1a.field_4 = v3;
		a1a.field_8 = cos(*(unaligned_float*)v2) * 600.0 + *(unaligned_float*)(a1 + 56);
		a1a.field_C = sin(*(unaligned_float*)v2) * 600.0 + *(unaligned_float*)(a1 + 60);
		if (nox_xxx_mapTraceRay_535250(&a1a, &a2, 0, 5)) {
			v4 = a1a.field_C;
			*(unaligned_float*)(a1 + 156) = a1a.field_8;
			*(unaligned_float*)(a1 + 160) = v4;
		} else {
			v5 = a2.field_0;
			v6 = a2.field_4;
			*(unaligned_float*)(a1 + 156) = a2.field_0;
			*(unaligned_float*)(a1 + 160) = v6;
			a1a.field_8 = v5;
			a1a.field_C = v6;
		}
		*(unaligned_float*)v2 = *(unaligned_float*)(v2 + 8) + *(unaligned_float*)v2;
...
void nox_xxx_sentry_511020(int a1, int a2) {
	...
	if (!(v2 & 0x41) &&
		...
		*(uint32_t*)(a1 + 556) && nox_xxx_mathPointOnTheLine_57C8A0(*(float4**)(a2 + 4), (float2*)(a1 + 56), &a3)) {
		v3 = *(unaligned_float*)(a1 + 60) - a3.field_4;
		if (*(unaligned_float*)(a1 + 176) * *(unaligned_float*)(a1 + 176) >
			v3 * v3 + (*(unaligned_float*)(a1 + 56) - a3.field_0) * (*(unaligned_float*)(a1 + 56) - a3.field_0)) {
			v7 = *(uint32_t*)a2;
...
void sub_511100(int a1) {
	...
	v9 = *((unaligned_float*)v2 + 908) - v4;
	v13 = (double)*((unsigned short*)v2 + 6);
	v10 = *((unaligned_float*)v2 + 909) - v13;
	v11 = v4 + *((unaligned_float*)v2 + 908);
	for (i = v13 + *((unaligned_float*)v2 + 909); v3; v3 = *(uint32_t*)(v3 + 496)) {
		if (*(uint32_t*)(v3 + 16) & 0x1000000) {
			if (*(unaligned_float*)(v3 + 56) >= (double)*(unaligned_float*)(v3 + 156)) {
				v5 = *(unaligned_float*)(v3 + 56);
				v6 = *(unaligned_float*)(v3 + 156);
			} else {
				v5 = *(unaligned_float*)(v3 + 156);
				v6 = *(unaligned_float*)(v3 + 56);
			}
			if (*(unaligned_float*)(v3 + 60) >= (double)*(unaligned_float*)(v3 + 160)) {
				v8 = *(unaligned_float*)(v3 + 60);
				v7 = *(unaligned_float*)(v3 + 160);
			} else {
				v7 = *(unaligned_float*)(v3 + 60);
				v8 = *(unaligned_float*)(v3 + 160);
			}
			if (v9 < v5 && v11 > (double)v6 && v10 < (double)v8 && i > (double)v7) {
				sub_511250(v1, (unaligned_float*)v3);
			}
		} else {
	...
	for (j = result; result; j = result) {
		if (*(uint8_t*)(j + 16) & 2 || *(uint8_t*)(j + 8) & 2 && nox_xxx_checkMobAction_50A0D0(j, 67)) {
			...
			*(uint32_t*)(j + 80) = 0;
			...
			if (nox_xxx_testUnitBuffs_4FF350(j, 5) || nox_xxx_testUnitBuffs_4FF350(j, 25) ||
				...
				v4 = *(unaligned_float*)(j + 96);
				v13 = *(unaligned_float*)(j + 100);
			} else {
				v4 = *(unaligned_float*)(j + 96) + *(unaligned_float*)(j + 88);
				v13 = *(unaligned_float*)(j + 100) + *(unaligned_float*)(j + 92);
			}
			v5 = *(unaligned_float*)(j + 64);
			v6 = (unaligned_float*)(j + 64);
			// update velocity
			*(unaligned_float*)(j + 80) += (v4 - *(unaligned_float*)(j + 80) * *(unaligned_float*)(j + 112)) * step;
			*(unaligned_float*)(j + 84) += (v13 - *(unaligned_float*)(j + 84) * *(unaligned_float*)(j + 112)) * step;
			v16.field_0 = v5;
			v16.field_4 = *(unaligned_float*)(j + 68);
			v7 = getMemAt(0x5D4594, 2386580);
			// calc new pos
			v16.field_8 = step * *(unaligned_float*)(j + 80) + *(unaligned_float*)(j + 64);
			v16.field_C = step * *(unaligned_float*)(j + 84) + *(unaligned_float*)(j + 68);
		...
		LABEL_20:
			if (nox_xxx_mapTraceRay_535250(&v16, 0, 0, v8)) {
				// sets new pos
				*(unaligned_float*)(j + 64) = v16.field_8;
				*(unaligned_float*)(j + 68) = v16.field_C;
			}
			v9 = *(uint32_t*)(j + 16);
			...
			v10 = *v6 - *(unaligned_float*)(j + 56);
			if (v10 < 0.0) {
				v10 = -v10;
			}
			v11 = *(unaligned_float*)(j + 68) - *(unaligned_float*)(j + 60);
			if (v11 < 0.0) {
				v11 = -v11;
			}
...
float* nox_xxx_monsterLookAt_5125A0(nox_object_t* obj, int a2) {
	...
	result = (unaligned_float*)nox_xxx_mathDirection4ToAngle_509E90(a2);
	if (*(uint8_t*)(a1 + 8) & 2) {
		v3 = *(uint32_t*)(a1 + 16);
		if ((v3 & 0x8000) == 0) {
			v4 = *getMemFloatPtr(0x587000, 194136 + 8 * (uint32_t)result) * 10.0 + *(unaligned_float*)(a1 + 56);
			v5 = *getMemFloatPtr(0x587000, 194140 + 8 * (uint32_t)result) * 10.0 + *(unaligned_float*)(a1 + 60);
			result = (unaligned_float*)nox_xxx_monsterPushAction_50A260(a1, 25);
			if (result) {
				result[1] = v4;
				result[2] = v5;
			}
...
void nox_xxx_monsterWalkTo_514110(nox_object_t* obj, float x, float y) {
	...
	if (SBYTE1(result) >= 0 && *(uint8_t*)(a1 + 8) & 2) {
		...
		if (result) {
			((unaligned_float*)result)[1] = x;
			((unaligned_float*)result)[2] = y;
			result[3] = 0;
		}
	}
}
...
void nox_xxx_monsterGoPatrol_515680(nox_object_t* a1p, void* a2p) {
	...
	if (a1) {
		if (*(uint8_t*)(a1 + 8) & 2) {
			v3 = *(uint32_t*)(a1 + 16);
			if ((v3 & 0x8000) == 0) {
				v5.field_0 = *(unaligned_float*)(a2 + 8) - *(unaligned_float*)a2;
				v5.field_4 = *(unaligned_float*)(a2 + 12) - *(unaligned_float*)(a2 + 4);
				nox_xxx_monsterClearActionStack_50A3A0(a1);
		...
		if (*(uint8_t*)(a1 + 8) & 2) {
			...
			if ((v2 & 0x8000) == 0) {
				if (nox_xxx_monsterCanMelee_534220(a1)) {
					...
					v4 = (unaligned_float*)nox_xxx_monsterPushAction_50A260(a1, 51);
					if (v4) {
						v4[1] = sub_534470(a1) + *(unaligned_float*)(a1 + 176);
						v4[3] = a2->field_0;
						v4[4] = a2->field_4;
					}
					v5 = (unaligned_float*)nox_xxx_monsterPushAction_50A260(a1, 7);
					if (v5) {
						v5[1] = a2->field_0;
						v5[2] = a2->field_4;
						v5[3] = 0;
...
int sub_518040(int arg0, float a2, int arg8, int a4) {
	...
	result = arg0;
	if (arg0) {
		v5 = *(unaligned_float*)arg0 - a2;
		a3[2] = arg8;
		a3[0] = arg0;
		*(unaligned_float*)&a3[1] = a2;
		a1.field_0 = v5;
		v6 = *(unaligned_float*)(arg0 + 4) - a2;
		a3[3] = a4;
		a1.field_4 = v6;
		a1.field_8 = a2 + *(unaligned_float*)arg0;
		a1.field_C = a2 + *(unaligned_float*)(arg0 + 4);
...
void sub_5180B0(int a1, int a2) {
	...
	if (a1 && a2) {
		if (*(uint32_t*)(a1 + 172) == 2) {
			v6 = *(float2**)a2;
			*(unaligned_float*)&v8 = **(unaligned_float**)a2 - *(unaligned_float*)(a1 + 56);
			v7 = v6->field_4 - *(unaligned_float*)(a1 + 60);
			v8.field_4 = v7;
			v4 = sqrt(v7 * v8.field_4 + v8.field_0 * v8.field_0) - *(unaligned_float*)(a1 + 176);
		} else {
			if (*(uint32_t*)(a1 + 172) == 3) {
				v5 = sub_54A990((float2*)*(uint32_t*)a2, *(unaligned_float*)(a2 + 4), a1, &v8);
				goto LABEL_9;
			}
			v2 = *(float2**)a2;
			*(unaligned_float*)&v8 = **(unaligned_float**)a2 - *(unaligned_float*)(a1 + 56);
			v3 = v2->field_4 - *(unaligned_float*)(a1 + 60);
			v8.field_4 = v3;
			v4 = sqrt(v3 * v8.field_4 + v8.field_0 * v8.field_0);
		}
		v5 = *(unaligned_float*)(a2 + 4) - v4;
	LABEL_9:
		if (v5 > 0.0) {
...
int nox_xxx_netSendSimpleObj_5188A0(int a1, int a2) {
	...
	*(uint16_t*)&v10[1] = nox_xxx_netGetUnitCodeServ_578AC0((uint32_t*)a2);
	v7 = nox_float2int(*(unaligned_float*)(a2 + 56));
	v8 = *(unaligned_float*)(a2 + 60);
	*(uint16_t*)&v10[5] = v7;
...
int nox_xxx_netSendComplexObject_518960(int a1, uint32_t* a2, int a3) {
	...
	*(uint16_t*)&v18[1] = nox_xxx_netGetUnitCodeServ_578AC0(v4);
	v10 = nox_float2int(*((unaligned_float*)v4 + 14));
	v11 = *((unaligned_float*)v4 + 15);
	*(uint16_t*)&v18[5] = v10;
...
int nox_xxx_netPlayerObjSend_518C30(nox_object_t* a1p, nox_object_t* a2p, int a3, signed int a4) {
	...
	*(uint16_t*)&v22[3] = v11;
	...
	v13 = *((unaligned_float*)v5 + 14);
	*(uint16_t*)&v22[1] = v12;
	v14 = nox_float2int(v13);
	v15 = *((unaligned_float*)v5 + 15);
	*(uint16_t*)&v22[5] = v14;
	...
	if (!(v4 & 0x20) && !(*(uint32_t*)(a2 + 8) & 0x40000000)) {
		...
		if (v6 & *(uint32_t*)(a2 + 152) || *(uint8_t*)(a2 + 8) & 1) {
			...
			if (!(v7 & 0x800) || nox_xxx_unitHasThatParent_4EC4F0(a2, a1) ||
				...
				v8 = *(uint32_t*)(v13 + 276);
				v14.field_0 = *(unaligned_float*)(v8 + 3632);
				v9 = *(unaligned_float*)(a2 + 60);
				v10 = *(unaligned_float*)(v8 + 3636);
				v14.field_8 = *(unaligned_float*)(a2 + 56);
				v4 = *(uint32_t*)(a2 + 8);
				v14.field_4 = v10;
				v14.field_C = v9;
...
void nox_xxx_spawnHecubahQuest_51A5A0(int* a1) {
	...
	if (v1) {
		...
		*(uint16_t*)(v1[139] + 4) = nox_float2int(v17);
		...
		v2[330] = 1062836634;
		nox_xxx_createAt_4DAA50((int)v1, 0, *(unaligned_float*)a1, *((unaligned_float*)a1 + 1));
...
void sub_51B810(nox_object_t* a1p) {
	...
	v6 = a1;
	v2 = *(unaligned_float*)(a1 + 88) + *(unaligned_float*)(a1 + 80);
	v3 = *(uint32_t*)(a1 + 68);
	*(uint32_t*)(a1 + 56) = *(uint32_t*)(a1 + 64);
	*(uint32_t*)(a1 + 60) = v3;
	v4 = v2 * *(unaligned_float*)(a1 + 112);
	*(unaligned_float*)(a1 + 80) = v4;
...
void nox_xxx_updateFallLogic_51B870(nox_object_t* a1p) {
	...
	v1 = a1;
	v2 = *(uint32_t*)(a1 + 16);
	v3 = *(unaligned_float*)(a1 + 104);
	if (v2 & 0x40000) {
		v10 = v3 + *(unaligned_float*)(a1 + 108);
		nox_xxx_unitRaise_4E46F0(a1, v10);
		v4 = *(unaligned_float*)(a1 + 108) - 1.0;
		*(uint32_t*)(a1 + 88) = 0;
		*(uint32_t*)(a1 + 92) = 0;
		*(uint32_t*)(a1 + 80) = 0;
		*(uint32_t*)(a1 + 84) = 0;
		*(unaligned_float*)(a1 + 108) = v4;
		v5 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a1 + 156);
		v6 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a1 + 160);
		v13 = v6;
		v7 = sqrt(v6 * v13 + v5 * v5);
		*(unaligned_float*)&v14 = v7;
		if (v7 > 0.0) {
			*(unaligned_float*)(v1 + 88) = v5 * -3.0 / *(unaligned_float*)&v14;
			*(unaligned_float*)(v1 + 92) = v13 * -3.0 / *(unaligned_float*)&v14;
		}
		if (*(unaligned_float*)(v1 + 104) < -50.0) {
			nox_xxx_unitRaise_4E46F0(v1, 90.0);
			*(uint32_t*)(v1 + 16) &= 0xFFFBFFFF;
			nox_xxx_unitMove_4E7010(v1, (float2*)(v1 + 164));
		}
	} else if (v3 != 0.0 || *(unaligned_float*)(a1 + 108) != 0.0) {
		if (0x800000 & v2) {
			v11 = *(unaligned_float*)(a1 + 104) + *(unaligned_float*)(a1 + 108);
			nox_xxx_unitRaise_4E46F0(a1, v11);
			if (*(unaligned_float*)(a1 + 104) >= 0.0) {
				*(unaligned_float*)(a1 + 108) = *(unaligned_float*)(a1 + 108) - 0.5;
			} else {
				nox_xxx_unitRaise_4E46F0(a1, 0.0);
				v8 = -*(unaligned_float*)(a1 + 108) * *(unaligned_float*)(a1 + 116) * 0.1;
				*(unaligned_float*)(a1 + 108) = v8;
				if (v8 < 2.0) {
					nox_xxx_unitRaise_4E46F0(a1, 0.0);
					*(uint32_t*)(a1 + 108) = 0;
				}
			...
			if (*(unaligned_float*)(a1 + 104) > 0.0) {
				if (*(unaligned_float*)(a1 + 108) <= 0.0) {
					*(uint32_t*)(a1 + 16) = v2 | 0x20000;
				}
				v12 = *(unaligned_float*)(a1 + 104) + *(unaligned_float*)(a1 + 108);
				nox_xxx_unitRaise_4E46F0(a1, v12);
				*(unaligned_float*)(a1 + 108) = *(unaligned_float*)(a1 + 108) - 1.0;
			}
			if (*(unaligned_float*)(a1 + 104) <= 0.0) {
				v9 = *(unaligned_float*)(a1 + 108);
				*(uint32_t*)(a1 + 16) &= 0xFFFDFFFF;
				if (v9 < 0.0 && !(*(uint8_t*)(a1 + 8) & 1)) {
					nox_xxx_unitHasCollideOrUpdateFn_537610(a1);
					if (*(unaligned_float*)(a1 + 108) < -10.0) {
						if (*(uint8_t*)(a1 + 8) & 4) {
...
uint32_t* sub_51D120(float* a1) {
	...
	result = (unaligned_float*)nox_xxx_mapGenFixCoords_4D3D90((float2*)a1, &v3);
	if (result) {
...
float* sub_51D5E0(float* a1) {
	...
	if (a1) {
		if (*getMemU32Ptr(0x973F18, 35912) == 255 ||
			(nox_xxx_mapGenFixCoords_4D3D90((float2*)a1, &v2), (result = (unaligned_float*)sub_51D8F0(&v2)) != 0) &&
				(dword_5d4594_3835364 != 1 || (result = (unaligned_float*)sub_527380(&v2.field_0)) != 0)) {
			result = (unaligned_float*)1;
		}
	}
	return result;
}
