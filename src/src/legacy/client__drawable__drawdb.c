...
bool nox_parse_thing_light_dir(nox_thing* obj, nox_memfile* f, char* attr_value) {
	...
	obj->light_dir = (long long)((double)deg * *getMemDoublePtr(0x581450, 9560) * *(unaligned_double*)&qword_581450_9552 +
								 *(unaligned_double*)&qword_581450_9544);
	obj->field_10 = 0;
	return 1;
}
...
bool nox_parse_thing_light_penumbra(nox_thing* obj, nox_memfile* f, char* attr_value) {
	...
	obj->light_penumbra = (long long)((double)deg * *getMemDoublePtr(0x581450, 9560) * *(unaligned_double*)&qword_581450_9552 +
									  *(unaligned_double*)&qword_581450_9544);
	return 1;
}
