...
int nox_xxx_mapGenMakeExit_522A40(int a1) {
	...
	for (int v2 = sub_5259E0(); v2; v2 = *(uint32_t*)(v2 + 68)) {
		...
		int v4 = a1 + 216;
		while (v3 < *(int*)(a1 + 472)) {
			float* v5 = nox_xxx_mapgen_522AD0((unaligned_float*)v2, v4);
			if (v5) {
...
//----- (005259D0) --------------------------------------------------------
double sub_5259D0() { return *(unaligned_float*)&dword_5d4594_2487580; }
	...
	for (i = sub_4D42C0(); i; i = *(uint32_t*)(i + 64)) {
		...
		if (*(uint32_t*)(a1 + 60)) {
			for (j = *(uint32_t*)(i + 368); j; j = *(uint32_t*)(j + 24)) {
				...
				sub_5245A0(a1, (unaligned_float*)(j + 4), (long long)((*(unaligned_float*)(j + 12) - *(unaligned_float*)(j + 4) + 0.5) * 0.030743772),
						   (long long)((*(unaligned_float*)(j + 16) - *(unaligned_float*)(j + 8) + 0.5) * 0.030743772));
			}
		}
	}
	v6 = (unaligned_float*)sub_4D42C0();
	v8 = (v6[11] + v6[9]) * 0.5;
	v9 = (v6[12] + v6[10]) * 0.5;
