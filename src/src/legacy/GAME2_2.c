...
void nox_xxx_clientOnCursorHover_477050(int arg0, int a2) {
	...
	v23 = (double)*(int*)(arg0 + 16) - *(unaligned_float*)(arg0 + 100) - (double)*(short*)(arg0 + 104);
	v29 = nox_float2int(v23);
	v24 = (double)*(int*)(v2 + 16) - *(unaligned_float*)(v2 + 96) - (double)*(short*)(v2 + 104);
	v8 = COERCE_FLOAT(nox_float2int(v24));
	a3.field_0 = v8;
	if (*(uint32_t*)(v2 + 44) == 2) {
		v25 = *(unaligned_float*)(v2 + 48) * *(unaligned_float*)(v2 + 48);
		LODWORD(a3.field_0) = nox_float2int(v25);
		v17 = nox_float2int(*(unaligned_float*)(v2 + 48));
		v18 = *(uint32_t*)(v2 + 12);
		v19 = *(uint32_t*)(v2 + 12) - v17;
		v20 = v18 + nox_float2int(*(unaligned_float*)(v2 + 48));
		v21 = *(uint32_t*)(a2 + 4);
		if (v21 <= SLODWORD(v8)) {
			v8 = *(unaligned_float*)&v29;
			if (v21 >= v29) {
		...
		if (nox_xxx_map_57B850(&a1, (unaligned_float*)(v2 + 44), &a3) ||
			(a1.field_4 = (double)v29, nox_xxx_map_57B850(&a1, (unaligned_float*)(v2 + 44), &a3)) ||
			(v9 = *(uint32_t*)(v2 + 12) + nox_float2int(*(unaligned_float*)(v2 + 72)),
			 v10 = v29 + nox_float2int(*(unaligned_float*)(v2 + 76)), v11 = LODWORD(v8) + nox_float2int(*(unaligned_float*)(v2 + 76)),
			 *(uint32_t*)a2 > v9) &&
				*(uint32_t*)a2 < *(int*)(v2 + 12) && (v12 = *(uint32_t*)(a2 + 4), v12 > v10) && v12 < v11) {
			goto LABEL_38;
		}
		v13 = *(uint32_t*)(v2 + 12) + nox_float2int(*(unaligned_float*)(v2 + 80));
		v14 = v29 + nox_float2int(*(unaligned_float*)(v2 + 84));
		LODWORD(v15) = LODWORD(v8) + nox_float2int(*(unaligned_float*)(v2 + 84));
		if (*(int*)a2 < *(int*)(v2 + 12)) {
			return;
		}
		if (*(int*)a2 >= v13) {
...
LABEL_38:
	v26 = (double)*(short*)(v2 + 104) + (double)*(int*)(v2 + 16) + *(unaligned_float*)(v2 + 96);
...
long long sub_484C00(int a1, int a2) {
	...
	result = (long long)((double)a2 * 0.0027777778 * *(unaligned_double*)&qword_581450_9552 + *(unaligned_double*)&qword_581450_9544);
...
int nox_xxx_spriteChangeIntensity_484D70_light_intensity(int a1, float a2) {
	...
	*(unaligned_float*)(a1 + 4) = a2;
	*(uint32_t*)(a1 + 12) = (long long)(a2 * *(unaligned_double*)&qword_581450_9552 + *(unaligned_double*)&qword_581450_9544);
	result = sub_484C60(a2);
	*(uint32_t*)(a1 + 8) = result;
	return result;
}
...
int nox_xxx_wndEditProc_487D70(nox_window* a1p, int a2, int a3, int a4) {
	...
	case 7:
		...
		dword_5d4594_1193352 = (uint32_t)a1;
...
void nox_xxx_onChar_488BD0(unsigned short a1) {
	...
	if (dword_5d4594_1193352) {
		...
		if (dword_5d4594_1193348 && (nox_strman_get_lang_code() == 6 || nox_strman_get_lang_code() == 8)) {
			if (!*(uint32_t*)(v2 + 1036)) {
				if (!*(uint32_t*)(v2 + 1032)) {
					if (!*(uint32_t*)(v2 + 1028)) {
						*(uint32_t*)(v2 + 1044) = 1;
			...
			if (a1 == 8) { // Backspace
				short curLen = *(uint16_t*)(v2 + 1052);
				if (curLen > 0) {
					curLen--;
					*(uint16_t*)(v2 + 1052) = curLen;
					*(uint16_t*)(v2 + 2 * curLen) = 0;
					*(uint32_t*)(v2 + 1044) = 1;
				}
				return;
			}
			if (a1 == 10 || a1 == 13) { // Enter / Return
				*(uint32_t*)(v2 + 1044) = 0;
				nox_window_call_field_94(*(uint32_t*)(dword_5d4594_1193352 + 52), 16415, (int)dword_5d4594_1193352, 0);
				return;
			}
			if (a1 >= 32) {
				if (*(uint32_t*)(v2 + 1028)) { // digits only
					if (!iswdigit(a1)) {
						return;
					}
				} else if (*(uint32_t*)(v2 + 1032)) { // alnum only
					if (!iswalnum(a1)) {
						return;
					}
				}
