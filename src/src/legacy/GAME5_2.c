...
//----- (0056FAC0) --------------------------------------------------------
int nox_xxx_protectionStringCRC_56FAC0(const void* a1, unsigned int a2) {
	const unaligned_u32* v2 = (const unaligned_u32*)a1;
	int result = 0;
	for (unsigned int i = a2 >> 2; i; --i) {
		int v5 = *v2;
		++v2;
		result ^= v5;
	}
...
//----- (0056FAE0) --------------------------------------------------------
int nox_xxx_protectionStringCRCLen_56FAE0(const void* a1, unsigned int a2) {
	int result = 0;
	if (a1) {
...
//----- (0056FB00) --------------------------------------------------------
int sub_56FB00(const void* a1, unsigned int a2, int a3) {
	uint32_t* v3; // esi
...
void sub_56FF00(int a1) {
	...
	do {
		...
		v1 = (32 * v3) ^ v3;
		*((unaligned_double*)v2 - 1) = (double)(unsigned int)v1 * *getMemDoublePtr(0x581450, 11344);
...
int sub_57B190(unsigned short a1, unsigned short a2) {
	...
	v3 = (double)a1;
	v4 = (double)a2;
	if (v3 >= v4 * *(unaligned_double*)&qword_581450_9544) {
		return 1;
	}
	result = 2;
...
int nox_xxx_collideReflect_57B810(float* a1, int a2) {
	...
	if (a1) {
		memcpy(&a1_0, a1, sizeof(float));
		memcpy(&a1_1, (char*)a1 + sizeof(float), sizeof(float));
	}
	...
	if (a1_1 * a1_0 <= 0.0) {
		v4 = *(uint32_t*)(a2 + 4);
		*(unaligned_float*)(a2 + 4) = *(unaligned_float*)a2;
		*(uint32_t*)a2 = v4;
	} else {
		*(unaligned_float*)a2 = -*(unaligned_float*)(a2 + 4);
		*(unaligned_float*)(a2 + 4) = -v3;
	}
	return result;
}
