...
int nox_xxx_bookDrawFn_45C7D0(uint32_t* a1) {
	...
	*(unaligned_float*)&dword_5d4594_1046636 = *(unaligned_float*)&dword_5d4594_1046636 + obj_5d4594_1046620.field_0;
	*(unaligned_float*)&dword_5d4594_1046640 = *(unaligned_float*)&dword_5d4594_1046640 + obj_5d4594_1046620.field_4;
	if ((double)*getMemIntPtr(0x5D4594, 1046668) <= *(unaligned_float*)&dword_5d4594_1046636 &&
		(double)*getMemIntPtr(0x5D4594, 1046672) <= *(unaligned_float*)&dword_5d4594_1046640) {
		nox_xxx_book_45DBE0(*(void**)getMemAt(0x5D4594, 1046676), *(int*)&dword_5d4594_1047524, *(int*)&dword_5d4594_1046852);
		sub_45D810();
		goto LABEL_27;
	}
	if (*(unaligned_float*)&dword_5d4594_1046636 >
...
LABEL_27:
	v23 = nox_float2int(*(unaligned_float*)&dword_5d4594_1046640);
	v12 = nox_float2int(*(unaligned_float*)&dword_5d4594_1046636);
...
void sub_45D870() {
	...
	if (dword_5d4594_1047520) {
		...
		v9 = ((int)*getMemU32Ptr(0x5D4594, 1046668) - nox_float2int(*(unaligned_float*)&dword_5d4594_1046636)) / 50;
		v10 = ((int)*getMemU32Ptr(0x5D4594, 1046672) - nox_float2int(*(unaligned_float*)&dword_5d4594_1046640)) / 50;
		v3 = nox_float2int(*(unaligned_float*)&dword_5d4594_1046636);
		v4 = nox_float2int(*(unaligned_float*)&dword_5d4594_1046640);
		v5 = 50;
		do {
