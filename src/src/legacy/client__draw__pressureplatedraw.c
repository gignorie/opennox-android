...
int nox_thing_pressure_plate_draw(uint32_t* a1, nox_drawable* dr) {
	...
	v4 = a1[1] - a1[5];
	v13 = *(unaligned_float*)(v2 + 64);
	v5 = *a1 - a1[4];
	v20 = a1[1] - a1[5];
	v18 = *(uint32_t*)(v2 + 12) + v5 + nox_float2int(v13);
	v6 = *(uint32_t*)(v2 + 16) + v4 + nox_float2int(*(unaligned_float*)(v2 + 68));
	v19 = *(uint32_t*)(v2 + 12) + v5 + nox_float2int(*(unaligned_float*)(v2 + 88));
	v7 = *(uint32_t*)(v2 + 16) + v20 + nox_float2int(*(unaligned_float*)(v2 + 92));
	v16 = *(uint32_t*)(v2 + 12) + v5 + nox_float2int(*(unaligned_float*)(v2 + 72));
	v17 = *(uint32_t*)(v2 + 16) + v20 + nox_float2int(*(unaligned_float*)(v2 + 76));
	v14 = *(uint32_t*)(v2 + 12) + v5 + nox_float2int(*(unaligned_float*)(v2 + 80));
	v8 = nox_float2int(*(unaligned_float*)(v2 + 84));
	v9 = v20;
	v10 = *(uint32_t*)(v2 + 16);
	v11 = v10 + v20 + v8;
	v12 = 0;
