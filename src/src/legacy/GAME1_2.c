	...
	if (nox_crypt_IsReadOnly()) {
		...
		if (v25 >= 1) {
			do {
				...
				*((uint32_t*)v10 + 22) = nox_float2int(*((unaligned_float*)v13 + 1));
				*((uint32_t*)v10 + 23) = nox_float2int(*((unaligned_float*)v13 + 2));
				*((uint32_t*)v10 + 24) = nox_float2int(*((unaligned_float*)v13 + 1));
				v14 = nox_float2int(*((unaligned_float*)v13 + 2));
				v15 = 1;
				v16 = *v11 <= 1u;
				*((uint32_t*)v10 + 25) = v14;
				if (!v16) {
					do {
						...
						v18 = *((unaligned_float*)v17 + 1);
						v29[0] = *((unaligned_float*)v17 + 1);
						if (v18 >= (double)*((int*)v10 + 22)) {
							v19 = *((unaligned_float*)v17 + 1);
							v29[0] = *((unaligned_float*)v17 + 1);
						...
						v20 = *((unaligned_float*)v17 + 2);
						v29[0] = *((unaligned_float*)v17 + 2);
						if (v20 >= (double)*((int*)v10 + 23)) {
							v21 = *((unaligned_float*)v17 + 2);
							v29[0] = *((unaligned_float*)v17 + 2);
...
int nox_server_mapRWWallMap_429B20(uint32_t* a1) {
	...
	if (nox_crypt_IsReadOnly()) {
		...
		if (!nox_xxx_fileReadWrite_426AC0_file3_fread(&v22, 1u) || v22 == -1 || (uint8_t)v22 == 0xFF) {
			return 1;
		}
		v15 = v22;
		while (1) {
