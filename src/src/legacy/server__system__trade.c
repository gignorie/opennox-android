...
uint32_t* nox_xxx_createPlayerShopSession_50E8F0(int a1, int a2) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096) &&
		*(uint32_t*)(a1 + 748) && *(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) &&
...
int sub_50F0F0(int a1, int a2) {
	...
	*(uint16_t*)&v6[2] = *(uint16_t*)(v2 + 4);
	if (!*(uint32_t*)(v3 + 748) || !*(uint32_t*)(*(uint32_t*)(v3 + 748) + 276)) {
		return 0;
	}
...
int sub_50F1A0(int a1, int a2) {
	...
	*(uint16_t*)v8 = 3273;
	v2 = *(uint32_t*)(a2 + 8);
	v3 = *(uint32_t*)(a1 + 748);
	if (!v3 || !*(uint32_t*)(v3 + 276)) {
		return 0;
	}
	if (a1 != v2) {
		if (v2 && (*(uint8_t*)(v2 + 8) & 4)) {
			if (*(uint32_t*)(v2 + 748) && *(uint32_t*)(*(uint32_t*)(v2 + 748) + 276)) {
		...
		v4 = *(uint32_t*)(a2 + 12);
		if (v4 && (*(uint8_t*)(v4 + 8) & 4)) {
			if (*(uint32_t*)(v4 + 748) && *(uint32_t*)(*(uint32_t*)(v4 + 748) + 276)) {
...
//----- (0050F820) --------------------------------------------------------
int nox_xxx_tradeP2PAddOffer2_50F820_trade(int a1, int a2, int a3) {
	int v3;      // ebx
	int result;  // eax
	int* v5;     // eax
	int* v6;     // edi
	...
	if (*(uint32_t*)(a1 + 8) == a2) {
		v3 = a3;
		if (!sub_50FD60(*(uint32_t**)(a1 + 32), a3)) {
			return 0;
		}
	} else {
		...
		v3 = a3;
		if (!sub_50FD60(*(uint32_t**)(a1 + 36), a3)) {
			return 0;
		}
	}
...
void sub_5100C0_trade(int a1, uint32_t* a2, int a3) {
	...
	result = (unaligned_float*)a2[5];
	if (result) {
		while (!*(uint32_t*)result || *(uint32_t*)(*(uint32_t*)result + 36) != a3) {
			result = (unaligned_float*)*((uint32_t*)result + 2);
			if (!result) {
				return;
			}
		}
		v6 = *(uint32_t*)result;
		if (v6) {
			v7 = nox_xxx_shopGetItemCost_50E3D0(1, (int)a2, v6);
			v8 = v7;
			if (v7 > v4) {
				sub_5104F0(v3, v7 - v4);
				return;
...
float* sub_510640_trade(int a1, int a2, int a3, float* a4) {
	...
	if (a4) {
		while (1) {
			...
			v8 = nox_xxx_shopGetItemCost_50E3D0(1, a2, v7);
			if (v8 > v19) {
				return (unaligned_float*)sub_5104F0(v4, v8 - v19);
			}
			if (*(uint8_t*)(v7 + 8) & 0x10) {
				...
				if (v9 >= (nox_common_gameFlags_check_40A5C0(6144) ? 9 : 3)) {
					...
					return (unaligned_float*)nox_xxx_netSendLineMessage_4D9EB0(v4, v14);
				}
				v6 = (uint32_t*)a2;
			}
	...
	*(uint16_t*)&v8[2] = (uint16_t)a3;
	if (v4) {
		...
		if (nox_xxx_ItemIsDroppable_53EBF0(v4) == 1) {
			...
			*(uint32_t*)&v8[4] = nox_xxx_shopGetItemCost_50E3D0(0, a2, (int)v4);
			result =
...
uint32_t* sub_510BE0_trade(int* a1, int a2, uint32_t* a3) {
	...
	if (v5) {
		...
		if (nox_xxx_ItemIsDroppable_53EBF0(v5) == 1) {
			...
			v8 = nox_xxx_shopGetItemCost_50E3D0(0, a2, (int)v5);
