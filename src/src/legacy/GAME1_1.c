...
table_55816_t table_55816[10];
int table_55816_cnt = 9;

static int call_table_55816_fnc(unsigned int ind, void* a1, void* a2) {
	switch (ind) {
	case 0x2: return sub_41A590(a1, a2);
	case 0x3: return sub_41AA30(a1, a2);
	case 0x4: return sub_41AC30(a1, a2);
	case 0x8: return nox_xxx_guiFieldbook_41B420((int)a1, a2);
	case 0x5: return nox_xxx_guiSpellbook_41B660((int)a1, a2);
	case 0x6: return nox_xxx_guiEnchantment_41B9C0((int)a1, a2);
	case 0x9: return sub_41BEC0((int)a1, a2);
	case 0xa: return sub_41C080((int)a1, a2);
	case 0xb: return sub_41C200(a1, (int)a2);
	default: return 0;
	}
}

void init_table_55816(void) {
	static int inited = 0;
	if (inited) return;
	inited = 1;
	table_55816[0] = (table_55816_t){"Attrib Data", 0x2, (int (*)(int, int))&sub_41A590};
	table_55816[1] = (table_55816_t){"Status Data", 0x3, (int (*)(int, int))&sub_41AA30};
	table_55816[2] = (table_55816_t){"Inventory Data", 0x4, (int (*)(int, int))&sub_41AC30};
	table_55816[3] = (table_55816_t){"FieldGuide Data", 0x8, (int (*)(int, int))&nox_xxx_guiFieldbook_41B420};
	table_55816[4] = (table_55816_t){"Spellbook Data", 0x5, (int (*)(int, int))&nox_xxx_guiSpellbook_41B660};
	table_55816[5] = (table_55816_t){"Enchantment Data", 0x6, (int (*)(int, int))&nox_xxx_guiEnchantment_41B9C0};
	table_55816[6] = (table_55816_t){"Journal Data", 0x9, (int (*)(int, int))&sub_41BEC0};
	table_55816[7] = (table_55816_t){"Game Data", 0xa, (int (*)(int, int))&sub_41C080};
	table_55816[8] = (table_55816_t){"PAD_DATA", 0xb, (int (*)(int, int))&sub_41C200};
	table_55816[9] = (table_55816_t){0};
}

__attribute__((constructor))
static void ctor_init_table_55816(void) {
	init_table_55816();
}
...
int nox_xxx_cliPlrInfoLoadFromFile_41A2E0(char* path, int pind) {
	...
	*getMemU32Ptr(0x5D4594, 527700) = *getMemU16Ptr(0x5D4594, 527700);
	...
	while (1) {
		...
		int call_res = call_table_55816_fnc(a2b, (void*)v3, v4);
		if (!call_res && csec->fnc) {
			call_res = csec->fnc(v3, (int)v4);
		}
		if (!call_res) {
	...
	if (result) {
		...
		if ((uint8_t)a1) {
			...
			*getMemU32Ptr(0x5D4594, 527700) = *(unsigned short*)(v2 + 4);
			...
			if (nox_crypt_IsReadOnly() == 1) {
				sub_56F8C0(*(uint32_t*)(*(uint32_t*)(v2 + 276) + 4604), *(unaligned_float*)(v1 + 28));
				sub_4D81A0(v1);
			}
			if ((short)v7 >= 2) {
...
int sub_420E80(float a1, float a2, float a3) {
	...
	if (nox_xxx_polygonNextAngle_587000_60356 > 1u) {
		...
		do {
			if (*((uint32_t*)v4 + 2)) {
				v6 = *((unaligned_float*)v4 + 1) - a2;
				v7 = v6 * v6 + (*(unaligned_float*)v4 - a1) * (*(unaligned_float*)v4 - a1);
				if (v7 < a3) {
					a3 = v7;
					v3 = (int)(v4 - 4);
				}
...
void sub_4214D0() {
	...
	if (*getMemU16Ptr(0x5D4594, 588072) >= 3u) {
		...
		if (v0) {
			...
			*((uint32_t*)v0 + 22) = nox_float2int(*((unaligned_float*)v2 + 1));
			*((uint32_t*)v0 + 23) = nox_float2int(*((unaligned_float*)v2 + 2));
			*((uint32_t*)v0 + 24) = nox_float2int(*((unaligned_float*)v2 + 1));
			v3 = nox_float2int(*((unaligned_float*)v2 + 2));
			v4 = 1;
			...
			*((uint32_t*)v0 + 25) = v3;
			if (!v5) {
				do {
					...
					if (*((unaligned_float*)v6 + 1) >= (double)*((int*)v0 + 22)) {
						if (*((unaligned_float*)v6 + 1) > (double)*((int*)v0 + 24)) {
							*((uint32_t*)v0 + 24) = nox_float2int(*((unaligned_float*)v6 + 1));
						}
					} else {
						*((uint32_t*)v0 + 22) = nox_float2int(*((unaligned_float*)v6 + 1));
					}
					if (*((unaligned_float*)v6 + 2) >= (double)*((int*)v0 + 23)) {
						if (*((unaligned_float*)v6 + 2) > (double)*((int*)v0 + 25)) {
							*((uint32_t*)v0 + 25) = nox_float2int(*((unaligned_float*)v6 + 2));
						}
					} else {
						*((uint32_t*)v0 + 23) = nox_float2int(*((unaligned_float*)v6 + 2));
					}
					++v4;
...
int nox_xxx_polygon_421660(int* a1, int a2) {
	...
	v12.field_0 = nox_float2int(*((unaligned_float*)v7 + 1));
	v8 = nox_float2int(*((unaligned_float*)v7 + 2));
	v9 = *(uint16_t*)(a2 + 128);
	v10 = 1;
	for (v12.field_4 = v8; v10 <= v9; ++v10) {
		v11 = getMemAt(0x5D4594, 535844 + 16 * *(uint32_t*)(*(uint32_t*)(a2 + 108) + 4 * (v10 % (int)v9)));
		if (v10 & 1) {
			v12.field_8 = nox_float2int(*((unaligned_float*)v11 + 1));
			v12.field_C = nox_float2int(*((unaligned_float*)v11 + 2));
		} else {
			v12.field_0 = nox_float2int(*((unaligned_float*)v11 + 1));
			v12.field_4 = nox_float2int(*((unaligned_float*)v11 + 2));
		}
...
int sub_421880(int a1, int a2, float a3) {
	...
	v9.field_0 = nox_float2int(*((unaligned_float*)v3 + 1));
	v4 = nox_float2int(*((unaligned_float*)v3 + 2));
	v5 = 1;
	...
	while (1) {
		...
		if (v5 & 1) {
			v9.field_8 = nox_float2int(*((unaligned_float*)v7 + 1));
			v9.field_C = nox_float2int(*((unaligned_float*)v7 + 2));
		} else {
			v9.field_0 = nox_float2int(*((unaligned_float*)v7 + 1));
			v9.field_4 = nox_float2int(*((unaligned_float*)v7 + 2));
		}
...
void nox_xxx_questCheckSecretArea_421C70(nox_object_t* a1p) {
	...
	if (*(uint8_t*)(v1 + 2064) == 31) {
		...
		if (*(int*)(v1 + 3664) != -559023410 && *(unaligned_float*)(a1 + 56) == *(unaligned_float*)(a1 + 72) &&
			*(unaligned_float*)(a1 + 60) == *(unaligned_float*)(a1 + 76)) {
			return;
		}
		v2 = nox_float2int(*(unaligned_float*)(a1 + 56));
...
void nox_xxx_monsterPolygonEnter_421FF0(nox_object_t* a1p) {
	...
	if (a1 && *(uint8_t*)(a1 + 8) & 2 &&
		(*v1 == -559023410 || *(unaligned_float*)(a1 + 56) != *(unaligned_float*)(a1 + 72) || *(unaligned_float*)(a1 + 60) != *(unaligned_float*)(a1 + 76))) {
		v2 = nox_float2int(*(unaligned_float*)(a1 + 56));
		v3 = *(unaligned_float*)(a1 + 60);
		v10.field_0 = v2;
