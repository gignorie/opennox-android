	...
	if (*(uint32_t*)(a1 + 112) & 0x13001000) {
		...
		if (v4) {
			if (*(float* (**)(int, int, int, int, int, float*))(v4 + 76) == sub_4E0380) {
				v5 = (double)*a2 * *(unaligned_float*)(v4 + 80);
				*a2 = nox_float2int(v5);
				v6 = (double)*a3 * *(unaligned_float*)(v4 + 80);
				...
				if (*v4) {
					...
					if (v7) {
						...
						if (v8 >= v9 * *getMemDoublePtr(0x581450, 9608)) {
							if (v8 >= v9 * *(unaligned_double*)&qword_581450_9544) {
								goto LABEL_16;
							}
...
int sub_466950(int a1) {
	...
	*(uint32_t*)&v6[16] = a1;
	...
	v5[0] = 0;
	v5[1] = 850;
	v4 = nox_gui_newSlider_4B4EE0(a1, 1033, 524, 42, 16, 91, v6, (unaligned_float*)v5);
...
int nox_xxx_cliSetTotalHealth_470C80(int a1, int a2) {
	...
	if (dword_8531A0_2576) {
		*(unaligned_u32*)(dword_8531A0_2576 + 2247) = a2;
	}
	result = a1;
...
int nox_xxx_cliSetManaAndMax_470CE0(int a1, int a2) {
	...
	if (dword_8531A0_2576) {
		*(unaligned_u32*)(dword_8531A0_2576 + 2243) = a2;
	}
	result = a1;
		...
		if (v7) {
			...
			if (v8 < v9 * *getMemDoublePtr(0x581450, 9608)) {
				*((uint32_t*)v3 + 4) = *getMemU32Ptr(0x85B3FC, 940);
				v12 = 1;
			} else if (v8 < v9 * *(unaligned_double*)&qword_581450_9544) {
	...
	if (*((int*)v1 + 2) >= 1) {
		...
		if (v6 > 0) {
			while (1) {
				...
				v12 = v22 + v21;
				v22 = v12;
				if (v12 >= *(unaligned_double*)&qword_581450_9512) {
					--v8;
					--v10;
					++v11;
					v22 = v22 - *(unaligned_double*)&qword_581450_9512;
				}
...
int sub_4721A0(int a1) {
	if (a1) {
		return nox_window_set_hidden(*(int*)&dword_5d4594_1090276, 0);
	} else {
		return nox_window_set_hidden(*(int*)&dword_5d4594_1090276, 1);
	}
}
...
int nox_xxx_cliDrawMinimap_472600(int a1, int a2) {
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_SHOW_AI)) {
		...
		for (j = (unaligned_float*)nox_xxx_minimapFirstMonster_50AAE0(); j; j = (unaligned_float*)nox_xxx_minimapNextMonster_50AB10()) {
			nox_client_drawSetColor_434460(*getMemIntPtr(0x85B3FC, 940));
