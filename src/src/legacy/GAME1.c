...
double sub_415BD0(int a1) {
	...
	if (*(uint32_t*)(a1 + 8) & 0x2000000 &&
		(v1 = (unaligned_float*)nox_xxx_equipClothFindDefByTT_413270(*(unsigned short*)(a1 + 4))) != 0) {
		result = v1[16];
	} else {
		result = 0.0;
	}
...
double nox_xxx_itemApplyDefendEffect_415C00(int a1) {
	...
	v1 = *(int**)(a1 + 692);
	v2 = (unaligned_float*)nox_xxx_equipClothFindDefByTT_413270(*(unsigned short*)(a1 + 4));
	if (!v2) {
		return v6;
	}
	v6 = v2[16];
...
int sub_417F50(int a1) {
	...
	*(unaligned_float*)(v8 + 24) = nox_xxx_gamedataGetFloat_419D40("FlagballResetVel");
		...
		if (!v2 || ((v3 = *(uint32_t*)(v2 + 276), *(uint32_t*)(v3 + 2060) != nox_player_netCode_85319C) ||
			...
			if (v7) {
				do {
					v8 = *((uint32_t*)v7 + 18);
					if (v8) {
						v9 = *(unaligned_float*)(v8 + 60) - *(unaligned_float*)(i + 60);
						v10 = *(unaligned_float*)(v8 + 56) - *(unaligned_float*)(i + 56);
						v11 = v10 * v10 + v9 * v9;
						if (v11 < v12) {
							v12 = v11;
							v6 = (int)v7;
