...
LABEL_120:
	...
	case 0xB:
		...
		if (v43 & 4) {
			if (!*(uint32_t*)(v12 + 304)) {
				*(uint32_t*)(v12 + 304) = 2;
				*(unaligned_float*)(v12 + 300) = v42;
			}
		} else if (v43 & 2 && !*(uint32_t*)(v12 + 2188)) {
			*(uint32_t*)(v12 + 2188) = 2;
			*(unaligned_float*)(v12 + 2184) = v42;
		}
		break;
	case 1:
	case 0xC:
		...
		if (v34 & 4) {
			if (!*(uint32_t*)(v12 + 304)) {
				v36 = a5;
				*(uint32_t*)(v12 + 304) = 2;
				*(unaligned_float*)(v12 + 300) = v36;
			}
		} else if (v34 & 2 && !*(uint32_t*)(v12 + 2188)) {
			v37 = a5;
			*(uint32_t*)(v12 + 2188) = 2;
			*(unaligned_float*)(v12 + 2184) = v37;
		}
		break;
	case 2:
	...
	case 0x10:
		...
		if (v38 & 4) {
			if (!*(uint32_t*)(v12 + 304)) {
				v39 = a5;
				*(uint32_t*)(v12 + 304) = 2;
				*(unaligned_float*)(v12 + 300) = v39;
			}
		} else if (v38 & 2 && !*(uint32_t*)(v12 + 2188)) {
			v40 = a5;
			*(uint32_t*)(v12 + 2188) = 2;
			*(unaligned_float*)(v12 + 2184) = v40;
		}
		break;
	case 9:
	case 0x11:
...
void nox_xxx_playerDecrementHPMana_4E20F0(int a1, int a2, float a3) {
	...
	if (a1 && a2) {
		v4 = *(uint32_t*)(a1 + 8);
		if (v4 & 4) {
			v5 = a3 + *(unaligned_float*)(*(uint32_t*)(a1 + 748) + 84);
		} else {
			if (!(v4 & 2)) {
				goto LABEL_8;
			}
			v5 = a3 + *(unaligned_float*)(*(uint32_t*)(a1 + 748) + 4);
		}
		a3 = v5;
	LABEL_8:
		v6 = nox_float2int(a3);
		...
		*(uint32_t*)a2 = v6;
		v7 = *(uint32_t*)(v3 + 8);
		if (v7 & 4) {
			*(unaligned_float*)(*(uint32_t*)(v3 + 748) + 84) = a3 - (double)v8;
		} else if (v7 & 2) {
			*(unaligned_float*)(*(uint32_t*)(v3 + 748) + 4) = a3 - (double)v8;
		}
	}
}
	...
	if (v7) {
		...
		do {
			if (v7[2] & 0x2000000) {
				v9 = v7[4];
				if (v9 & 0x100) {
					v11 = nox_xxx_itemApplyDefendEffect_415C00((int)v7) / *(unaligned_float*)&v10 * (double)a4;
...
int sub_4E23C0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (nox_xxx_testUnitBuffs_4FF350(a1, 23)) {
		...
		result = 1;
	} else if (a2 && (!a3 ? (v7 = *(unaligned_float*)(a2 + 76), a3a.field_0 = *(unaligned_float*)(a2 + 72), a3a.field_4 = v7)
						  : (v6 = *(unaligned_float*)(a3 + 76), a3a.field_0 = *(unaligned_float*)(a3 + 72), a3a.field_4 = v6),
...
int nox_xxx_damageMonsterGen_4E27D0(int a1, int a2, int a3, int a4, int a5) {
	...
	if ((unsigned int)(gameFrame() - *(uint32_t*)(a1 + 536)) > 0x14 || !(gameFrame() % 0x1Eu)) {
		if (a3) {
			a1a.field_0 = *(unaligned_float*)(a3 + 56) - *(unaligned_float*)(a1 + 56) + 0.0099999998;
			a1a.field_4 = *(unaligned_float*)(a3 + 60) - *(unaligned_float*)(a1 + 60) + 0.0099999998;
			nox_xxx_utilNormalizeVector_509F20(&a1a);
			a1a.field_0 = a1a.field_0 * 22.0 + *(unaligned_float*)(a1 + 56);
			a1a.field_4 = a1a.field_4 * 22.0 + *(unaligned_float*)(a1 + 60);
			sub_523150(240, 26, &a1a.field_0);
		} else {
			sub_523150(240, 26, (unaligned_float*)(a1 + 56));
		}
...
void nox_xxx_unitRaise_4E46F0(nox_object_t* obj, float a2) {
	...
	if (*(unaligned_float*)(a1 + 104) != a2) {
		nox_xxx_unitNeedSync_4E44F0(a1);
		*(unaligned_float*)(a1 + 104) = a2;
		if (*(uint32_t*)(a1 + 8) & 0x20400004) {
			v2 = (int*)(a1 + 560);
			v3 = 32;
			do {
...
//----- (004E4A70) --------------------------------------------------------
double nox_xxx_objectGetMass_4E4A70(int a1) { return *(unaligned_float*)(a1 + 120); }
...
double nox_xxx_calcDistance_4E6C00(nox_object_t* a1p, nox_object_t* a2p) {
	...
	result = v5;
	if (v4 == 2) {
		result = v5 - *(unaligned_float*)(a1 + 176);
	} else if (v4 == 3) {
		v7 = *(unaligned_float*)(a1 + 184) * 0.5;
		v10 = *(unaligned_float*)(a1 + 188) * 0.5;
		if (v7 <= v10) {
			v7 = v10;
		}
		result = v5 - v7;
	...
	v8 = *(uint32_t*)(a2 + 172);
	if (v8 == 2) {
		result = result - *(unaligned_float*)(a2 + 176);
	} else if (v8 == 3) {
		v9 = *(unaligned_float*)(a2 + 184) * 0.5;
		v11 = *(unaligned_float*)(a2 + 188) * 0.5;
		if (v9 <= v11) {
			v9 = v11;
		}
		result = result - v9;
...
int sub_4E6CE0(float2* a1, float2* a2) {
	...
	*(unaligned_float*)&dword_5d4594_1565628 = a2->field_0 - a1->field_0;
	*(unaligned_float*)&dword_5d4594_1565632 = a2->field_4 - a1->field_4;
	*getMemFloatPtr(0x5D4594, 1565652) = *(unaligned_float*)&dword_5d4594_1565628 * 0.41304299 - *(unaligned_float*)&dword_5d4594_1565632;
	v2 = *(unaligned_float*)&dword_5d4594_1565628 * 2.4210529 - *(unaligned_float*)&dword_5d4594_1565632;
	*getMemFloatPtr(0x5D4594, 1565656) = v2;
	*getMemFloatPtr(0x5D4594, 1565636) = *(unaligned_float*)&dword_5d4594_1565628 * -2.4210529 - *(unaligned_float*)&dword_5d4594_1565632;
	*getMemFloatPtr(0x5D4594, 1567708) = *(unaligned_float*)&dword_5d4594_1565628 * -0.41304299 - *(unaligned_float*)&dword_5d4594_1565632;
...
int nox_xxx_objectUnkUpdateCoords_4E7290(nox_object_t* a1p) {
	...
	case 1:
		...
		*(uint32_t*)(a1 + 244) = v4;
		break;
	case 2:
		*(unaligned_float*)(a1 + 232) = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a1 + 176);
		*(unaligned_float*)(a1 + 236) = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a1 + 176);
		*(unaligned_float*)(a1 + 240) = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 56);
		*(unaligned_float*)(a1 + 244) = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 60);
		break;
	case 3:
		*(unaligned_float*)(a1 + 232) = *(unaligned_float*)(a1 + 200) + *(unaligned_float*)(a1 + 56);
		*(unaligned_float*)(a1 + 236) = *(unaligned_float*)(a1 + 196) + *(unaligned_float*)(a1 + 60);
		*(unaligned_float*)(a1 + 240) = *(unaligned_float*)(a1 + 208) + *(unaligned_float*)(a1 + 56);
		*(unaligned_float*)(a1 + 244) = *(unaligned_float*)(a1 + 220) + *(unaligned_float*)(a1 + 60);
		break;
	}
	return result;
}
...
void nox_xxx_collidePlayer_4E8460(int a1, int a2) {
	...
	if (!(v2 & 6) || (v3 = *(uint16_t**)(a2 + 556), !*v3) && v3[2]) {
		if (!(v2 & 0x400000) && (signed char)*(uint8_t*)(a2 + 16) >= 0 &&
			*(unaligned_float*)(a2 + 120) <= (double)*(unaligned_float*)(a1 + 120)) {
			goto LABEL_26;
		}
	}
	if ((v2 & 0x80u) == 0) {
...
LABEL_14:
	...
	if (a2) {
		...
		v14 = *(unaligned_float*)(a1 + 68) * 0.043478262;
		v15 = nox_float2int(v14);
		v13 = *(unaligned_float*)(a1 + 64) * 0.043478262;
...
void sub_4E86E0(int a1, float* a2) {
	...
	if (a1) {
		v3 = a2;
		if (a2) {
			v12 = *(unaligned_float*)(a1 + 120);
			v10 = v3[30];
			v8 = v10 + v12;
			v4 = (v12 - v10) / v8;
			v9 = (v10 + v10) / v8;
			v5 = *(unaligned_float*)(v2 + 84) * v4 + v9 * v3[21];
			v6 = (v10 - v12) / v8;
			v7 = (v12 + v12) / v8;
			v11 = v6 * v3[20] + v7 * *(unaligned_float*)(v2 + 80);
			v13 = v6 * v3[21] + v7 * *(unaligned_float*)(v2 + 84);
			*(unaligned_float*)(v2 + 80) = *(unaligned_float*)(v2 + 80) * v4 + v9 * v3[20];
			*(unaligned_float*)(v2 + 84) = v5;
			v3[21] = v13;
			v3[20] = v11;
		}
	}
...
void nox_xxx_collideProjectileSpark_4E8880(int a1, int a2) {
	...
	if (a2) {
		...
		v8 = *v2;
		v6 = *(unaligned_float*)(a1 + 68) * 0.043478262;
		v7 = nox_float2int(v6);
		v5 = *(unaligned_float*)(a1 + 64) * 0.043478262;
		v4 = nox_float2int(v5);
...
void nox_xxx_collideBoom_4E9770(int a1, int a2, float* a3) {
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v3 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 ||
		...
		if (a2) {
			...
			nox_xxx_collideReflect_57B810(a3, a1 + 80);
			v4 = *(unaligned_float*)(a1 + 84);
			v12.field_0 = *(unaligned_float*)(a1 + 80);
			v12.field_4 = v4;
			v5 = nox_xxx_math_509ED0(&v12);
			v6 = *(unaligned_float*)(a1 + 80) * 0.5;
			*(uint16_t*)(a1 + 126) = v5;
			*(unaligned_float*)(a1 + 80) = v6;
			*(unaligned_float*)(a1 + 84) = *(unaligned_float*)(a1 + 84) * 0.5;
			v7 = (int*)sub_537760();
			if (v7) {
...
void nox_xxx_fireballCollide_4E9AC0(int a1, int a2) {
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v5 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 ||
		...
		if (v4) {
			...
			nox_xxx_mapDamageUnitsAround_4E25B0(v2 + 56, v8, *(unaligned_float*)&v9, v10, 1, v12, v13);
			nox_xxx_netSparkExplosionFx_5231B0((unaligned_float*)(v2 + 56), *v3);
...
void nox_xxx_collideSulphurShot2_4E9D80(int a1, int a2, float* a3) {
	...
	if (a2) {
		...
		nox_xxx_collideReflect_57B810(a3, a1 + 80);
		v10 = *v3;
		v8 = *(unaligned_float*)(a1 + 68) * 0.043478262;
		v9 = nox_float2int(v8);
		v7 = *(unaligned_float*)(a1 + 64) * 0.043478262;
		v4 = nox_float2int(v7);
...
void nox_xxx_collideSulphurShot_4E9E50(int a1, int a2, int a3) {
	...
	nox_xxx_collideSulphurShot2_4E9D80(a1, a2, (unaligned_float*)a3);
}
...
void nox_xxx_collidePixie_4EA080(int a1, int a2, float* a3) {
	...
	if (a2) {
		...
		v5 = *(unaligned_float*)(a1 + 80) + *(unaligned_float*)(a1 + 64);
		*(uint16_t*)(a1 + 126) = v4;
		*(unaligned_float*)(a1 + 64) = v5;
		v6 = *(unaligned_float*)(a1 + 84) + *(unaligned_float*)(a1 + 68);
		*(unaligned_float*)(a1 + 68) = v6;
		v14 = *v3;
		v12 = v6 * 0.043478262;
		v13 = nox_float2int(v12);
		v11 = *(unaligned_float*)(a1 + 64) * 0.043478262;
...
void nox_xxx_collideWallReflectSpark_4EA200(int a1, int a2, float2* a3) {
	...
	if (a2) {
		...
		v5 = *(unaligned_float*)(a1 + 80);
		if (a3->field_0 * a3->field_4 <= 0.0) {
			*(unaligned_float*)(a1 + 80) = *(unaligned_float*)(a1 + 84);
		} else {
			*(unaligned_float*)(a1 + 80) = -*(unaligned_float*)(a1 + 84);
			v5 = -v5;
		}
		*(unaligned_float*)(a1 + 84) = v5;
		v13 = *v3;
		v11 = *(unaligned_float*)(a1 + 68) * 0.043478262;
		v12 = nox_float2int(v11);
		v10 = *(unaligned_float*)(a1 + 64) * 0.043478262;
...
void nox_xxx_pickupFlagCtf_4EA490(int a1, int a2) {
	...
	if (nox_xxx_servCompareTeams_419150(v3 + 48, a1 + 48)) {
		v5 = *(uint32_t*)(a1 + 748);
		if (fabs(*(unaligned_float*)(a1 + 56) - *(unaligned_float*)v5) > *getMemDoublePtr(0x581450, 10160) ||
			fabs(*(unaligned_float*)(a1 + 60) - *(unaligned_float*)(v5 + 4)) > *getMemDoublePtr(0x581450, 10160)) {
			v15 = *(float2**)(a1 + 748);
			a2 = *(uint32_t*)(v3 + 36);
			...
			if (v6) {
				while (1) {
					if (*(uint32_t*)(v6 + 8) & 0x10000000) {
						...
						nox_xxx_createAt_4DAA50(v6, 0, *(unaligned_float*)v8, *(unaligned_float*)(v8 + 4));
		...
		if ((v3 & 0x80u) == 0) {
			if (*(uint32_t*)(a1 + 16) & 0x1000000) {
				...
				if (v4 == 3) {
					...
					if (nox_xxx_map_57B850((float2*)(a1 + 56), (unaligned_float*)(a1 + 172), (float2*)(a2 + 56))) {
						*(uint32_t*)(a2 + 16) |= 0x60000u;
						*(unaligned_float*)(a2 + 164) = (double)*(int*)(v2 + 8);
						*(unaligned_float*)(a2 + 168) = (double)*(int*)(v2 + 12);
				...
				v5 = *(unaligned_float*)(a2 + 176) + *(unaligned_float*)(a2 + 176);
				if (v5 <= *(unaligned_float*)(a1 + 184) && v5 <= *(unaligned_float*)(a1 + 188)) {
					if (nox_xxx_map_57B850((float2*)(a1 + 56), (unaligned_float*)(a1 + 172), (float2*)(a2 + 56))) {
						*(uint32_t*)(a2 + 16) |= 0x60000u;
						*(unaligned_float*)(a2 + 164) = (double)*(int*)(v2 + 8);
						*(unaligned_float*)(a2 + 168) = (double)*(int*)(v2 + 12);
...
void sub_4EACA0(int a1, int a2) {
	...
	if (a2) {
		if ((signed char)*(uint8_t*)(a2 + 8) >= 0) {
			...
			*(unaligned_float*)(a2 + 164) = (double)*v3;
			*(unaligned_float*)(a2 + 168) = (double)v3[1];
			nox_xxx_teleportToMB_4E7190((uint8_t*)a2, (unaligned_float*)(a2 + 164));
		...
		if (a2 == *(uint32_t*)(v3 + 508)) {
			...
			if (!v11 || *(uint32_t*)(v11 + 16) & 0x8020) {
				...
				if ((v13 & 0x8000) == 0 && v12) {
					...
					v22[7] = v3;
					v22[5] = v15;
					*(unaligned_float*)v22 = nox_xxx_calcBoltDamage_4EF1E0(v14, v24);
					v16 = *(unaligned_float*)(v3 + 176) + 30.0;
					LOBYTE(v22[1]) = 0;
					v22[3] = v11;
					*(unaligned_float*)&v22[2] = v16;
					v22[6] = 0;
					...
					(*(void (**)(int, int, int, uint32_t, uint32_t))(v7 + 716))(
						v7, v11, v3, (long long)(*(unaligned_float*)v22 + *(unaligned_double*)&qword_581450_9544), 0);
					...
					if (*(uint8_t*)(v4 + 24) == 1) {
						...
						sub_4ED0C0(v3, v19);
						nox_xxx_createAt_4DAA50((int)v19, 0, *(unaligned_float*)(v3 + 56), *(unaligned_float*)(v3 + 60));
						nox_xxx_delayedDeleteObject_4E5CC0(v3);
						return;
					}
					if (!*(uint8_t*)(v4 + 4) && v18) {
...
int sub_4EB250(int a1) {
	...
	*getMemU32Ptr(0x5D4594, 1567836) = 1259902592;
	a1a.field_0 = *(unaligned_float*)(a1 + 56) - 400.0;
	a1a.field_4 = *(unaligned_float*)(a1 + 60) - 400.0;
	a1a.field_8 = *(unaligned_float*)(a1 + 56) + 400.0;
	a1a.field_C = *(unaligned_float*)(a1 + 60) + 400.0;
	nox_xxx_getUnitsInRect_517C10(&a1a, sub_4EB340, a1 + 56);
	result = dword_5d4594_1567928;
	if (dword_5d4594_1567928) {
		*(uint8_t*)(v2 + 24) = 2;
		result = dword_5d4594_1567928;
		v4 = *(unaligned_float*)(dword_5d4594_1567928 + 56) - *(unaligned_float*)(a1 + 56);
		v5 = *(unaligned_float*)(dword_5d4594_1567928 + 60) - *(unaligned_float*)(a1 + 60);
		v8 = v5;
		v6 = sqrt(v5 * v8 + v4 * v4) + *(unaligned_double*)&qword_581450_10176;
		v1[20] = v4 * v1[136] / v6;
		v1[21] = v8 * v1[136] / v6;
	}
	return result;
...
void sub_4EB340(float* a1, int a2) {
	...
	if ((uint32_t)a1[2] & 0x20006) {
		if (!((uint32_t)a1[4] & 0x8020) && !nox_xxx_testUnitBuffs_4FF350((int)a1, 0) &&
			a1 != *(unaligned_float**)getMemAt(0x5D4594, 1567840) && a1 != *(unaligned_float**)getMemAt(0x5D4594, 1567932)) {
			if (nox_xxx_mapCheck_537110((int)a1, *getMemIntPtr(0x5D4594, 1567924))) {
				v2 = *(unaligned_float*)a2 - a1[14];
				v3 = *(unaligned_float*)(a2 + 4) - a1[15];
				v4 = v3 * v3 + v2 * v2;
...
void nox_xxx_collideArrow_4EB490(int a1, int a2) {
	...
	*(unaligned_float*)v21 = v10;
	...
	v20 = LOBYTE(v21[1]);
	v18 = (long long)(*(unaligned_float*)v21 + *(unaligned_double*)&qword_581450_9544);
...
void nox_xxx_collideBearTrap_4EB890(int* a1, int a2) {
	...
	if (a2 && sub_4E9A30((int)a1, a2)) {
		...
		if (v2) {
			nox_xxx_createAt_4DAA50((int)v2, a1[127], *((unaligned_float*)a1 + 14), *((unaligned_float*)a1 + 15));
...
int nox_GlyphDrop_4ED500(int a1, int a2, float2* a3) {
	...
	*(float2*)(*(uint32_t*)(a2 + 692) + 28) = *a3;
	v5.field_0 = *(unaligned_float*)(a1 + 56) - a3->field_0;
	v5.field_4 = *(unaligned_float*)(a1 + 60) - a3->field_4;
...
int nox_xxx_drop_4ED810(int a1, int a2, float* a3) {
	...
	v11.field_0 = *(unaligned_float*)(a1 + 56);
	v11.field_4 = v4;
	float a3_x = 0.0f, a3_y = 0.0f;
	if (a3) {
		memcpy(&a3_x, a3, sizeof(float));
		memcpy(&a3_y, (char*)a3 + sizeof(float), sizeof(float));
	}
	v5 = a3_y;
	v11.field_8 = a3_x;
	v11.field_C = a3_y;
...
uint32_t* nox_xxx_dropAllItems_4EDA40(uint32_t* a1) {
	...
	v12 = 0.0;
	while (v3) {
		if (nox_xxx_unitDropCheckSome_4EDCD0((int)a1, v3) && *(unaligned_float*)(v3 + 176) > (double)v12) {
			v12 = *(unaligned_float*)(v3 + 176);
		}
		v3 = *(uint32_t*)(v3 + 496);
	}
	result = (uint32_t*)a1[126];
	v5 = *((unaligned_float*)a1 + 15);
	v6 = -1;
	v15 = 0;
	v7 = 3;
	v20 = 0;
	...
	v14 = 0;
	v16 = 0;
	v22.field_0 = *((unaligned_float*)a1 + 14);
	v22.field_4 = v5;
	v23 = result;
	v13 = v12 + v12 + 6.0;
	if (!result) {
		...
		if (a2) {
			...
			if (v31) {
				...
				if (v2 & 0x100) {
					...
					a1a.field_0 = *(unaligned_float*)(a2 + 56) - *(unaligned_float*)(a1 + 56);
					a1a.field_4 = *(unaligned_float*)(a2 + 60) - *(unaligned_float*)(a1 + 60);
				}
				nox_xxx_utilNormalizeVector_509F20(&a1a);
				v3 = sub_4EE2A0(a1) + 4.0 + 15.0;
				a3[0].field_0 = v3 * a1a.field_0 + *(unaligned_float*)(a1 + 56);
				a3[0].field_4 = v3 * a1a.field_4 + *(unaligned_float*)(a1 + 60);
				v4 = -a1a.field_4;
				v29 = -v4;
				v30 = -a1a.field_0;
				...
				v5 = a3[0].field_0 - *(unaligned_float*)(a2 + 56);
				v6 = a3[0].field_4 - *(unaligned_float*)(a2 + 60);
				v27 = v6 * v6 + v5 * v5;
				v7 = a3[1].field_0 - *(unaligned_float*)(a2 + 56);
				v8 = a3[1].field_4 - *(unaligned_float*)(a2 + 60);
				v9 = v8 * v8 + v7 * v7;
				v10 = a3[2].field_0 - *(unaligned_float*)(a2 + 56);
				v11 = a3[2].field_4 - *(unaligned_float*)(a2 + 60);
				v28 = v11 * v11 + v10 * v10;
				if (v27 >= v9) {
					v13 = a3[1].field_4;
					v12 = a3[1].field_0;
				...
				v19 = *(unaligned_float*)(a1 + 56);
				v34.field_4 = *(unaligned_float*)(a1 + 60);
				v34.field_0 = v19;
				v34.field_8 = a3[2].field_0;
				v34.field_C = a3[2].field_4;
				if (!nox_xxx_mapTraceRay_535250(&v34, 0, 0, 1)) {
					v20 = *(unaligned_float*)(a2 + 60);
					a3[2].field_0 = *(unaligned_float*)(a2 + 56);
					a3[2].field_4 = v20;
				}
				v34.field_8 = a3[1].field_0;
				v34.field_C = a3[1].field_4;
				if (!nox_xxx_mapTraceRay_535250(&v34, 0, 0, 1)) {
					v21 = *(unaligned_float*)(a2 + 60);
					a3[1].field_0 = *(unaligned_float*)(a2 + 56);
					a3[1].field_4 = v21;
				}
				v34.field_8 = a3[0].field_0;
				v34.field_C = a3[0].field_4;
				if (!nox_xxx_mapTraceRay_535250(&v34, 0, 0, 1)) {
					v22 = *(unaligned_float*)(a2 + 60);
					a3[0].field_0 = *(unaligned_float*)(a2 + 56);
					a3[0].field_4 = v22;
				}
				if (v31 == 1) {
...
double sub_4EE2A0(int a1) {
	...
	v1 = *(uint32_t*)(a1 + 172);
	if (v1 == 2) {
		return *(unaligned_float*)(a1 + 176);
	}
	if (v1 != 3) {
		return 0.0;
	}
	if (*(unaligned_float*)(a1 + 184) <= (double)*(unaligned_float*)(a1 + 188)) {
		return *(unaligned_float*)(a1 + 188) * 0.5;
	}
	return *(unaligned_float*)(a1 + 184) * 0.5;
}
...
int nox_xxx_plrReadVals_4EEDC0(nox_object_t* a1p, int a2) {
	...
	if (nox_common_gameFlags_check_40A5C0(0x2000)) {
		...
		*(unaligned_u32*)(v4 + 2239) = nox_float2int(v5[3]);
		v16 = v5[2];
		*(unaligned_float*)(v2 + 548) = v5[2] * 0.000099999997;
		*(unaligned_u32*)(v4 + 2235) = nox_float2int(v16);
		...
		*(unaligned_u32*)(v4 + 2239) = nox_float2int(v19);
		v10 = (v5[2] - v26[2]) * v22 / ((double)NOX_PLAYER_MAX_LEVEL - 1) + v26[2];
		*(unaligned_float*)(v2 + 548) = v10 * 0.000099999997;
		v20 = v10 + 0.5;
		*(unaligned_u32*)(v4 + 2235) = nox_float2int(v20);
		if (!*(uint8_t*)(v4 + 2251)) {
			nox_xxx_abilGivePlayerAll_4EED40(v2, v24, a2);
		}
	}
	*(unaligned_float*)(v2 + 120) = (double)*(unaligned_i32*)(v4 + 2239) / v25[3] * 20.0 + 10.0;
	*(uint16_t*)(*(uint32_t*)(v3 + 276) + 3652) =
		(long long)(((double)*(unaligned_i32*)(v4 + 2239) / v25[3] * 1250.0 + 750.0) * *getMemDoublePtr(0x581450, 10216));
	*(uint16_t*)(v2 + 490) = *(uint16_t*)(*(uint32_t*)(v3 + 276) + 3652);
	sub_56F780(*(uint32_t*)(*(uint32_t*)(v3 + 276) + 4624), *(unaligned_u32*)(v4 + 2239));
	sub_56F780(*(uint32_t*)(*(uint32_t*)(v3 + 276) + 4620), *(unaligned_u32*)(v4 + 2235));
	...
	if (nox_common_gameFlags_check_40A5C0(0x2000)) {
		...
		*(uint8_t*)(v1 + 3684) = NOX_PLAYER_MAX_LEVEL;
		...
		for (i = 0; i <= NOX_PLAYER_MAX_LEVEL; ++i) {
			if (nox_xxx_gamedataGetFloatTable_419D70("XPTable", i) > *(unaligned_float*)(a1 + 28)) {
				break;
			}
		}
		v5 = *(uint32_t*)(v1 + 4644);
...
double nox_xxx_calcBoltDamage_4EF1E0(int a1, int a2) {
	...
	if (!nox_common_gameFlags_check_40A5C0(2048) || *(uint32_t*)(a2 + 4) != *getMemU32Ptr(0x5D4594, 1568264)) {
		result = (double)(a1 - *(unsigned short*)(a2 + 60)) * *(unaligned_float*)(a2 + 64) + (double)*(unsigned short*)(a2 + 72);
	} else {
		result = nox_xxx_gamedataGetFloat_419D40("BoltSoloDamageMin") +
				 (double)(a1 - *(unsigned short*)(a2 + 60)) * *(unaligned_float*)(a2 + 64);
	}
	return result;
}
...
void sub_4EF410(int a1, unsigned char a2) {
	...
	*(unaligned_float*)(a1 + 28) = nox_xxx_gamedataGetFloatTable_419D70("XPTable", v2);
...
int nox_xxx_unitInitGold_4F04B0(int a1) {
	...
	if (!*v2) {
		...
		v9 = v8 / (double)v7;
		v6 = nox_common_randomInt_415FA0((long long)(v9 * *(unaligned_double*)&qword_581450_10256),
	...
	for (j = nox_server_getFirstObject_4DA790(); j; j = nox_server_getNextObject_4DA7A0(j)) {
		...
		if (((unsigned short)v6 == dword_5d4594_1568280 || v6 == *getMemU32Ptr(0x5D4594, 1568284)) &&
			...
			if (v4 == v3) {
				...
				if (v7) {
					nox_xxx_createAt_4DAA50((int)v7, 0, *(unaligned_float*)(j + 56), *(unaligned_float*)(j + 60));
...
int nox_xxx_servMapLoadPlaceObj_4F3F50(nox_object_t* a1p, int a2, void* a3p) {
	...
	if (nox_common_gameFlags_check_40A5C0(0x400000) || nox_xxx_getUnitDefDd10_4E3BA0(*(unsigned short*)(a1 + 4))) {
		if (a3) {
			...
			*(unaligned_float*)(a1 + 56) = *(unaligned_float*)(a1 + 56) - (double)(int)(23 * *(uint32_t*)v6) + (double)*a3 - 11.0;
			*(unaligned_float*)(a1 + 60) = *(unaligned_float*)(a1 + 60) - (double)(int)(23 * *((uint32_t*)v6 + 1)) + (double)a3[1] - 11.0;
		}
		if (nox_common_gameFlags_check_40A5C0(0x400000)) {
			...
			nox_xxx_createAt_4DAA50(a1, a2, *(unaligned_float*)(a1 + 56), *(unaligned_float*)(a1 + 60));
			result = 1;
		} else {
			v7 = *(uint32_t*)(a1 + 504);
			if (v7) {
...
int nox_xxx_readObjectOldVer_4F4170(int a1, int a2, int a3) {
	...
	if (nox_crypt_IsReadOnly()) {
		if (a3 < 40 || a2 < 4) {
			...
			v10 = v3 + 14;
			*((unaligned_float*)v3 + 14) = (double)v23[0];
			*((unaligned_float*)v3 + 15) = (double)v23[1];
		} else {
			v10 = v3 + 14;
...
int nox_xxx_mapReadWriteObjData_4F4530(nox_object_t* a1p, int a2) {
	...
	if (nox_crypt_IsReadOnly()) {
		if ((short)v18 < 4) {
			...
			v8 = v2 + 14;
			*((unaligned_float*)v2 + 14) = (double)v22[0];
			*((unaligned_float*)v2 + 15) = (double)v22[1];
		} else {
			v8 = v2 + 14;
	...
	if (result) {
		...
		if (nox_crypt_IsReadOnly() == 1) {
			...
			*(uint32_t*)(v2 + 8) = a1;
			...
			v4 = (long long)(((double)v9 + *(unaligned_float*)(v1 + 56)) * 0.043478262);
			v9 = *getMemIntPtr(0x587000, 196188 + 8 * v6) / 2;
			v5 = (long long)(((double)v9 + *(unaligned_float*)(v1 + 60)) * 0.043478262);
...
//----- (004F4E50) --------------------------------------------------------
int nox_xxx_unitTriggerXfer_4F4E50(nox_object_t* a1_obj) {
	float a1 = 0;
	int v1;      // edi
	uint8_t* v2; // esi
	int result;  // eax
	...
	v1 = (int)a1_obj;
	v2 = *(uint8_t**)((uintptr_t)a1_obj + 748);
	v13 = *(uint32_t*)((uintptr_t)a1_obj + 136);
	v11 = 61;
	nox_xxx_fileReadWrite_426AC0_file3_fread(&v11, 2u);
	if ((short)v11 > 61) {
		return 0;
	...
	if (result) {
		if (nox_crypt_IsReadOnly()) {
			...
			a1 = v5;
			*(unaligned_float*)(v1 + 184) = v5;
			v6 = (double)v12;
			*(unaligned_float*)(v1 + 188) = v6;
			if (a1 > 60.0) {
			...
			v4 = *(unaligned_float*)(v1 + 188);
			LODWORD(a1) = (long long)*(unaligned_float*)(v1 + 184);
			v12 = (long long)v4;
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 4u);
			nox_xxx_fileReadWrite_426AC0_file3_fread(&v12, 4u);
		}
