	...
	while (1) {
		...
		*v7 = 0;
		...
		case 1:
			...
			*(uint32_t*)(v2 + 64) = 1;
			if (nox_xxx_mapGenReadLine_51E540(a2, getMemAt(0x5D4594, 2487264))) {
				*(unaligned_float*)(v2 + 76) = atof((const char*)getMemAt(0x5D4594, 2487264));
				if (nox_xxx_mapGenReadLine_51E540(a2, getMemAt(0x5D4594, 2487264))) {
...
int sub_5212B0(int a1, uint32_t* a2) {
	...
	while (1) {
		...
		switch (v12) {
		case 0:
			a2a.field_0 = *(unaligned_float*)(a1 + 20);
			a2a.field_4 = (double)v19[0] * 32.526913 + *(unaligned_float*)(a1 + 24);
			break;
		case 1:
			a2a.field_0 = *(unaligned_float*)(a1 + 20);
			a2a.field_4 = *(unaligned_float*)(a1 + 24) - (double)v19[1] * 32.526913;
			break;
		case 2:
			a2a.field_4 = *(unaligned_float*)(a1 + 24);
			a2a.field_0 = (double)v19[2] * 32.526913 + *(unaligned_float*)(a1 + 20);
			break;
		case 3:
			a2a.field_4 = *(unaligned_float*)(a1 + 24);
			a2a.field_0 = *(unaligned_float*)(a1 + 20) - (double)v19[3] * 32.526913;
			break;
		default:
			break;
		}
...
int sub_5217A0(int a1, int a2) {
	...
	v2 = 0;
	v3 = *(uint32_t*)(a2 + 16);
	v4 = *(unaligned_float*)(a2 + 24);
	if (v3 <= 0) {
		return 1;
	}
	v5 = *(uint32_t*)(a2 + 12);
	while (1) {
		v6 = *(unaligned_float*)(a2 + 20);
		v7 = 0;
		if (v5 > 0) {
			while (*(unaligned_float*)(a1 + 64) >= fabs(v6) && *(unaligned_float*)(a1 + 64) >= fabs(v4)) {
				v6 = v6 + 32.526913;
				if (++v7 >= v5) {
					goto LABEL_7;
				}
...
int nox_xxx_mapGenUpdateRoomRect_521850(int a1) {
	...
	result = a1;
	v2 = *(unaligned_float*)(a1 + 28) + *(unaligned_float*)(a1 + 20);
	v3 = *(uint32_t*)(a1 + 24);
	*(uint32_t*)(a1 + 36) = *(uint32_t*)(a1 + 20);
	*(uint32_t*)(a1 + 40) = v3;
	*(unaligned_float*)(a1 + 44) = v2;
	*(unaligned_float*)(a1 + 48) = *(unaligned_float*)(a1 + 32) + *(unaligned_float*)(a1 + 24);
	return result;
}
...
float* nox_xxx_mapGenMakeRoomStruct_521940(int a1, int a2) {
	...
	result = (unaligned_float*)calloc(1u, 0x178u);
	if (result) {
		*(uint32_t*)result = 1;
...
float* sub_521BC0(int a1, float2* a2, float a3, float a4) {
	...
	result = (unaligned_float*)calloc(1u, 0x1Cu);
	if (result) {
		*result = 0.0;
		*(float2*)(result + 1) = *a2;
		result[3] = a3 + a2->field_0;
		result[4] = a4 + a2->field_4;
		result[6] = *(unaligned_float*)(a1 + 368);
...
int sub_521CB0(int a1, int a2, int a3, int a4) {
	...
	v4 = (unaligned_float*)calloc(1u, 0x1Cu);
	if (!v4) {
		return 0;
	}
	v15 = sub_502E70(a4);
	...
	if (v7 >= 0 && v8 >= 0) {
		v17 = sub_526AA0(a4);
		v20.field_0 = (double)nox_xxx_mapGenRandFunc_526AC0(0, v7) * 32.526913 + *(unaligned_float*)(a2 + 36);
		v20.field_4 = (double)nox_xxx_mapGenRandFunc_526AC0(0, v8) * 32.526913 + *(unaligned_float*)(a2 + 40);
		v9 = *((uint32_t*)v17 + 15);
		if (v9 & 1) {
			v20.field_4 = *(unaligned_float*)(a2 + 40);
		} else if (v9 & 2) {
			v20.field_4 = *(unaligned_float*)(a2 + 48) - v16;
		}
		v10 = *((uint32_t*)v17 + 15);
		if (v10 & 4) {
			v20.field_0 = *(unaligned_float*)(a2 + 44) - v15;
		} else if (v10 & 8) {
			v20.field_0 = *(unaligned_float*)(a2 + 36);
		}
		if (v17[60] & 0x10) {
			v22 = (*(uint32_t*)(a2 + 16) - v19) / 2;
			v20.field_0 = (double)(int)((*(uint32_t*)(v6 + 12) - v18) / 2) * 32.526913 + *(unaligned_float*)(v6 + 36);
			v20.field_4 = (double)v22 * 32.526913 + *(unaligned_float*)(v6 + 40);
		}
		*(uint32_t*)v4 = 1;
		v4[1] = v20.field_0;
		v4[2] = v20.field_4;
		...
		*((uint32_t*)v4 + 5) = a4;
		v4[4] = v11;
		v12 = sub_521EB0((unaligned_float*)v6, v4);
		v14 = v4;
		if (!v12) {
			goto LABEL_18;
		}
...
int sub_521F10(int a1, float* a2) {
	...
	while (1) {
		if ((unaligned_float*)v2 != a2) {
			v4 = a2[1] + 0.5;
			if (v4 < *(unaligned_float*)(v2 + 12) - 0.5) {
				v6 = a2[3] - 0.5;
				if (v6 > *(unaligned_float*)(v2 + 4) + 0.5) {
					v9 = *(unaligned_float*)(v2 + 16) - 0.5;
					v5 = a2[2] + 0.5;
					if (v5 < (double)v9) {
						v8 = *(unaligned_float*)(v2 + 8) + 0.5;
						v7 = a2[4] - 0.5;
						if (v7 > (double)v8) {
							break;
						}
...
float* nox_xxx_mapgen_5224B0(int a1, int a2, int a3) {
	...
	if (*(uint32_t*)(a3 + 64)) {
		...
		v5 = (long long)((double)(int)(*(uint32_t*)(a2 + 12) * *(uint32_t*)(a2 + 16)) * *(unaligned_float*)(a3 + 76));
		v6 = *(uint32_t*)(a3 + 68);
	...
	case 0:
		if (v5 > 0) {
			...
			do {
				...
				result = (unaligned_float*)--v12;
			} while (v12);
		}
		break;
	case 1:
		result = (unaligned_float*)sub_5268F0((const char*)(a3 + 4));
		v9 = result;
		if ((int)result >= 0 && v5 > 0) {
			...
			do {
				...
				result = (unaligned_float*)--v13;
			} while (v13);
		}
		break;
	case 2:
		result = (unaligned_float*)sub_521C10((int)v4);
		break;
	case 3:
		result = (unaligned_float*)sub_5226D0((int)v4, 0.89999998, (int)&v11);
		if (result) {
			result = (unaligned_float*)nox_xxx_mapGenMakeEnchantedItem_5221A0((char*)(a3 + 4), *(char**)(a1 + 1100),
																	*(uint32_t*)(a1 + 1104));
			if (result) {
				result = nox_xxx_mapGenMoveObject_527A10(result, (unaligned_float*)&v11);
			}
		}
		break;
	case 4:
		result = (unaligned_float*)sub_5226D0((int)v4, 0.89999998, (int)&v11);
		if (result) {
			result = (unaligned_float*)nox_xxx_mapGenMakeEnchantedItem_5221A0((char*)(a3 + 4), *(char**)(a1 + 1108),
																	*(uint32_t*)(a1 + 1112));
			if (result) {
				result = nox_xxx_mapGenMoveObject_527A10(result, (unaligned_float*)&v11);
			}
	...
	case 5:
		result = (unaligned_float*)sub_5226D0((int)v4, 0.89999998, (int)&v11);
		if (result) {
			result = (unaligned_float*)nox_xxx_mapGenMakeSpellbook_5220E0(a1, (const char*)(a3 + 4));
			if (result) {
				result = nox_xxx_mapGenMoveObject_527A10(result, (unaligned_float*)&v11);
			}
		}
...
int sub_5226D0(int a1, float a2, int a3) {
	...
	v3 = (unaligned_float*)a1;
	v4 = *(unaligned_float*)(a1 + 36) + *(unaligned_float*)(a1 + 44);
	v12 = 0;
	v10 = v4 * 0.5;
	v11 = (v3[10] + v3[12]) * 0.5;
	v8 = (v3[11] - v3[9]) * 0.5;
	...
	while (1) {
		v6 = -v8;
		*(unaligned_float*)a3 = sub_526BC0(v6, v8) * a2 + v10;
		v7 = -v9;
		*(unaligned_float*)(a3 + 4) = sub_526BC0(v7, v9) * a2 + v11;
		if (!sub_5227B0((int)v3, (unaligned_float*)a3)) {
			break;
		}
		if (++v12 >= 10) {
			return 0;
...
int sub_5227B0(int a1, float* a2) {
	...
	while (*a2 < (double)*(unaligned_float*)(v2 + 4) || *a2 > (double)*(unaligned_float*)(v2 + 12) || a2[1] < (double)*(unaligned_float*)(v2 + 8) ||
		   a2[1] > (double)*(unaligned_float*)(v2 + 16)) {
		v2 = *(uint32_t*)(v2 + 24);
		if (!v2) {
			return 0;
		}
...
float* sub_522C80(float* a1) {
	...
	if (!result) {
		result = (unaligned_float*)sub_51D120(a1);
	}
	return result;
}
...
char sub_522CA0(int a1, float* a2) {
	...
	if ((unsigned char)v2 < 0x10u) {
		...
		*(unaligned_float*)(a1 + 8 * v5 + 224) = *a2;
		*(unaligned_float*)(a1 + 8 * v5 + 228) = a2[1];
...
float* sub_522D30(int a1) {
	...
	sub_51D0F0(128);
	result = (unaligned_float*)nox_xxx_mapGenGetTopRoom_521710();
	for (i = result; result; i = result) {
		...
		if (*(uint32_t*)i == 1) {
				...
				if (*((uint8_t*)i + v4 + 216)) {
					do {
						if (nox_xxx_mapGenCheckRoomType_5238F0((int*)*v3) && sub_523920(*(uint32_t*)*v3) == v4) {
							...
							sub_523D30((unaligned_float*)*v3, &v11.field_0);
			...
			do {
				...
				++v7;
				v6 = (unaligned_float**)(v10 + 32);
				v10 += 32;
			} while (v7 < 4);
		}
		result = (unaligned_float*)sub_521720((int)i);
	}
	return result;
}
...
int nox_xxx_netSendFxAllCli_523030(float2* a1, const void* a2, int a3) {
	...
	for (i = result; result; i = result) {
		...
		if (*(uint8_t*)(v5 + 3680) & 3 && (v6 = *(uint32_t*)(v5 + 3628)) != 0) {
			v7 = *(unaligned_float*)(v6 + 56);
			v8 = *(unaligned_float*)(v6 + 60);
			v12 = v7;
		} else {
			v8 = *(unaligned_float*)(i + 60);
			v12 = *(unaligned_float*)(i + 56);
		}
...
int nox_xxx_netClientPredictLinear_523530(int a1) {
	...
	*(uint16_t*)&v14[5] = v3;
	v5 = (long long)v4;
	v6 = *(unaligned_float*)(a1 + 112) * 16.0;
	v7 = *(uint16_t*)(a1 + 124);
	*(uint16_t*)&v14[7] = v5;
	*(uint16_t*)&v14[9] = v7;
	v8 = (long long)v6;
	v9 = *(unaligned_float*)(a1 + 80) * 16.0;
	v14[11] = v8;
	v10 = (long long)v9;
	v11 = *(unaligned_float*)(a1 + 84) * 16.0;
	v14[12] = v10;
...
int nox_xxx_netSendShieldFx_523670(int a1, float* a2) {
	...
	*(uint16_t*)&v5[1] = nox_xxx_netGetUnitCodeServ_578AC0((uint32_t*)a1);
	if (a2) {
		v6.field_0 = *(unaligned_float*)(a1 + 56) - *a2;
		v6.field_4 = *(unaligned_float*)(a1 + 60) - a2[1];
...
int nox_xxx_sendSummonStartFX_5236F0(short a1, float* a2, char a3, short a4, short a5) {
	...
	float y = 0.0f;
	if (a2) {
		memcpy(&x, a2, sizeof(float));
		memcpy(&y, (char*)a2 + sizeof(float), sizeof(float));
	}
	uint16_t v6 = (uint16_t)(long long)x;
	uint16_t v7 = (uint16_t)(long long)y;
	uint16_t u_a1 = (uint16_t)a1;
	uint16_t u_a4 = (uint16_t)a4;
	uint16_t u_a5 = (uint16_t)a5;
...
int sub_523A10(int a1, float* a2) {
	...
	switch (*(uint32_t*)a1) {
	case 2:
		if (*(unaligned_float*)(a1 + 36) < (double)a2[9] || *(unaligned_float*)(a1 + 44) > (double)a2[11]) {
			return 0;
		}
		v2 = *(unaligned_float*)(a1 + 24);
		v19.field_0 = *(unaligned_float*)(a1 + 20);
		v3 = *(uint32_t*)(a1 + 16);
		v19.field_4 = v2;
		if (v3 > 1) {
			do {
				v2 = v2 + 32.526913;
				v4 = *(unaligned_float*)(a1 + 32) - 32.526913;
				v5 = *(uint32_t*)(a1 + 16) - 1;
				*(uint32_t*)(a1 + 16) = v5;
				*(unaligned_float*)(a1 + 32) = v4;
	...
	case 3:
		...
		break;
	case 4:
		if (*(unaligned_float*)(a1 + 40) < (double)a2[10] || *(unaligned_float*)(a1 + 48) > (double)a2[12]) {
			return 0;
		}
		v11 = *(unaligned_float*)(a1 + 24);
		v19.field_0 = *(unaligned_float*)(a1 + 20);
		v12 = *(uint32_t*)(a1 + 12);
		v19.field_4 = v11;
		if (v12 > 1) {
			do {
				v13 = *(unaligned_float*)(a1 + 28) - 32.526913;
				v14 = *(uint32_t*)(a1 + 12) - 1;
				*(uint32_t*)(a1 + 12) = v14;
				*(unaligned_float*)(a1 + 28) = v13;
	...
	case 5:
		...
		v15 = *(unaligned_float*)(a1 + 20);
		v19.field_4 = *(unaligned_float*)(a1 + 24);
		v16 = *(uint32_t*)(a1 + 12);
		v19.field_0 = v15;
		if (v16 > 1) {
			do {
				v15 = v15 + 32.526913;
				v17 = *(unaligned_float*)(a1 + 28) - 32.526913;
				v18 = *(uint32_t*)(a1 + 12) - 1;
				*(uint32_t*)(a1 + 12) = v18;
				*(unaligned_float*)(a1 + 28) = v17;
	...
	while (1) {
		v9 = *(unaligned_float*)(a1 + 32) - 32.526913;
		v10 = *(uint32_t*)(a1 + 16) - 1;
		*(uint32_t*)(a1 + 16) = v10;
		*(unaligned_float*)(a1 + 32) = v9;
...
int sub_523C30(int a1, int a2) {
	...
	switch (*(uint32_t*)a1) {
	case 2:
		*(unaligned_float*)a2 = (*(unaligned_float*)(a1 + 44) + *(unaligned_float*)(a1 + 36)) * 0.5;
	...
	case 4:
		v3 = *(uint32_t*)(a1 + 44);
		*(uint32_t*)a2 = v3;
		*(unaligned_float*)(a2 + 4) = (*(unaligned_float*)(a1 + 48) + *(unaligned_float*)(a1 + 40)) * 0.5;
		break;
	case 5:
		v3 = *(uint32_t*)(a1 + 36);
		*(uint32_t*)a2 = v3;
...
int sub_524550(int* a1, int a2) {
	...
	v2 = a1[1];
	v5 = *a1;
	v6 = *(unaligned_float*)&v2;
	result = sub_526D50(1);
	v4 = a2;
	if (a2 > 0) {
		do {
			result = sub_526E60((unaligned_float*)&v5);
			--v4;
			v6 = v6 + 32.526913;
		} while (v4);
	}
...
int nox_xxx_gen_524680(int a1, int a2, int a3) {
	...
	v3 = (unaligned_float*)(a2 + 20);
	sub_5245A0(a1, (unaligned_float*)(a2 + 20), *(uint32_t*)(a2 + 12), *(uint32_t*)(a2 + 16));
	switch (*(uint32_t*)a2) {
	case 1:
		v4 = *v3 + 32.526913;
		...
		v22 = v6;
		v23 = v4;
		v24 = *(unaligned_float*)(a2 + 24) + 32.526913;
		break;
	case 2:
		v7 = *(uint32_t**)(a2 + 88);
		result = *(uint32_t*)(a2 + 12) - 2;
	...
	case 4:
		v13 = *(uint32_t*)(a2 + 16);
		v14 = *(unaligned_float*)(a2 + 24) + 32.526913;
		v23 = *v3;
		v15 = *(uint32_t**)(a2 + 152);
		v6 = v13 - 2;
		v24 = v14;
...
void nox_xxx_gen_524E00(int a1, int a2) {
	...
	if (!(*(uint8_t*)(a2 + 52) & 2)) {
		...
		sub_526CA0(v3);
		v4 = *(unaligned_float*)(a2 + 40);
		v17.field_0 = *(unaligned_float*)(a2 + 36);
		v17.field_4 = v4;
		sub_526D50(8);
		sub_526E60(&v17);
		...
		sub_524500(&v17, v15);
		v5 = *(unaligned_float*)(a2 + 40);
		v17.field_0 = *(unaligned_float*)(a2 + 44);
		v17.field_4 = v5;
		sub_526D50(9);
		sub_526E60(&v17);
		v6 = *(unaligned_float*)(a2 + 48);
		v17.field_0 = *(unaligned_float*)(a2 + 36);
		v17.field_4 = v6;
		sub_526D50(7);
		sub_526E60(&v17);
		...
		v17.field_0 = v17.field_0 + 32.526913;
		sub_524500(&v17, v14);
		v7 = *(unaligned_float*)(a2 + 48);
		v17.field_0 = *(unaligned_float*)(a2 + 44);
		v17.field_4 = v7;
		sub_526D50(10);
		sub_526E60(&v17);
		v8 = *(unaligned_float*)(a2 + 40) + 32.526913;
		v16 = *(uint32_t*)(a2 + 16) - 1;
		v17.field_0 = *(unaligned_float*)(a2 + 36);
		v17.field_4 = v8;
		sub_524550(&v17, v16);
		v9 = *(unaligned_float*)(a2 + 40) + 32.526913;
...
int sub_524FB0(int a1, int a2, int a3) {
	...
	switch (a3) {
	case 0:
		if (*(unaligned_float*)(a2 + 36) >= (double)*(unaligned_float*)(a1 + 36)) {
			v4 = *(unaligned_float*)(a2 + 36);
		} else {
			v4 = *(unaligned_float*)(a1 + 36);
		}
		v5 = *(uint32_t*)(a1 + 12);
		a2a.field_4 = *(unaligned_float*)(a1 + 40);
		v6 = *(uint32_t*)(a2 + 12);
		a2a.field_0 = v4;
		if (v5 >= v6) {
			v7 = v6;
			sub_521BC0(a1, &a2a, *(unaligned_float*)(a2 + 28), 32.526913);
		} else {
			v7 = v5;
			sub_521BC0(a1, &a2a, *(unaligned_float*)(a1 + 28), 32.526913);
		}
		v34.field_0 = a2a.field_0 + 32.526913;
		v34.field_4 = a2a.field_4;
		sub_525330((int*)&v34, v7 - 1);
		sub_5253B0(&a2a.field_0);
		v8 = *(unaligned_float*)(a1 + 40);
		if (*(unaligned_float*)(a2 + 44) <= (double)*(unaligned_float*)(a1 + 44)) {
			a2a.field_0 = *(unaligned_float*)(a2 + 44);
		} else {
			a2a.field_0 = *(unaligned_float*)(a1 + 44);
		}
		a2a.field_4 = v8;
	...
	case 1:
		if (*(unaligned_float*)(a2 + 36) >= (double)*(unaligned_float*)(a1 + 36)) {
			v9 = *(unaligned_float*)(a2 + 36);
		} else {
			v9 = *(unaligned_float*)(a1 + 36);
		}
		a2a.field_0 = v9;
		v10 = *(unaligned_float*)(a1 + 48);
		v11 = *(uint32_t*)(a2 + 12);
		v34.field_0 = v9;
		a2a.field_4 = v10;
		v12 = *(uint32_t*)(a1 + 12);
		...
		if (v12 >= v11) {
			v13 = v11;
			sub_521BC0(a1, &v34, *(unaligned_float*)(a2 + 28), 32.526913);
		} else {
			v13 = v12;
			sub_521BC0(a1, &v34, *(unaligned_float*)(a1 + 28), 32.526913);
		}
		v34.field_0 = a2a.field_0 + 32.526913;
		v34.field_4 = a2a.field_4;
		...
		sub_5253B0(&a2a.field_0);
		if (*(unaligned_float*)(a2 + 44) <= (double)*(unaligned_float*)(a1 + 44)) {
			v14 = *(unaligned_float*)(a2 + 44);
		} else {
			v14 = *(unaligned_float*)(a1 + 44);
		}
		v15 = *(unaligned_float*)(a1 + 48);
		a2a.field_0 = v14;
		a2a.field_4 = v15;
		result = sub_5253B0(&a2a.field_0);
		break;
	case 2:
		v16 = *(unaligned_float*)(a1 + 40);
		v17 = *(unaligned_float*)(a2 + 40);
		a2a.field_0 = *(unaligned_float*)(a1 + 44);
		if (v17 >= v16) {
			v18 = *(unaligned_float*)(a2 + 40);
		} else {
			v18 = *(unaligned_float*)(a1 + 40);
		}
		a2a.field_4 = v18;
		v19 = *(uint32_t*)(a1 + 16);
		v20 = *(uint32_t*)(a2 + 16);
		...
		if (v19 >= v20) {
			v21 = v20;
			sub_521BC0(a1, &v34, 32.526913, *(unaligned_float*)(a2 + 32));
		} else {
			v21 = v19;
			sub_521BC0(a1, &v34, 32.526913, *(unaligned_float*)(a1 + 32));
		}
		v34.field_4 = a2a.field_4 + 32.526913;
		v34.field_0 = a2a.field_0;
		sub_525370((int*)&v34, v21 - 1);
		sub_5253B0(&a2a.field_0);
		v22 = *(unaligned_float*)(a1 + 48);
		v23 = *(unaligned_float*)(a2 + 48);
		a2a.field_0 = *(unaligned_float*)(a1 + 44);
		if (v23 <= v22) {
			a2a.field_4 = *(unaligned_float*)(a2 + 48);
		} else {
			a2a.field_4 = *(unaligned_float*)(a1 + 48);
		}
		result = sub_5253B0(&a2a.field_0);
		break;
	case 3:
		v24 = *(unaligned_float*)(a1 + 40);
		v25 = *(unaligned_float*)(a2 + 40);
		a2a.field_0 = *(unaligned_float*)(a1 + 36);
		if (v25 >= v24) {
			v26 = *(unaligned_float*)(a2 + 40);
		} else {
			v26 = *(unaligned_float*)(a1 + 40);
		}
		v27 = *(uint32_t*)(a1 + 16);
		v28 = *(uint32_t*)(a2 + 16);
		a2a.field_4 = v26;
		if (v27 >= v28) {
			v29 = v28;
			sub_521BC0(a1, &a2a, 32.526913, *(unaligned_float*)(a2 + 32));
		} else {
			v29 = v27;
			sub_521BC0(a1, &a2a, 32.526913, *(unaligned_float*)(a1 + 32));
		}
		v34.field_4 = a2a.field_4 + 32.526913;
		v34.field_0 = a2a.field_0;
		sub_525370((int*)&v34, v29 - 1);
		sub_5253B0(&a2a.field_0);
		v30 = *(unaligned_float*)(a1 + 48);
		v31 = *(unaligned_float*)(a2 + 48);
		a2a.field_0 = *(unaligned_float*)(a1 + 36);
		if (v31 <= v30) {
			v32 = *(unaligned_float*)(a2 + 48);
		} else {
			v32 = *(unaligned_float*)(a1 + 48);
		}
		a2a.field_4 = v32;
		result = sub_5253B0(&a2a.field_0);
		break;
...
void nox_xxx_mapgen_525570(int a1, int a2, int a3, int a4) {
	...
	case 0:
	case 1:
		if (*(unaligned_float*)(a3 + 36) >= (double)*(unaligned_float*)(a2 + 36)) {
			v4 = *(unaligned_float*)(a3 + 36);
		} else {
			v4 = *(unaligned_float*)(a2 + 36);
		}
		v9.field_0 = v4;
		if (a4) {
			v9.field_4 = *(unaligned_float*)(a2 + 48);
		} else {
			v9.field_4 = *(unaligned_float*)(a2 + 40);
		}
		v5 = *(uint32_t*)(a3 + 12);
	...
	case 3:
		if (a4 == 3) {
			v9.field_0 = *(unaligned_float*)(a2 + 36);
		} else {
			v9.field_0 = *(unaligned_float*)(a2 + 44);
		}
		if (*(unaligned_float*)(a3 + 40) >= (double)*(unaligned_float*)(a2 + 40)) {
			v6 = *(unaligned_float*)(a3 + 40);
		} else {
			v6 = *(unaligned_float*)(a2 + 40);
		}
		v7 = *(uint32_t*)(a2 + 16);
		v8 = *(uint32_t*)(a3 + 16);
		v9.field_4 = v6;
...
void sub_5259F0(int a1, int a2, float a3) {
	...
	if (a2) {
		switch (*(uint32_t*)a2) {
		case 1:
			v3 = sqrt(*(unaligned_float*)(a2 + 28) * *(unaligned_float*)(a2 + 28) + *(unaligned_float*)(a2 + 32) * *(unaligned_float*)(a2 + 32));
			break;
		case 2:
		case 3:
			v3 = *(unaligned_float*)(a2 + 32);
			break;
		case 4:
		case 5:
			v3 = *(unaligned_float*)(a2 + 28);
			break;
		default:
			v3 = a3;
			break;
	...
	v4 = a1;
	v11 = v3 + a3;
	if (*(uint8_t*)(a1 + 220) != 1 || v11 < (double)*(unaligned_float*)(a1 + 356)) {
		*(unaligned_float*)(a1 + 356) = v11;
		v5 = (int*)(a1 + 88);
		v6 = -216 - a1;
		*(uint8_t*)(a1 + 220) = 1;
		v7 = (uint8_t*)(a1 + 216);
...
float* sub_525AF0(int a1) {
	...
	*(uint32_t*)(dword_5d4594_2487576 + 52) |= 1u;
	for (i = (unaligned_float*)nox_xxx_mapGenGetTopRoom_521710(); i; i = (unaligned_float*)sub_521720((int)i)) {
		++v1;
		i[90] = i[89] / *(unaligned_float*)&dword_5d4594_2487580;
	}
	...
	if (a1) {
		...
		result = *(unaligned_float**)&dword_5d4594_2487576;
...
void sub_525BF0(int a1) {
	...
	if (*(uint8_t*)(a1 + 220) != 2) {
		if (*(unaligned_float*)&dword_5d4594_2487580 < (double)*(unaligned_float*)(a1 + 356) && *(uint32_t*)a1 == 1) {
			v1 = *(uint32_t*)(a1 + 356);
			dword_5d4594_2487576 = a1;
...
float* sub_525C90() {
	...
	for (i = result; result; i = result) {
		...
		if (dword_5d4594_2487584) {
			v3 = 0;
			while (1) {
				if (i[89] < (double)*(unaligned_float*)(v2 + 356)) {
					v4 = *(uint32_t*)(v2 + 68);
					if (v4) {
						*(uint32_t*)(v4 + 64) = i;
					} else {
...
void sub_525DF0(float a1) {
	...
	v1 = *(unaligned_float*)(LODWORD(a1) + 64) * 0.5;
...
LABEL_10:
	...
	case 2:
		...
		if (nox_xxx_mapGenRandFunc_526AC0(0, 100) >= 50) {
			...
			*(unaligned_float*)&dword_5d4594_2487620 = v16;
			*(unaligned_float*)&dword_5d4594_2487624 = sub_526BC0(v15, v16);
		} else {
			*getMemFloatPtr(0x5D4594, 2487612) = sub_526BC0(v15, v16);
			*getMemFloatPtr(0x5D4594, 2487616) = v15;
			*(unaligned_float*)&dword_5d4594_2487620 = sub_526BC0(v15, v16);
			*(unaligned_float*)&dword_5d4594_2487624 = v16;
		}
		break;
	case 3:
		...
		if (v9 >= 25) {
			if (v9 >= 50) {
				...
				if (v9 >= 75) {
					...
					*(unaligned_float*)&dword_5d4594_2487620 = v12;
					*(unaligned_float*)&dword_5d4594_2487624 = v16;
					*(unaligned_float*)&dword_5d4594_2487628 = v16;
				} else {
					*getMemFloatPtr(0x5D4594, 2487616) = v12;
					*(unaligned_float*)&dword_5d4594_2487628 = v12;
				...
				*(unaligned_float*)&dword_5d4594_2487632 = v11;
			...
			*(unaligned_float*)&dword_5d4594_2487624 = v10;
			*(unaligned_float*)&dword_5d4594_2487620 = v16;
			dword_5d4594_2487628 = 0;
			*(unaligned_float*)&dword_5d4594_2487632 = v16;
		}
		break;
	case 4:
	case 5:
		...
		*(unaligned_float*)&dword_5d4594_2487624 = v13;
		*(unaligned_float*)&dword_5d4594_2487628 = v13;
		*(unaligned_float*)&dword_5d4594_2487620 = v16;
		*(unaligned_float*)&dword_5d4594_2487632 = v16;
...
int nox_xxx_mapGenPrefabMkRoom_526100(int a1, int a2) {
	...
	if (result) {
		v3 = nox_xxx_mapGenMakeRoomStruct_521940(
			4 * *(uint32_t*)(a2 + 144) + (unsigned long long)(long long)(*(unaligned_float*)(a2 + 60) * 0.030743772 + 0.5),
			4 * *(uint32_t*)(a2 + 144) + (unsigned long long)(long long)(*(unaligned_float*)(a2 + 64) * 0.030743772 + 0.5));
		*(uint32_t*)(a2 + 148) = v3;
...
long long sub_526260(int a1, float* a2) {
	...
	*a2 = *a2 - *(unaligned_float*)(a1 + 28) * 0.5;
	a2[1] = a2[1] - *(unaligned_float*)(a1 + 32) * 0.5;
...
int sub_5262F0(int a1, int a2) {
	...
	*(uint32_t*)(a2 + 68) = v2;
	...
	v4 = *(uint32_t*)(a2 + 68);
	*(unaligned_float*)(a2 + 60) = v3;
	*(unaligned_float*)(a2 + 64) = sub_502EA0(v4);
...
int nox_xxx_mapGen_InPrefab2_5266F0(int a1) {
	...
	while (1) {
		if (*(uint32_t*)(v1 + 76)) {
			v2 = *(uint32_t*)(v1 + 148);
			v8.field_0 = *(unaligned_float*)(v2 + 20);
			v8.field_4 = *(unaligned_float*)(v2 + 24);
			...
			v3 = nox_xxx_mapGenMakeRoomStruct_521940((long long)(*(unaligned_float*)(v1 + 60) * 0.030743772 + 0.5),
													 (long long)(*(unaligned_float*)(v1 + 64) * 0.030743772 + 0.5));
			*(uint32_t*)(v1 + 148) = v3;
...
float* nox_xxx_mapGenPlaceObj_5279B0(float2* a1) {
	...
	result = (unaligned_float*)nox_xxx_mapGenFixCoords_4D3D90(a1, &a2);
	if (result) {
		result = (unaligned_float*)nox_xxx_newObjectWithTypeInd_4E3450(*(int*)&dword_5d4594_3835388);
		if (result) {
...
float* nox_xxx_mapGenMoveObject_527A10(float* a1, float2* a2) {
	...
	v3 = v7.field_4;
	a1[10] = *(unaligned_float*)&dword_5d4594_3835392;
	v4 = v7.field_0;
...
void nox_xxx_unitUpdateSightMB_5281F0(nox_object_t* a1p) {
	...
	if (v4 >= *(unaligned_float*)(v3 + 1312)) {
		v21 = v4;
	} else {
		v21 = *(unaligned_float*)(v3 + 1312);
	}
	...
	if (*(uint8_t*)(v3 + 1129)) {
		...
		do {
			if (*(uint32_t*)(*v6 + 16) & 0x8020 || !nox_xxx_unitCanSee_536FB0(v1, *v6, 0) ||
				(v7 = *(unaligned_float*)(v1 + 56) - *(unaligned_float*)(*v6 + 56),
				 v8 = *(unaligned_float*)(v1 + 60) - *(unaligned_float*)(*v6 + 60), v20 = (v21 + 30.0) * (v21 + 30.0),
				 v8 * v8 + v7 * v7 > v20) ||
				(v9 = *(unaligned_float*)(v1 + 56) - *(unaligned_float*)(v1 + 72),
				 v10 = *(unaligned_float*)(v1 + 60) - *(unaligned_float*)(v1 + 76), v10 * v10 + v9 * v9 > 1000.0) ||
	...
	if (v4) {
		for (i = (int*)(v2 + 1132); *i != *(uint32_t*)(v2 + 1216); ++i) {
			if (nox_xxx_unitIsEnemyTo_5330C0(v1, *i) && nox_xxx_checkIsKillable_528190(*i)) {
				v6 = *(unaligned_float*)(*i + 56) - *(unaligned_float*)(v1 + 56);
				v7 = *(unaligned_float*)(*i + 60) - *(unaligned_float*)(v1 + 60);
				v8 = v7 * v7 + v6 * v6;
				if (v8 < v9) {
					v9 = v8;
					*(uint32_t*)(v2 + 1196) = *i;
		...
		if (*(uint8_t*)(a1 + 8) & 6) {
			if (!(*(uint32_t*)(a1 + 16) & 0x8020)) {
				...
				if ((v4 & 0x400 || nox_xxx_unitIsEnemyTo_5330C0(a2, a1)) && !sub_528950(a2, a1)) {
					v5 = *(uint32_t*)(v3 + 1440);
					if (v5 & 0x100 ||
						(v6 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a2 + 56), v7 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a2 + 60),
...
void nox_xxx_monsterVisionSeeEnemy_5287B0(int a1, int a2) {
	...
	if (*(uint8_t*)(v4 + 1129) == 16) {
		v7 = v4 + 1132;
		do {
			v8 = *(unaligned_float*)(*(uint32_t*)v7 + 56) - *(unaligned_float*)(v2 + 56);
			v9 = *(unaligned_float*)(*(uint32_t*)v7 + 60) - *(unaligned_float*)(v2 + 60);
			v10 = v9 * v9 + v8 * v8;
			if (v10 > v3) {
				v18 = v10;
				v3 = v18;
		...
		v11 = a2;
		v12 = *(unaligned_float*)(a2 + 56) - *(unaligned_float*)(v2 + 56);
		v13 = *(unaligned_float*)(a2 + 60) - *(unaligned_float*)(v2 + 60);
...
int nox_xxx_monsterCmdSend_528BD0(int unit, int source, const char* command, short a4) {
	...
	v5 = *(unaligned_float*)(unit + 56);
	*(uint16_t*)&v10[1] = v4;
	v6 = (long long)v5;
	v7 = *(unaligned_float*)(unit + 60);
	*(uint16_t*)&v10[4] = v6;
...
int nox_xxx_castStun_52C2C0(int a1, int a2, int a3, int a4, int* a5, char a6) {
	...
	v10 = *(uint32_t*)(*a5 + 8);
	if (!(v10 & 4)) {
		if (v10 & 2 && *(unaligned_float*)(v8 + 120) > 15.0) {
...
int nox_xxx_castBurn_52C3E0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (*(unsigned short*)(a4 + 4) != v5) {
		v8 = *(unaligned_float*)(a4 + 56);
		v9 = *(unaligned_float*)(a5 + 4);
		v18.field_4 = *(unaligned_float*)(a4 + 60);
		v18.field_0 = v8;
		v10 = *(unaligned_float*)(a5 + 8);
		v18.field_8 = v9;
		v18.field_C = v10;
		if ((unsigned char)nox_xxx_traceRay_5374B0(&v18)) {
			v7 = (unaligned_float*)(v6 + 4);
			goto LABEL_12;
		}
		if (*(uint8_t*)(a4 + 8) & 4) {
			v11 = *(uint32_t*)(a4 + 748);
...
LABEL_12:
	...
	v14 = (unaligned_float*)nox_xxx_newObjectWithTypeInd_4E3450(v13);
	if (v14) {
...
int nox_xxx_castFireball_52C790(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	v6 = a6;
	v7 = (unaligned_float*)nox_xxx_newObjectByTypeID_4E3810(*(char**)getMemAt(0x587000, 258864 + 4 * a6));
	if (!v7) {
		return 1;
	}
	v8 = a4;
	v9 = *(unaligned_float*)(a4 + 176) + *(unaligned_float*)(a4 + 176);
	v10 = 8 * *(short*)(a4 + 124);
	v21 = *getMemFloatPtr(0x587000, 194136 + v10);
	v20 = *getMemFloatPtr(0x587000, 194140 + v10);
	v11 = *(unaligned_float*)(v8 + 60);
	v19.field_0 = *(unaligned_float*)(v8 + 56);
	v12 = v9 * v21 + *(unaligned_float*)(v8 + 56);
	v19.field_4 = v11;
	v19.field_8 = v12;
	v13 = v9 * v20 + *(unaligned_float*)(v8 + 60);
	v19.field_8 = v19.field_8 + *(unaligned_float*)(v8 + 80);
	v19.field_C = v13 + *(unaligned_float*)(v8 + 84);
	...
	v15 = v14 * v20;
	v7[21] = v15;
	v7[20] = v22 + *(unaligned_float*)(v8 + 80);
	v7[21] = v15 + *(unaligned_float*)(v8 + 84);
	v16 = *(uint16_t*)(v8 + 124);
	...
	if (*(uint8_t*)(a3 + 8) & 4) {
		...
		if (v7) {
			...
			*(uint32_t*)(v6 + 4 * a1 - 68) = v8;
			...
			v9 = *(unaligned_float*)(v5 + 4);
			v10 = *(unaligned_float*)v5;
			v16 = 0;
...
int sub_52CCD0(int a1, int a2, int a3) {
	...
	do {
		if (nox_xxx_unitHasThatParent_4EC4F0(v3, a3) && !strcmp((const char*)nox_xxx_getUnitName_4E39D0(v3), "Glyph")) {
			v4 = *(unaligned_float*)(a3 + 56) - *(unaligned_float*)(v3 + 56);
			v5 = *(unaligned_float*)(a3 + 60) - *(unaligned_float*)(v3 + 60);
			v6 = v5 * v5 + v4 * v4;
			if (v6 < v9) {
				v9 = v6;
				Tm = (struct tm*)v3;
...
int nox_xxx_castLock_52CE90(int a1, int a2, int a3, int a4) {
	...
	v9.field_0 = *(unaligned_float*)(a3 + 56) - 150.0;
	v9.field_4 = *(unaligned_float*)(a3 + 60) - 150.0;
	v9.field_8 = *(unaligned_float*)(a3 + 56) + 150.0;
	v9.field_C = *(unaligned_float*)(a3 + 60) + 150.0;
...
void sub_52CF90(int a1, int a2) {
	...
	v2 = a1;
	if (*(uint8_t*)(a1 + 8) & 0x80) {
		v3 = *(unaligned_float*)(a2 + 56) - *(unaligned_float*)(a1 + 56);
		v4 = *(unaligned_float*)(a2 + 60) - *(unaligned_float*)(a1 + 60);
		v8 = v4 * v4 + v3 * v3;
		if (v8 <= 22500.0 && v8 < (double)*getMemFloatPtr(0x5D4594, 2487704)) {
			v5 = *(uint32_t*)(v2 + 748);
			v6 = *(unaligned_float*)(a2 + 60);
			v7.field_0 = *(unaligned_float*)(a2 + 56);
			v7.field_4 = v6;
			v7.field_8 = (double)*getMemIntPtr(0x587000, 196184 + 8 * *(uint32_t*)(v5 + 12)) * 0.5 + *(unaligned_float*)(v2 + 56);
			v7.field_C = (double)*getMemIntPtr(0x587000, 196188 + 8 * *(uint32_t*)(v5 + 12)) * 0.5 + *(unaligned_float*)(v2 + 60);
...
int nox_xxx_castTelekinesis_52D330(int a1, int a2, int a3, int a4, int* a5, char a6) {
	...
	if (*a5) {
		if (*(uint8_t*)(result + 8) & 4) {
			...
			if (v7) {
				nox_xxx_createAt_4DAA50((int)v7, *a5, *(unaligned_float*)(*a5 + 56), *(unaligned_float*)(*a5 + 60));
...
int nox_xxx_castFist_52D3C0(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	v8 = *(unaligned_float*)(a4 + 60);
	v9 = *(unaligned_float*)(a5 + 4);
	v21.field_0 = *(unaligned_float*)(a4 + 56);
	v10 = *(unaligned_float*)(a5 + 8);
	v21.field_4 = v8;
	v21.field_8 = v9;
	v21.field_C = v10;
	...
	if (nox_xxx_mapTraceRay_535250(&v21, 0, 0, !v11 ? 73 : 9)) {
		...
		if (v14) {
			...
			*v16 = nox_float2int(v20);
			nox_xxx_createAt_4DAA50(v15, a4, *(unaligned_float*)(a5 + 4), *(unaligned_float*)(a5 + 8));
...
int nox_xxx_spellCastCleansingFlame_52D5C0(int a1, nox_object_t* a2p, nox_object_t* a3p, nox_object_t* a4p, void* a5p, int a6) {
	...
	do {
		...
		if (v8 >= 1) {
			v9 = (unaligned_float*)nox_xxx_newObjectWithTypeInd_4E3450(
				*getMemU32Ptr(0x5D4594, 2487756 + 4 * ((a1 != 10 ? 5 : 0) + v8)));
			if (v9) {
				v10 = nox_common_randomInt_415FA0(0, 255);
				v11 = v9[44];
				*((uint16_t*)v9 + 62) = v10;
				v12 = v11 + *(unaligned_float*)(a4 + 176) + 4.0;
				v13 = 8 * v10;
				v21 = *getMemFloatPtr(0x587000, 194136 + v13);
				v22 = *getMemFloatPtr(0x587000, 194140 + v13);
				v14 = *(unaligned_float*)(a4 + 60);
				v15 = v12 * v21 + *(unaligned_float*)(a4 + 56);
				v20.field_0 = *(unaligned_float*)(a4 + 56);
				v20.field_4 = v14;
				v20.field_8 = v15;
				v20.field_C = v12 * v22 + *(unaligned_float*)(a4 + 60);
				if (nox_xxx_mapTraceRay_535250(&v20, 0, 0, 65)) {
					...
					*((uint32_t*)v9 + 34) =
					...
					v9[39] = *(unaligned_float*)(a4 + 56);
					v9[40] = *(unaligned_float*)(a4 + 60);
...
int nox_xxx_castMeteorShower_52D8A0(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	v6 = a5;
	v7 = a4;
	v8 = *(unaligned_float*)(a5 + 4);
	v9 = *(unaligned_float*)(a4 + 60);
	v19.field_0 = *(unaligned_float*)(a4 + 56);
	v10 = *(unaligned_float*)(a5 + 8);
	v19.field_4 = v9;
	v19.field_8 = v8;
	v19.field_C = v10;
	...
	if (nox_xxx_mapTraceRay_535250(&v19, 0, 0, !v11 ? 73 : 9)) {
		...
		if (v14) {
			...
			*v16 = nox_float2int(v18);
			nox_xxx_createAt_4DAA50(v15, a3, *(unaligned_float*)(v6 + 4), *(unaligned_float*)(v6 + 8));
			v17 = nox_xxx_spellGetAud44_424800(a1, 0);
...
LABEL_6:
	v8 = a4;
	v9 = a5;
	v10 = *(unaligned_float*)(a4 + 60);
	v11 = *(unaligned_float*)(a5 + 4);
	v12 = (float2*)(a5 + 4);
	v24.field_0 = *(unaligned_float*)(a4 + 56);
	v24.field_4 = v10;
	v13 = *(unaligned_float*)(a5 + 8);
	v24.field_8 = v11;
	v24.field_C = v13;
	...
	if (nox_xxx_mapTraceRay_535250(&v24, 0, 0, !v14 ? 73 : 9)) {
		...
		if (v17) {
			...
			v21 = a3;
			*v19 = v20;
			nox_xxx_createAt_4DAA50(v18, v21, v12->field_0, *(unaligned_float*)(v9 + 8));
			*(uint32_t*)(v18 + 20) |= 0x20u;
			nox_xxx_unitRaise_4E46F0(v18, 255.0);
			*(unaligned_float*)(v18 + 108) = -nox_xxx_gamedataGetFloat_419D40("MeteorSpeed");
...
int nox_xxx_castToxicCloud_52DB60(int a1, int a2, int a3, int a4, int a5) {
	...
	v7 = *(unaligned_float*)(a4 + 56);
	v8 = *(unaligned_float*)(a5 + 4);
	v16.field_4 = *(unaligned_float*)(a4 + 60);
	v16.field_0 = v7;
	v9 = *(unaligned_float*)(a5 + 8);
	v16.field_8 = v8;
	v16.field_C = v9;
	if ((unsigned char)nox_xxx_traceRay_5374B0(&v16)) {
		...
		if (v12) {
			...
			nox_xxx_createAt_4DAA50((int)v12, a3, *(unaligned_float*)(v6 + 4), *(unaligned_float*)(v6 + 8));
...
int nox_xxx_spellArachna_52DC80(int a1, int a2, int a3, int a4, int a5) {
	...
	v7 = *(unaligned_float*)(a4 + 56);
	v8 = *(unaligned_float*)(a5 + 4);
	v13.field_4 = *(unaligned_float*)(a4 + 60);
	v13.field_0 = v7;
	v9 = *(unaligned_float*)(a5 + 8);
	v13.field_8 = v8;
	v13.field_C = v9;
...
int nox_xxx_castEquake_52DE40(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	*getMemU32Ptr(0x5D4594, 2487700) = a6;
	...
	nox_xxx_earthquakeSend_4D9110((unaligned_float*)(a4 + 56), v7);
	return 1;
}
...
void nox_xxx_mapPushUnitsAround_52E040(void* a1p, float a2, float a3p, float a4, nox_object_t* a5p, int a6, int a7) {
	...
	a3a[0] = a1;
	v7 = *(unaligned_float*)a1 - a2;
	a3a[5] = a6;
	a3a[6] = a7;
	a1a.field_0 = v7;
	a1a.field_4 = *(unaligned_float*)(a1 + 4) - a2;
	a1a.field_8 = a2 + *(unaligned_float*)a1;
	v8 = a2 + *(unaligned_float*)(a1 + 4);
	a3a[4] = a5;
	a3a[2] = a3;
	a1a.field_C = v8;
	*(unaligned_float*)&a3a[3] = a4 * 10.0;
	if (a2 >= (double)a3p) {
		*(unaligned_float*)&a3a[1] = a2;
	} else {
		a3a[1] = a3;
	}
...
void nox_xxx_unitPushAroundFn_52E0E0(int a1, int** a2) {
	...
	if (nox_xxx_isObjectMovable_52E020(a1)) {
		...
		v5 = *((unaligned_float*)v4 + 1);
		v6 = *(unaligned_float*)(a1 + 56);
		v7 = *(unaligned_float*)(a1 + 60);
		v15.field_4 = v5;
		v15.field_8 = v6;
		v15.field_C = v7;
		if (nox_xxx_mapTraceRay_535250(&v15, 0, 0, 0)) {
			v13 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)*a2;
			v8 = *(unaligned_float*)(a1 + 60) - *((unaligned_float*)*a2 + 1);
			v14 = v8;
			v9 = sqrt(v8 * v14 + v13 * v13) + 0.1;
			v16 = v9;
			if (v9 <= *((unaligned_float*)a2 + 1)) {
				if (v16 > (double)*((unaligned_float*)a2 + 2)) {
					v17 =
						(1.0 - (v16 - *((unaligned_float*)a2 + 2)) / (*((unaligned_float*)a2 + 1) - *((unaligned_float*)a2 + 2))) * *((unaligned_float*)a2 + 3);
				} else {
					v17 = *((unaligned_float*)a2 + 3);
				}
				...
				*(unaligned_float*)(v2 + 88) = v18 * v13 / v16 + *(unaligned_float*)(v2 + 88);
				*(unaligned_float*)(v2 + 92) = v18 * v14 / v16 + *(unaligned_float*)(v2 + 92);
				if (v12) {
...
//----- (0052E210) --------------------------------------------------------
int nox_xxx_spellDrainMana_52E210(int a1) {
	int v1;            // esi
	int v2;            // eax
	int v3;            // eax
	float v4;          // edx
	...
	} else if (!*(uint32_t*)(v1 + 20)) {
		return 1;
	}
	if (*(uint32_t*)(v1 + 20)) {
		v3 = *(uint32_t*)(v1 + 16);
		if (v3) {
			v19.field_0 = *(unaligned_float*)(v3 + 56);
			v4 = *(unaligned_float*)(v3 + 60);
		} else {
			v4 = *(unaligned_float*)(v1 + 32);
			v19.field_0 = *(unaligned_float*)(v1 + 28);
		}
		v19.field_4 = v4;
	...
	v9 = *(uint32_t*)(v1 + 16);
	if (*(uint8_t*)(v9 + 8) & 2) {
		if (sub_4FEA70(v9, (float2*)(v1 + 28))) {
			return 1;
		}
	}
	v10 = *(uint32_t*)(v1 + 16);
	v11 = *(unaligned_float*)(v1 + 28) - *(unaligned_float*)(v10 + 56);
	if (v11 < 0.0) {
		v11 = -v11;
	}
	v19.field_0 = v11;
	v12 = *(unaligned_float*)(v1 + 32) - *(unaligned_float*)(v10 + 60);
	if (v12 < 0.0) {
		v12 = -v12;
	}
	v19.field_4 = v12;
	...
	v13 = sub_52E610((int*)(*(uint32_t*)(v1 + 16) + 56), *(uint32_t*)(v1 + 16));
	*(uint32_t*)(v1 + 48) = v13;
	if (!v13) {
		if (*(uint32_t*)(v1 + 36)) {
	...
	v21 = *(unaligned_float*)(v1 + 72);
	v22 = nox_xxx_gamedataGetFloatTable_419D70("ManaDrainCoeff", *(uint32_t*)(v1 + 8) - 1) + v21;
	*(unaligned_float*)&v14 = COERCE_FLOAT(nox_float2int(v22));
	v15 = *(uint32_t**)(v1 + 48);
	v19.field_0 = *(unaligned_float*)&v14;
	v16 = (double)v14;
	v17 = *(uint32_t**)(v1 + 36);
	*(unaligned_float*)(v1 + 72) = v22 - v16;
	if (v15 != v17) {
		if (v17) {
...
void sub_52E660(int a1, int a2) {
	...
	v4 = 1.0;
LABEL_18:
	v6 = *getMemFloatPtr(0x5D4594, 2487836) - *(unaligned_float*)(a1 + 56);
	v7 = *getMemFloatPtr(0x5D4594, 2487840) - *(unaligned_float*)(a1 + 60);
	v8 = v4 * (v7 * v7 + v6 * v6);
...
//----- (0052E850) --------------------------------------------------------
int nox_xxx_spellEnergyBoltTick_52E850(int a1) {
	int v1;                                              // esi
	int v2;                                              // eax
	int result;                                          // eax
	int v5;                                              // eax
	...
	if (!*(uint32_t*)(v1 + 20)) {
		...
		*getMemU32Ptr(0x5D4594, 2487832) = 0;
		...
		v14 = *(uint32_t*)(v1 + 16);
		*getMemFloatPtr(0x5D4594, 2487868) = *(unaligned_float*)(v14 + 56);
		*getMemFloatPtr(0x5D4594, 2487872) = *(unaligned_float*)(v14 + 60);
		*(unaligned_float*)&dword_5d4594_2487884 = v31 * v31;
	...
	float2 v29;
	v29.field_0 = *(unaligned_float*)(v1 + 28);
	v29.field_4 = *(unaligned_float*)(v1 + 32);
		...
		if (!(*(uint32_t*)(target + 16) & 0x8020) && target != source) {
			if (!(v2 & 2) || (v3 = *(uint32_t*)(target + 12), (v3 & 0x8000) == 0)) {
				if (!source || nox_xxx_unitIsEnemyTo_5330C0(source, target) &&
					...
					v4 = *(unaligned_float*)(target + 56) - *getMemFloatPtr(0x5D4594, 2487868);
					v5 = *(unaligned_float*)(target + 60) - *getMemFloatPtr(0x5D4594, 2487872);
					v6 = v5 * v5 + v4 * v4;
					if (v6 < *(unaligned_float*)&dword_5d4594_2487884) {
						*(unaligned_float*)&dword_5d4594_2487884 = v6;
...
int nox_xxx_firewalkTick_52ED40(float* a1) {
	...
	if (*((uint32_t*)a1 + 15) == *((uint32_t*)a1 + 16)) {
		...
		*((uint32_t*)a1 + 18) = v4;
		a1[19] = *(unaligned_float*)(*((uint32_t*)a1 + 12) + 60);
		*((uint32_t*)a1 + 20) = v4;
		a1[21] = a1[19];
		++*((uint32_t*)a1 + 16);
		result = 0;
	} else {
		v5 = (unaligned_float*)*((uint32_t*)a1 + 12);
		v6 = *((uint32_t*)a1 + 2);
		v7 = v5[14] - a1[18];
		v8 = v5[15] - a1[19];
		v9 = sqrt(v8 * v8 + v7 * v7);
		...
		if (v9 - v5[44] > 15.0) {
			...
			v1[21] = v1[19];
			v16 = *((uint32_t*)v1 + 12);
			v1[18] = *(unaligned_float*)(v16 + 56);
			v1[19] = *(unaligned_float*)(v16 + 60);
		}
		result = 0;
	}
	return result;
...
int sub_52EF30(int a1) {
	...
	if (*(uint32_t*)(a1 + 20)) {
		*(uint16_t*)(a1 + 72) = *(uint16_t*)(*(uint32_t*)(a1 + 24) + 124);
		v3 = *(uint32_t*)(a1 + 24);
		v4 = *(unaligned_float*)(v3 + 56);
		v5 = *(unaligned_float*)(v3 + 60);
	} else {
		v1 = *(uint32_t*)(a1 + 16);
		if (*(uint8_t*)(v1 + 8) & 4) {
		...
		v6 = *(uint32_t*)(a1 + 16);
		v4 = *(unaligned_float*)(v6 + 56);
		v5 = *(unaligned_float*)(v6 + 60);
...
int sub_52EFD0(int a1) {
	...
	if (*(uint32_t*)(a1 + 68) - 1 == gameFrame()) {
		v4 = (unaligned_float*)nox_xxx_newObjectByTypeID_4E3810("DeathBall");
		if (v4) {
			if (*(uint32_t*)(a1 + 20)) {
				v5 = *(unaligned_float*)(a1 + 28);
				v6 = *(unaligned_float*)(a1 + 32);
				v7 = *(uint16_t*)(a1 + 72);
				v13 = *(unaligned_float*)(a1 + 28);
				v8 = 0.0;
				v14 = *(unaligned_float*)(a1 + 32);
			} else {
				v9 = *(uint32_t*)(a1 + 16);
				v5 = *(unaligned_float*)(v9 + 56);
				v6 = *(unaligned_float*)(v9 + 60);
				v7 = *(uint16_t*)(v9 + 124);
				v13 = *(unaligned_float*)(v9 + 56);
				v14 = *(unaligned_float*)(v9 + 60);
				switch (*(uint32_t*)(v9 + 172)) {
				case 1:
					v8 = 4.0;
					break;
				case 2:
					v8 = *(unaligned_float*)(v9 + 176) + 4.0;
					break;
				case 3:
					if (*(unaligned_float*)(v9 + 184) <= (double)*(unaligned_float*)(v9 + 188)) {
						v8 = *(unaligned_float*)(v9 + 188) + 4.0;
					} else {
						v8 = *(unaligned_float*)(v9 + 184) + 4.0;
					}
					break;
				default:
					v8 = 24.0;
...
int sub_52F2E0(float a1) {
	...
	v11 = *(unaligned_float*)(LODWORD(a1) + 72) + *getMemFloatPtr(0x587000, 260360 + 4 * *(uint32_t*)(LODWORD(a1) + 8));
	...
	*(unaligned_float*)(LODWORD(v1) + 72) = v11 - (double)nox_float2int(v11);
			...
			if (*(uint8_t*)(v5 + 8) & 2 && sub_4FEA70(v5, (float2*)(LODWORD(a1) + 28))) {
				...
				if (v6 == nox_xxx_unitGetOldMana_4EEC80(*(uint32_t*)(LODWORD(a1) + 48))) {
					...
					if (nox_xxx_unitGetHP_4EE780(*(uint32_t*)(LODWORD(a1) + 16))) {
						v8 = *(unaligned_float*)(LODWORD(a1) + 72);
						v9 = nox_xxx_gamedataGetFloatTable_419D70("ChannelLifeCoeff",
																  *(uint32_t*)(LODWORD(v1) + 8) - 1) +
							 v8;
						*(unaligned_float*)(LODWORD(v1) + 72) = v9 - (double)nox_float2int(v9);
						v7 = nox_float2int(v9);
...
void nox_xxx_unitShieldReduceDamage_52F710(int a1, int* a2, int a3, int a4) {
	...
	if (a1 && a2) {
		...
		if (a4) {
			nox_xxx_netSendShieldFx_523670(a1, (unaligned_float*)(a4 + 56));
		} else {
