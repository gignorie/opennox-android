...
int nox_xxx_onFrameLightning_52F8A0(int a1) {
	int source;                // esi
	int v2;                    // eax
	int v4;                    // eax
	int v5;                    // eax
	...
	source = a1;
	v2 = *(uint32_t*)(source + 16);
	if (v2) {
		if (nox_xxx_testUnitBuffs_4FF350(v2, 8)) {
			return 1;
		}
	} else if (!*(uint32_t*)(source + 20)) {
		return 1;
	}
	...
	*getMemU32Ptr(0x5D4594, 2487860) = 0;
	...
	if (!(*(uint8_t*)(v10 + 8) & 4) || (v11 = *(uint32_t*)(v10 + 748), (v12 = *(uint32_t*)(v11 + 288)) == 0) ||
		(!nox_xxx_unitIsEnemyTo_5330C0(v10, *(uint32_t*)(v11 + 288)) ||
		 ...
		 !target)) {
		*(unaligned_float*)&nox_xxx_lightningClosestTargetDistance_5d4594_2487912 = lightningRange * lightningRange;
...
LABEL_55:
	...
	damage = nox_xxx_gamedataGetFloat_419D40("LightningDamage") + *(unaligned_float*)(source + 76);
	v20 = nox_float2int(damage);
	*(unaligned_float*)(source + 76) = damage - (double)v20;
		...
		if (!(*(uint8_t*)(target + 8) & 2) || (v3 = *(uint32_t*)(target + 12), (v3 & 0x8000) == 0)) {
			...
			LABEL_14:
				if (nox_xxx_unitCanInteractWith_5370E0(source, target, 0)) {
					xDistance = *(unaligned_float*)(target + 56) - *(unaligned_float*)(source + 56);
					yDistance = *(unaligned_float*)(target + 60) - *(unaligned_float*)(source + 60);
					distance = yDistance * yDistance + xDistance * xDistance;
					if (distance < *(unaligned_float*)&nox_xxx_lightningClosestTargetDistance_5d4594_2487912) {
						*(unaligned_float*)&nox_xxx_lightningClosestTargetDistance_5d4594_2487912 = distance;
...
uint32_t* nox_xxx_spellTeleportCreateWake_530560(int a1, int* a2, uint32_t* a3) {
	...
	if (result) {
		...
		*v6 = *a3;
		v6[1] = a3[1];
		nox_xxx_createAt_4DAA50((int)v5, a1, *(unaligned_float*)a2, *((unaligned_float*)a2 + 1));
...
int sub_530650(int* a1) {
	...
	if (*(uint8_t*)(v4 + 8) & 4) {
		...
		nox_xxx_teleportToMB_4E7190((uint8_t*)a1[12], (unaligned_float*)(*(uint32_t*)(v5 + 4 * v6 + 116) + 56));
		if (nox_xxx_testUnitBuffs_4FF350(a1[12], 0)) {
			v10 = a1[12];
			if (!(*(uint8_t*)(v10 + 8) & 4)) {
				goto LABEL_18;
...
int sub_530880(int* a1) {
	...
	if (*(uint8_t*)(v4 + 8) & 4) {
		...
		nox_xxx_teleportToMB_4E7190((uint8_t*)a1[12], (unaligned_float*)(*(uint32_t*)(v5 + 4 * v10 + 116) + 56));
		if (!nox_xxx_testUnitBuffs_4FF350(a1[12], 0)) {
...
int nox_xxx_castTTT_530B70(int* a1) {
	...
	nox_xxx_teleportToMB_4E7190((uint8_t*)a1[12], (unaligned_float*)a1 + 13);
	if (nox_xxx_testUnitBuffs_4FF350(a1[12], 0)) {
		v6 = a1[12];
		if (!(*(uint8_t*)(v6 + 8) & 4)) {
			sub_4E7540(a1[4], a1[12]);
...
int sub_530D30(int* a1) {
	...
	if (!(!(*(uint8_t*)(v5 + 8) & 4) ||
		(v6 = *(uint32_t*)(v5 + 748),
		 v14.field_0 = *(unaligned_float*)(v5 + 56) - (double)*(unsigned short*)(*(uint32_t*)(v6 + 276) + 10),
		 v14.field_4 = *(unaligned_float*)(v5 + 60) - (double)*(unsigned short*)(*(uint32_t*)(v6 + 276) + 12),
		 v14.field_8 = (double)*(unsigned short*)(*(uint32_t*)(v6 + 276) + 10) + *(unaligned_float*)(v5 + 56),
		 v18 = *(unsigned short*)(*(uint32_t*)(v6 + 276) + 12), v7 = (float2*)(v1[12] + 56),
		 v14.field_C = (double)v18 + *(unaligned_float*)(v5 + 60), sub_428220(v7, &v14)))) {
		nox_xxx_netPriMsgToPlayer_4DA2C0(v1[4], "ExecDur.c:NeedClearLOSForSwap", 0);
		return 1;
	}
LABEL_23:
	v8 = v1[12];
	v14.field_0 = *(unaligned_float*)(v8 + 56);
	v13 = (unaligned_float*)(v1[4] + 56);
	v14.field_4 = *(unaligned_float*)(v8 + 60);
...
int nox_xxx_manaBomb_530F90(uint32_t* a1) {
	...
	if (v2) {
		nox_xxx_createAt_4DAA50((int)v2, 0, *((unaligned_float*)a1 + 7), *((unaligned_float*)a1 + 8));
		a1[19] = v2;
	}
	return 0;
}
...
LABEL_18:
	...
	if (!v5) {
		if (a1[5]) {
			v7 = *((unaligned_float*)a1 + 8);
			v15.field_0 = *((unaligned_float*)a1 + 7);
		} else {
			v8 = a1[4];
			if (!v8) {
				return 1;
			}
			v15.field_0 = *(unaligned_float*)(v8 + 56);
			v7 = *(unaligned_float*)(v8 + 60);
		}
		v15.field_4 = v7;
	...
	do {
		...
		if (v3) {
			...
			*((uint16_t*)v4 + 63) = v2;
			v5 = 8 * (short)v2;
			*((uint16_t*)v4 + 62) = v2;
			*((unaligned_float*)v4 + 20) = *getMemFloatPtr(0x587000, 194136 + v5) * 4.0;
			v6 = *getMemFloatPtr(0x587000, 194140 + v5) * 4.0;
			v4[28] = 0;
			*((unaligned_float*)v4 + 21) = v6;
		}
		v2 += 6;
	} while (v2 < 256);
		...
		if (!(*(uint32_t*)(a1 + 16) & 0x8020) && a1 != a2) {
			if (!(v2 & 2) || (v3 = *(uint32_t*)(a1 + 12), (v3 & 0x8000) == 0)) {
				if (nox_xxx_unitIsEnemyTo_5330C0(a2, a1) &&
					...
					v4 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a2 + 56);
					v5 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a2 + 60);
					v6 = v5 * v5 + v4 * v4;
	...
	if (nox_xxx_testUnitBuffs_4FF350(a1, 29) || (result = (int*)nox_xxx_mobCastRelated2_540D90(a1, a2)) == 0) {
		if (nox_xxx_monsterCanShoot_534280(a1)) {
			...
			if (v4 && (v5 = nox_xxx_calcDistance_4E6C00(a1, a2), v7 = a2, v6 = a1,
					   v5 < *(unaligned_float*)(*(uint32_t*)(v2 + 484) + 212) * 0.5)) {
...
int* nox_xxx_monsterAction_531C60(int a1, int a2) {
	...
	if (nox_xxx_monsterCanShoot_534280(a1)) {
		...
		if (v5) {
			v6 = *(unaligned_float*)(*(uint32_t*)(v2 + 484) + 212) * 0.60000002;
			v5[3] = a2;
			*((unaligned_float*)v5 + 1) = v6;
		}
	}
...
char nox_xxx_mobActionFight_531EC0(int a1) {
	...
	*getMemU32Ptr(0x5D4594, 2487944) = 0;
	...
	if (*getMemU32Ptr(0x5D4594, 2487944)) {
		...
		v5 = *v4 - *(unaligned_float*)(a1 + 56);
		v6 = *(unaligned_float*)(v2 + 8) - *(unaligned_float*)(a1 + 60);
		if (v6 * v6 + v5 * v5 < 64.0) {
			LOBYTE(v3) = nox_xxx_monsterPopAction_50A160(a1);
			return (char)v3;
		}
...
int* nox_xxx_mobActionMelee1_532130(int a1) {
	...
	if (gameFrame() >= *(int*)(v1 + 512)) {
		...
		v14.field_0 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)&dword_587000_261388;
		v14.field_4 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)&dword_587000_261388;
		v14.field_8 = *(unaligned_float*)&dword_587000_261388 + *(unaligned_float*)(a1 + 56);
		v5 = *(unaligned_float*)&dword_587000_261388 + *(unaligned_float*)(a1 + 60);
		dword_5d4594_2487948 = 0;
		v14.field_C = v5;
		*getMemFloatPtr(0x5D4594, 2487952) = *(unaligned_float*)&dword_587000_261388 + 1.0;
		...
		if (v2) {
			*((unaligned_float*)v2 + 1) = *(unaligned_float*)(*(uint32_t*)(v1 + 484) + 112) * 1.2;
...
uint32_t* sub_532540(int a1) {
	...
	if (gameFrame() >= v1[128]) {
		...
		*(uint32_t*)(a1 + 136) = gameFrame();
		...
		v2 = nox_xxx_monsterPushAction_50A260(a1, 50);
		if (v2) {
			*((unaligned_float*)v2 + 1) = *(unaligned_float*)(v1[121] + 212) * 1.2;
			v2[3] = v1[299];
		}
		result = nox_xxx_monsterPushAction_50A260(a1, 1);
		if (result) {
...
char nox_xxx_mobActionMissileAtt_532610(int a1) {
	...
	if (*(uint8_t*)(a1 + 12) & 0x10) {
		...
		if (*(unsigned char*)(v2 + 481) == *(uint32_t*)(v5 + 216) && !*(uint8_t*)(v2 + 482)) {
			v6 = (unaligned_float*)nox_xxx_newObjectByTypeID_4E3810((char*)(v5 + 148));
			if (v6) {
				v7 = v4[3];
				if (v7) {
					nox_xxx_projAddVelocitySmth_533080(a1, v7, v6[136], (int)&v22);
				} else {
					v8 = *(unaligned_float*)(&v4[2]);
					v22.field_0 = *(unaligned_float*)(&v4[1]);
					v22.field_4 = v8;
				}
				v9 = v22.field_0 - *(unaligned_float*)(a1 + 56);
				v10 = v22.field_4 - *(unaligned_float*)(a1 + 60);
				v18 = v10;
				v11 = 8 * *(short*)(a1 + 124);
				v12 = *(unaligned_float*)(a1 + 60);
				v24.field_0 = *(unaligned_float*)(a1 + 56);
				v24.field_4 = v12;
				v25 = sqrt(v10 * v18 + v9 * v9) + 0.1;
				v16 = *(unaligned_float*)(v1 + 176) + 4.0;
				v20 = v9 * v6[136] / v25;
				v21 = v18 * v6[136] / v25;
				v17 = v16 * *getMemFloatPtr(0x587000, 194136 + v11) + *(unaligned_float*)(v1 + 56);
				v19 = v16 * *getMemFloatPtr(0x587000, 194140 + v11) + *(unaligned_float*)(v1 + 60);
				v24.field_8 = v17 + v20;
				v24.field_C = v19 + v21;
...
int nox_xxx_projAddVelocitySmth_533080(int a1, int a2, float a3, int a4) {
	...
	result = a2;
	v5 = *(unaligned_float*)(a2 + 56) - *(unaligned_float*)(a1 + 56);
	v6 = *(unaligned_float*)(a2 + 60) - *(unaligned_float*)(a1 + 60);
	v7 = sqrt(v6 * v6 + v5 * v5) / a3;
	*(unaligned_float*)a4 = v7 * *(unaligned_float*)(a2 + 80) + *(unaligned_float*)(a2 + 56);
	*(unaligned_float*)(a4 + 4) = v7 * *(unaligned_float*)(a2 + 84) + *(unaligned_float*)(a2 + 60);
	return result;
}
...
void nox_xxx_mobCalcDir_533CC0(int a1, float* a2) {
	...
	if (a1) {
		v2.field_0 = *a2 - *(unaligned_float*)(a1 + 56);
		v2.field_4 = a2[1] - *(unaligned_float*)(a1 + 60);
...
void sub_533EB0(int a1, int a2) {
	...
	v2 = a1;
	v3 = *(unaligned_float*)(a1 + 76);
	a3.field_0 = *(unaligned_float*)(a1 + 72);
	a3.field_4 = v3;
	if (sub_54E6F0(a2, a1)) {
		if (nox_server_testTwoPointsAndDirection_4E6E50((float2*)(a2 + 56), *(short*)(a2 + 124), &a3) & 1) {
			v4 = *(short*)(a2 + 124);
			v5 = *(unaligned_float*)(a1 + 80) * *getMemFloatPtr(0x587000, 194136 + 8 * v4);
			v6 = *(unaligned_float*)(a1 + 84) * *getMemFloatPtr(0x587000, 194140 + 8 * v4);
			v7 = getMemFloatPtr(0x587000, 194136 + 8 * v4);
			if (v5 + v6 < 0.0) {
				v10 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a2 + 56);
				v11 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a2 + 60);
				v8 = *v7 * v11 + -v7[1] * v10;
				if (v8 < 0.0) {
					v8 = -v8;
				}
				if (v8 < 20.0) {
					v9 = sqrt(*(unaligned_float*)(a1 + 80) * *(unaligned_float*)(a1 + 80) + *(unaligned_float*)(a1 + 84) * *(unaligned_float*)(a1 + 84));
					v13 = *(unaligned_float*)(a1 + 80) / v9;
					v14 = sqrt(v11 * v11 + v10 * v10);
					if (*(unaligned_float*)(v2 + 84) / v9 * -(v11 / v14) + v13 * -(v10 / v14) > 0.69999999) {
...
int nox_xxx_monsterCanMelee_534220(int a1) {
	...
	if (*(unaligned_float*)(*(uint32_t*)(v1 + 484) + 112) <= 0.0) {
		return 0;
	} else {
		return 1;
	}
...
//----- (00534320) --------------------------------------------------------
int nox_xxx_monsterIsMoveing_534320(int a1) { return *(unaligned_float*)(a1 + 548) >= 0.0099999998; }
...
int nox_xxx_monsterCanAttackAtWill_534390(nox_object_t* a1) {
	return *(unaligned_float*)(*(uint32_t*)((int)a1 + 748) + 1304) > 0.66000003;
}
...
int sub_5343C0(int a1) {
	...
	v1 = *(uint32_t*)(a1 + 748);
	return *(unaligned_float*)(v1 + 1304) < 0.66000003 && *(unaligned_float*)(v1 + 1304) > 0.33000001;
}
...
int sub_534400(int a1) {
	...
	v1 = *(uint32_t*)(a1 + 748);
	return *(unaligned_float*)(v1 + 1304) < 0.33000001 && *(unaligned_float*)(v1 + 1304) > 0.079999998;
}

//----- (00534440) --------------------------------------------------------
int sub_534440(int a1) { return *(unaligned_float*)(*(uint32_t*)(a1 + 748) + 1304) < 0.079999998; }

//----- (00534470) --------------------------------------------------------
double sub_534470(int a1) { return *(unaligned_float*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 484) + 112); }
...
void nox_xxx_monsterMimicCheckMorph_534950(nox_object_t* a1p) {
	...
	if (v2 && (v2 != 4 || (v4 = *(unaligned_float*)(v3 + 4) - *(unaligned_float*)(a1 + 56), v5 = *(unaligned_float*)(v3 + 8) - *(unaligned_float*)(a1 + 60),
						   v5 * v5 + v4 * v4 > 64.0))) {
...
char nox_xxx_projectileTraceHit_537850(int a1, int* a2, float2* a3) {
	...
	v3 = a1;
	v4 = 0;
	*(unaligned_float*)&v34 = *(unaligned_float*)(a1 + 64) - *(unaligned_float*)(a1 + 56);
	v5 = *(unaligned_float*)(v3 + 68) - *(unaligned_float*)(v3 + 60);
	v26 = v5;
	v6 = v5 * v26 + *(unaligned_float*)&v34 * *(unaligned_float*)&v34;
	if (v6 <= 36.0) {
		v7 = *(uint32_t*)(v3 + 56);
		v8 = *(unaligned_float*)(v3 + 64);
		v28.field_4 = *(unaligned_float*)(v3 + 68);
		v29[0] = v7;
		v28.field_0 = v8;
		...
		if (v9) {
			v4 = v9;
			v27.field_0 = *(unaligned_float*)v29 - *(unaligned_float*)(v9 + 56);
			v27.field_4 = *(unaligned_float*)&v29[1] - *(unaligned_float*)(v9 + 60);
		}
	} else {
		v15 = nox_double2int(sqrt(v6 * 0.027777778)) + 1;
		v16 = *(unaligned_float*)(v3 + 60);
		v17 = (double)v15;
		v29[0] = *(uint32_t*)(v3 + 56);
		v18 = 0;
		*(unaligned_float*)&v29[1] = v16;
		LODWORD(v28.field_0) = v29[0];
		v28.field_4 = v16;
		*(unaligned_float*)&v35 = *(unaligned_float*)&v34 / v17;
		v27.field_0 = v26 / v17;
		if (v15 > 0) {
			while (1) {
				v28.field_0 = v28.field_0 + *(unaligned_float*)&v35;
	...
	v10 = *(unaligned_float*)(v3 + 60);
	v11 = *(unaligned_float*)(v3 + 64);
	a1a.field_0 = *(unaligned_float*)(v3 + 56);
	v12 = *(unaligned_float*)(v3 + 68);
	a1a.field_4 = v10;
	a1a.field_8 = v11;
	a1a.field_C = v12;
	...
	if (v4) {
		...
		v19 = *(unaligned_float*)(v3 + 56) - *(unaligned_float*)(v4 + 56);
		v20 = *(unaligned_float*)(v3 + 60) - *(unaligned_float*)(v4 + 60);
		v21 = v20 * v20 + v19 * v19;
		v22 = *(unaligned_float*)(v3 + 56) - a2a.field_0;
		v23 = *(unaligned_float*)(v3 + 60) - a2a.field_4;
...
void nox_xxx_sMakeScorch_537AF0(float* a1, int a2) {
	...
	v3 = result;
	if (result) {
		nox_xxx_createAt_4DAA50((int)result, 0, *(unaligned_float*)a1, *((unaligned_float*)a1 + 1));
...
int nox_xxx_playerTraceAttack_538330(int a1, int a2) {
	...
	if (v3 && (v4 = *(uint32_t*)(v3 + 12), BYTE1(v4) & 0x40)) {
		sub_518040(a2 + 16, *(unaligned_float*)(a2 + 8), sub_538510, a2);
		v21 = 25;
	} else {
		dword_5d4594_2488660 = 0;
		dword_5d4594_2488652 = *(uint32_t*)(a2 + 8);
		sub_518040(a1 + 56, *(unaligned_float*)(a2 + 8), sub_5386A0, a1);
		if (dword_5d4594_2488660) {
			sub_538510(*(int*)&dword_5d4594_2488660, a2);
		}
	}
	v23 = (double)v21;
	v15 = *(unaligned_float*)(a2 + 16) - *(unaligned_float*)(a2 + 8) - v23;
	v5 = nox_float2int(v15);
	v16 = *(unaligned_float*)(a2 + 20) - *(unaligned_float*)(a2 + 8) - v23;
	a1a.field_0 = v5 / 23;
	v6 = nox_float2int(v16);
	v17 = *(unaligned_float*)(a2 + 8) + *(unaligned_float*)(a2 + 16) + v23;
	a1a.field_4 = v6 / 23;
	v8 = nox_float2int(v17);
	v18 = *(unaligned_float*)(a2 + 20) + *(unaligned_float*)(a2 + 8) + v23;
	a1a.field_8 = v8 / 23;
	...
	a3 = v23 + *(unaligned_float*)(a2 + 8);
	nox_xxx_mapDamageToWalls_534FC0(&a1a, a2 + 16, a3, (long long)(*(unaligned_float*)a2 + 0.5), *(unsigned char*)(a2 + 4), v12);
	if (*(uint32_t*)(a2 + 28)) {
		if (dword_5d4594_2488656) {
			v20 = *(unsigned char*)(a2 + 4);
			v19 = nox_xxx_gamedataGetFloat_419D40("ItemDamagePercentage") * *(unaligned_float*)a2;
					...
					if ((unsigned char)nox_server_testTwoPointsAndDirection_4E6E50(
						...
						*(uint8_t*)(a2 + 32)) {
						...
						if (!(v3 & 0x8040) && (*(uint32_t*)(a2 + 24) || !(v3 & 8))) {
							...
							v4 = *(uint32_t*)(a2 + 12);
							v12.field_0 = *(unaligned_float*)(v4 + 56);
							v5 = *(unaligned_float*)(a1 + 60);
							v6 = *(unaligned_float*)(v4 + 60);
							v7 = *(unaligned_float*)(a1 + 56);
							v12.field_4 = v6;
							v12.field_8 = v7;
							v12.field_C = v5;
							if (nox_xxx_mapTraceRay_535250(&v12, 0, 0, 5)) {
								...
								(*(void (**)(int, uint32_t, uint32_t, uint32_t, uint32_t))(a1 + 716))(
									a1, *(uint32_t*)(a2 + 12), *(uint32_t*)(a2 + 28), (long long)(*(unaligned_float*)a2 + 0.5),
									*(unsigned char*)(a2 + 4));
								if (nox_common_gameFlags_check_40A5C0(2048)) {
				...
				if (!(v2 & 0x8049) && (*(uint8_t*)(a3 + 8) & 6 || !(v2 & 0x10) || (v2 & 0x80u) != 0) &&
					...
					if ((v3 & 0x8000) == 0) {
						if (nox_xxx_unitCanInteractWith_5370E0(a2, a3, 1)) {
							if (*(unaligned_float*)&dword_5d4594_2488652 > 0.0) {
								a4.field_0 = *(unaligned_float*)(a3 + 56) - *(unaligned_float*)(a2 + 56);
								v4 = *(unaligned_float*)(a3 + 60) - *(unaligned_float*)(a2 + 60);
								a4.field_4 = v4;
								...
								if (v5 != 0.0) {
									...
									if (a4.field_4 / v5 * v6[1] + a4.field_0 / v5 * *v6 > 0.5) {
										if (*(uint32_t*)(a3 + 172) == 2) {
											v5 = v5 - *(unaligned_float*)(a3 + 176);
										} else if (*(uint32_t*)(a3 + 172) == 3) {
											v7 =
												sub_54A990((float2*)(a2 + 56), *(unaligned_float*)&dword_5d4594_2488652, a3, &a4);
											if (v7 < 0.0) {
												return;
											}
											v5 = *(unaligned_float*)&dword_5d4594_2488652 - v7;
										}
										if (v5 < 0.0) {
											v5 = 0.0;
										}
										if ((v5 < *(unaligned_float*)&dword_5d4594_2488652 ||
											 dword_5d4594_2488660 && !(*(uint8_t*)(dword_5d4594_2488660 + 8) & 2) &&
												 (*(uint8_t*)(a3 + 8) & 2) == 2) &&
											(!dword_5d4594_2488660 || !(*(uint8_t*)(dword_5d4594_2488660 + 8) & 2))) {
											*(unaligned_float*)&dword_5d4594_2488652 = v5;
...
int nox_xxx_playerAttack_538960(nox_object_t* a1p) {
	...
	LOBYTE(v80) = v6;
	if (v4) {
		v1 = (unaligned_float*)nox_xxx_getProjectileClassById_413250(*(unsigned short*)(v4 + 4));
		if (!v1) {
			return 0;
		}
	...
	*(uint32_t*)&v82[28] = v4;
	...
	if (nox_common_playerIsAbilityActive_4FC250(a1, 2) && nox_xxx_probablyWarcryCheck_4FC3E0(a1, 2)) {
		...
		if (v76 == 770) {
			v7 = *(unaligned_float*)(a1 + 56);
			v8 = *(unaligned_float*)(a1 + 60);
			LODWORD(v83.field_0) = a1;
			v83.field_4 = v7;
			v83.field_8 = v8;
			nox_xxx_earthquakeSend_4D9110((unaligned_float*)(a1 + 56), 15);
	...
	if (nox_common_playerIsAbilityActive_4FC250(a1, 1)) {
		if (!nox_xxx_testUnitBuffs_4FF350(a1, 25) && !nox_xxx_testUnitBuffs_4FF350(a1, 5)) {
			...
			v10 = *(unaligned_float*)(a1 + 548) * 6.0;
			*(unaligned_float*)(a1 + 544) = v10;
			HIBYTE(v76) = v9;
			v11 = 8 * *(short*)(a1 + 124);
			v12 = v77 - 1;
			*(unaligned_float*)(a1 + 88) = v10 * *getMemFloatPtr(0x587000, 194136 + v11) + *(unaligned_float*)(a1 + 88);
			*(unaligned_float*)(a1 + 92) = v10 * *getMemFloatPtr(0x587000, 194140 + v11) + *(unaligned_float*)(a1 + 92);
			if (HIBYTE(v76) >= v12) {
				HIBYTE(v76) = 0;
			}
			goto LABEL_159;
	...
	if (!v4) {
		...
		v15 = *(uint32_t*)(a1 + 56);
		v16 = *(uint32_t*)(a1 + 60);
		*(unaligned_float*)&v87[64] = v13;
		*(uint16_t*)&v87[72] = v14;
		*(uint32_t*)&v82[16] = v15;
		*(uint32_t*)&v82[20] = v16;
		*(uint16_t*)&v87[60] = 0;
		*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v87);
		v17 = *(unaligned_float*)(a1 + 176) + 20.0;
		v82[4] = 10;
		*(uint32_t*)&v82[12] = a1;
		*(uint32_t*)&v82[24] = 0;
		*(unaligned_float*)&v82[8] = v17;
		v82[32] = 1;
		*(uint32_t*)&v82[28] = 0;
	...
	if (v5 & 0x47F8000) {
		...
		*(uint32_t*)&v82[20] = v21;
		*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
		v22 = *(unaligned_float*)(a1 + 176);
		v82[4] = 0;
		*(uint32_t*)&v82[12] = a1;
		v23 = v22 + v1[17];
		*(uint32_t*)&v82[24] = 0;
		v82[32] = 1;
		*(unaligned_float*)&v82[8] = v23;
	...
	if (v5 & 0x7800000) {
		...
		*(uint32_t*)&v82[20] = v26;
		*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
		v27 = *(unaligned_float*)(a1 + 176);
		v82[4] = 0;
		*(uint32_t*)&v82[12] = a1;
		v28 = v27 + v1[17];
		*(uint32_t*)&v82[24] = 0;
		v82[32] = 1;
		*(unaligned_float*)&v82[8] = v28;
		nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
		v18 = nox_xxx_playerTraceAttack_538330(a1, (int)v82);
		if (!v18) {
			nox_xxx_aud_501960(879, a1, 0, 0);
	...
	if (!(v5 & 0x40)) {
		if ((v5 & 0x80u) == 0) {
			if (v5 & 0x200) {
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					...
					*(uint32_t*)&v82[20] = v46;
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v47 = *(unaligned_float*)(a1 + 176);
					v82[4] = 0;
					*(uint32_t*)&v82[12] = a1;
					v48 = v47 + v1[17];
					*(uint32_t*)&v82[24] = 0;
					v82[32] = 1;
					*(unaligned_float*)&v82[8] = v48;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					...
					*(uint32_t*)&v82[20] = v49;
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v50 = *(unaligned_float*)(a1 + 176);
					v82[4] = 0;
					*(uint32_t*)&v82[12] = a1;
					v51 = v50 + v1[17];
					*(uint32_t*)&v82[24] = 0;
					v82[32] = 1;
					*(unaligned_float*)&v82[8] = v51;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
					if (!nox_xxx_playerTraceAttack_538330(a1, (int)v82)) {
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					...
					*(uint32_t*)&v82[20] = v52;
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v53 = *(unaligned_float*)(a1 + 176);
					v82[4] = 0;
					*(uint32_t*)&v82[12] = a1;
					v54 = v53 + v1[17];
					*(uint32_t*)&v82[24] = 0;
					v82[32] = 1;
					*(unaligned_float*)&v82[8] = v54;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
					if (!nox_xxx_playerTraceAttack_538330(a1, (int)v82)) {
						nox_xxx_aud_501960(881, a1, 0, 0);
					}
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					v55 = 8 * *(short*)(a1 + 124);
					*(unaligned_float*)&v82[16] = *getMemFloatPtr(0x587000, 194136 + v55) * 35.0 + *(unaligned_float*)(a1 + 56);
					*(unaligned_float*)&v82[20] = *getMemFloatPtr(0x587000, 194140 + v55) * 35.0 + *(unaligned_float*)(a1 + 60);
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v82[4] = 2;
					*(uint32_t*)&v82[12] = a1;
					*(unaligned_float*)&v82[8] = v1[17];
					*(uint32_t*)&v82[24] = 1;
					v82[32] = 1;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
					...
					nox_xxx_earthquakeSend_4D9110((unaligned_float*)(a1 + 56), v56);
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					...
					*(uint32_t*)&v82[20] = v57;
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v58 = *(unaligned_float*)(a1 + 176);
					v82[4] = 2;
					*(uint32_t*)&v82[12] = a1;
					v59 = v58 + v1[17];
					*(uint32_t*)&v82[24] = 1;
					v82[32] = 1;
					*(unaligned_float*)&v82[8] = v59;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
					if (!nox_xxx_playerTraceAttack_538330(a1, (int)v82)) {
				...
				if (HIBYTE(v76) == v77 / 2 && HIBYTE(v76) > (unsigned char)v76) {
					...
					*(uint32_t*)&v82[20] = v60;
					*(unaligned_float*)v82 = nox_xxx_calcBoltDamage_4EF1E0(v81, (int)v1);
					v61 = *(unaligned_float*)(a1 + 176);
					v82[4] = 0;
					*(uint32_t*)&v82[12] = a1;
					v62 = v61 + v1[17];
					*(uint32_t*)&v82[24] = 1;
					v82[32] = 1;
					*(unaligned_float*)&v82[8] = v62;
					nox_xxx_itemApplyAttackEffect_538840(v4, a1, (int)v82);
					if (!nox_xxx_playerTraceAttack_538330(a1, (int)v82)) {
		...
		v37 = *(unaligned_float*)(a1 + 176) + 4.0;
		v38 = 8 * *(short*)(a1 + 124);
		v39 = *(unaligned_float*)(a1 + 60);
		v40 = *(char**)(v4 + 736);
		v41 = v37 * *getMemFloatPtr(0x587000, 194136 + v38) + *(unaligned_float*)(a1 + 56);
		v83.field_0 = *(unaligned_float*)(a1 + 56);
		v83.field_4 = v39;
		v83.field_8 = v41;
		v83.field_C = v37 * *getMemFloatPtr(0x587000, 194140 + v38) + *(unaligned_float*)(a1 + 60);
		if (nox_xxx_mapTraceRay_535250(&v83, 0, 0, 4)) {
			...
			*(unaligned_float*)(v43 + 80) =
				*getMemFloatPtr(0x587000, 194136 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v43 + 544);
			*(unaligned_float*)(v43 + 84) =
				*getMemFloatPtr(0x587000, 194140 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v43 + 544);
			v44 = *(uint16_t*)(a1 + 124);
	...
	v29 = *(unaligned_float*)(a1 + 176) + 4.0;
	v30 = 8 * *(short*)(a1 + 124);
	v31 = *(unaligned_float*)(a1 + 60);
	v32 = v29 * *getMemFloatPtr(0x587000, 194136 + v30) + *(unaligned_float*)(a1 + 56);
	v83.field_0 = *(unaligned_float*)(a1 + 56);
	v83.field_4 = v31;
	v83.field_8 = v32;
	v83.field_C = v29 * *getMemFloatPtr(0x587000, 194140 + v30) + *(unaligned_float*)(a1 + 60);
	...
	*(unaligned_float*)(v34 + 80) = *getMemFloatPtr(0x587000, 194136 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v34 + 544);
	*(unaligned_float*)(v34 + 84) = *getMemFloatPtr(0x587000, 194140 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v34 + 544);
	v36 = *(uint16_t*)(a1 + 124);
...
uint32_t* nox_xxx_shootBowCrossbow2_539D80(int a1, int a2, int a3, char* a4) {
	...
	v19.field_4 = *(unaligned_float*)(a1 + 60);
	v17 = v7 + *(unaligned_float*)(a1 + 56);
	v8 = v4 * *getMemFloatPtr(0x587000, 194140 + v6);
	v9 = *(unaligned_float*)(a1 + 56);
	v19.field_8 = v17;
	v19.field_0 = v9;
	v18 = v8 + *(unaligned_float*)(a1 + 60);
	v19.field_C = v18;
	...
	if (result) {
		...
		if (v11) {
			...
			*(unaligned_float*)(v12 + 80) = *getMemFloatPtr(0x587000, 194136 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v12 + 544);
			*(unaligned_float*)(v12 + 84) = *getMemFloatPtr(0x587000, 194140 + 8 * *(short*)(a1 + 124)) * *(unaligned_float*)(v12 + 544);
			v13 = *(uint16_t*)(a1 + 124);
...
float* nox_xxx_updateProjTrail_53AEC0(int a1) {
	...
	v1 = (unaligned_float*)a1;
	v2 = 8 * *(short*)(a1 + 124);
	v3 = 0;
	v4 = *getMemFloatPtr(0x587000, 194136 + v2) * *(unaligned_float*)(a1 + 544);
	v18 = 0;
	v1[22] = v4 * 0.25 + v1[22];
...
void nox_xxx_updatePush_53B030(int a1) {
	nox_xxx_mapPushUnitsAround_52E040(a1 + 56, **(unaligned_float**)(a1 + 748), 0, *(unaligned_float*)(*(uint32_t*)(a1 + 748) + 8), 0, 0,
									  0);
}
...
void nox_xxx_fnElevatorShaft_53B410(int a1, int a2) {
	...
	if (nox_xxx_map_57B850((float2*)(a2 + 56), (unaligned_float*)(a2 + 172), (float2*)(a1 + 56))) {
		v2 = *(uint32_t*)(a2 + 748);
		v3 = *(uint32_t*)(*(uint32_t*)(v2 + 4) + 748);
		v4 = *(unaligned_float*)(a1 + 104) + 64.0 - (double)*(int*)(v3 + 16);
...
void nox_xxx_elevatorFn_53B750(int a1, int a2) {
	...
	if (nox_xxx_map_57B850((float2*)(a2 + 56), (unaligned_float*)(a2 + 172), (float2*)(a1 + 56))) {
		...
		v3 = *(uint32_t*)(v2 + 4);
		if (v3) {
			v6 = *(unaligned_float*)(a1 + 104) - (double)*(int*)(v2 + 16);
			if (sub_419A10(v6) < 10.0) {
				v4 = *(uint32_t*)(a1 + 172);
				if (v4 == 3) {
					if (*(unaligned_float*)(v3 + 184) < (double)*(unaligned_float*)(a1 + 184) ||
						*(unaligned_float*)(v3 + 188) < (double)*(unaligned_float*)(a1 + 188)) {
						*(uint32_t*)(a1 + 16) &= 0xFFEFFFFF;
						nox_xxx_unitRaise_4E46F0(a1, 0.0);
						return;
					}
				} else if (v4 == 2) {
					v5 = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 176);
					if (v5 > *(unaligned_float*)(v3 + 184) || v5 > *(unaligned_float*)(v3 + 188)) {
						*(uint32_t*)(a1 + 16) &= 0xFFEFFFFF;
						nox_xxx_unitRaise_4E46F0(a1, 0.0);
						return;
					}
...
void nox_xxx_updatePhantomPlayer_53B860(int a1) {
	...
	v1 = *(unaligned_float**)(a1 + 748);
	v2 = *(unaligned_float*)(*(uint32_t*)v1 + 56) - v1[1];
	v3 = *(unaligned_float*)(*(uint32_t*)v1 + 60) - v1[2];
	v7 = v3;
	if (v3 * v7 + v2 * v2 <= 160000.0) {
		*(unaligned_float*)(a1 + 64) = *(unaligned_float*)(*(uint32_t*)v1 + 56) - v2;
		*(unaligned_float*)(a1 + 68) = *(unaligned_float*)(*(uint32_t*)v1 + 60) - v7;
		v4 = *(uint32_t*)v1;
...
void nox_xxx_spellFlyUpdate_53B940(int a1) {
	...
	if (gameFrame() - *(uint32_t*)(a1 + 128) <= (unsigned int)nox_float2int(v15)) {
		...
		v9 = v2[1];
		if (v9) {
			v18 = *(unaligned_float*)(v9 + 56) - *(unaligned_float*)(a1 + 56);
			v10 = *(unaligned_float*)(v9 + 60) - *(unaligned_float*)(v1 + 60);
			v17 = v10;
			v11 = nox_double2float(sqrt(v10 * v17 + v18 * v18) + *(unaligned_double*)&qword_581450_10176);
			v12 = v18 * *(unaligned_float*)(v1 + 544);
			*(uint32_t*)(v1 + 112) = 1063675494;
			*(unaligned_float*)(v1 + 88) = v12 / v11;
			*(unaligned_float*)(v1 + 92) = v17 * *(unaligned_float*)(v1 + 544) / v11;
		} else {
			v13 = nox_double2float(
				sqrt(*(unaligned_float*)(a1 + 80) * *(unaligned_float*)(a1 + 80) + *(unaligned_float*)(a1 + 84) * *(unaligned_float*)(a1 + 84)) +
				*(unaligned_double*)&qword_581450_10176);
			v14 = *(unaligned_float*)(a1 + 544) * *(unaligned_float*)(a1 + 80);
			*(uint32_t*)(a1 + 112) = 1063675494;
			*(unaligned_float*)(a1 + 88) = v14 / v13;
			*(unaligned_float*)(a1 + 92) = *(unaligned_float*)(a1 + 544) * *(unaligned_float*)(a1 + 84) / v13;
		}
	} else {
...
void nox_xxx_updateAntiSpellProj_53BB00(int a1) {
	...
	if (gameFrame() - *(uint32_t*)(a1 + 128) <= (unsigned int)(5 * gameFPS())) {
		...
		v6 = *(uint32_t*)(v3 + 4);
		if (v6) {
			v7 = *(unaligned_float*)(v6 + 56) - *(unaligned_float*)(a1 + 56);
			v8 = *(unaligned_float*)(v6 + 60) - *(unaligned_float*)(a1 + 60);
			v9 = v7;
			v10 = sqrt(v8 * v8 + v7 * v7) + 0.1;
			*(unaligned_float*)(a1 + 88) = v9 * *(unaligned_float*)(a1 + 544) / v10;
			*(unaligned_float*)(a1 + 92) = v8 * *(unaligned_float*)(a1 + 544) / v10;
			if (v10 < 10.0) {
			...
			v11 = sqrt(*(unaligned_float*)(a1 + 80) * *(unaligned_float*)(a1 + 80) + *(unaligned_float*)(a1 + 84) * *(unaligned_float*)(a1 + 84)) + 0.1;
			*(unaligned_float*)(a1 + 88) = *(unaligned_float*)(a1 + 544) * *(unaligned_float*)(a1 + 80) / v11;
			*(unaligned_float*)(a1 + 92) = *(unaligned_float*)(a1 + 544) * *(unaligned_float*)(a1 + 84) / v11;
		}
		v17 = *(unaligned_float*)(a1 + 56);
		v18 = *(int*)(a1 + 60);
		v16 = nox_common_randomFloat_416030(-2.0, 2.0);
		v15 = nox_common_randomFloat_416030(-2.0, 2.0);
		v14 = nox_common_randomInt_415FA0(15, 30);
		v13 = nox_common_randomFloat_416030(-4.0, 4.0) + *(unaligned_float*)&v18;
...
void sub_53BD10(int a1, int a2) {
	...
	if (!(*(uint8_t*)(a1 + 16) & 0x20) && (!(*(uint8_t*)(a1 + 8) & 1) || *(uint8_t*)(a1 + 12) & 2) && a2 != a1 &&
		...
		if (nox_xxx_unitCanInteractWith_5370E0(a2, a1, 0)) {
			v2 = *(unaligned_float*)(a2 + 56) - *(unaligned_float*)(a1 + 56);
			v3 = *(unaligned_float*)(a2 + 60) - *(unaligned_float*)(a1 + 60);
			v4 = v3 * v3 + v2 * v2;
...
int nox_xxx_updateMagicMissile_53BDA0(int a1) {
	...
	if (v6) {
		v7 = *(uint16_t*)(a1 + 126);
		if ((*(unaligned_float*)(v6 + 60) - *(unaligned_float*)(a1 + 60)) * *getMemFloatPtr(0x587000, 194136 + 8 * v7) -
				(*(unaligned_float*)(v6 + 56) - *(unaligned_float*)(a1 + 56)) * *getMemFloatPtr(0x587000, 194140 + 8 * v7) >=
			0.0) {
	...
	*(unaligned_float*)(a1 + 88) = *getMemFloatPtr(0x587000, 194136 + result) * *(unaligned_float*)(a1 + 544);
	v10 = *getMemFloatPtr(0x587000, 194140 + result) * *(unaligned_float*)(a1 + 544);
	*(uint32_t*)(a1 + 112) = 1061997773;
	*(unaligned_float*)(a1 + 92) = v10;
	return result;
}
	...
	if (*v1) {
		...
		if (v5) {
			...
			if ((uint8_t)result) {
				...
				if (result) {
					a1a.field_0 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a1 + 176);
					a1a.field_4 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a1 + 176);
					a1a.field_8 = *(unaligned_float*)(a1 + 56) + *(unaligned_float*)(a1 + 176);
					a1a.field_C = *(unaligned_float*)(a1 + 60) + *(unaligned_float*)(a1 + 176);
...
void nox_xxx_fnPentagramTeleport_53C060(float* a1, int a2) {
	if (!((uint32_t)a1[2] & 0x420000)) {
		...
		nox_xxx_teleportToMB_4E7190(a1, (unaligned_float*)a2);
		nox_xxx_netSendPointFx_522FF0(137, (float2*)a1 + 7);
		nox_xxx_aud_501960(147, (int)a1, 0, 0);
	}
}
	...
	if (*(uint32_t*)(v2 + 4)) {
		...
		if (v3) {
			if (*(uint32_t*)(a1 + 16) & 0x1000000) {
				a1a.field_0 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a1 + 176);
				a1a.field_4 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a1 + 176);
				a1a.field_8 = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 56);
				a1a.field_C = *(unaligned_float*)(a1 + 60) + *(unaligned_float*)(a1 + 176);
...
void nox_xxx_updateBlow_53C160(int a3) {
	...
	if (*(uint32_t*)(a3 + 16) & 0x1000000) {
		...
		if (a2.field_0 >= 0) {
			if (a2.field_4 < 0) {
				v4 = *(unaligned_float*)(a3 + 60) - 400.0;
				v5 = *(unaligned_float*)(a3 + 60);
				a1.field_0 = *(unaligned_float*)(a3 + 56);
				a1.field_C = v5;
				a1.field_4 = v4;
				a1.field_8 = *(unaligned_float*)(a3 + 56) + 400.0;
				nox_xxx_getUnitsInRectAdv_517ED0(&a1, sub_53C240, a3);
				return;
			}
			v6 = *(unaligned_float*)(a3 + 56) + 400.0;
			v7 = *(unaligned_float*)(a3 + 60);
			a1.field_0 = *(unaligned_float*)(a3 + 56);
			a1.field_4 = v7;
			a1.field_8 = v6;
		} else {
			a1.field_0 = *(unaligned_float*)(a3 + 56) - 400.0;
			if (a2.field_4 < 0) {
				v1 = *(unaligned_float*)(a3 + 60) - 400.0;
				v2 = *(unaligned_float*)(a3 + 60);
				a1.field_8 = *(unaligned_float*)(a3 + 56);
				a1.field_C = v2;
				a1.field_4 = v1;
				nox_xxx_getUnitsInRectAdv_517ED0(&a1, sub_53C240, a3);
				return;
			}
			v3 = *(unaligned_float*)(a3 + 56);
			a1.field_4 = *(unaligned_float*)(a3 + 60);
			a1.field_8 = v3;
		}
		a1.field_C = *(unaligned_float*)(a3 + 60) + 400.0;
		nox_xxx_getUnitsInRectAdv_517ED0(&a1, sub_53C240, a3);
		return;
	}
}
...
void sub_53C240(float* a1, int arg4) {
	...
	if (!((uint8_t)a1[4] & 0x20) && !((uint32_t)a1[2] & 0x400000)) {
		v3 = arg4;
		v15 = a1[14] - *(unaligned_float*)(arg4 + 56);
		v4 = a1[15] - *(unaligned_float*)(v3 + 60);
		v13 = v4;
...
signed int nox_xxx_updateObelisk_53C580(int a1) {
	...
	while (1) {
		...
		v6 = *(unaligned_float*)(v1 + 56) - *(unaligned_float*)(v3 + 56);
		v7 = *(unaligned_float*)(v1 + 60) - *(unaligned_float*)(v3 + 60);
		v22 = 0;
...
void nox_xxx_updateWaterBarrel_53CB90(int a1) {
	...
	if (v1 == 8) {
		*getMemU32Ptr(0x5D4594, 2488664) = 0;
		a1a.field_0 = *(unaligned_float*)(a1 + 56) - 40.0;
		a1a.field_4 = *(unaligned_float*)(a1 + 60) - 40.0;
		a1a.field_8 = *(unaligned_float*)(a1 + 56) + 40.0;
		a1a.field_C = *(unaligned_float*)(a1 + 60) + 40.0;
...
void nox_xxx_waterBarrel_53CC30(float* a1, int a2) {
	...
	v2 = *((uint32_t*)a1 + 2);
	if (v2 & 0x2000) {
		v3 = *(unaligned_float*)a2 - a1[14];
		v4 = *(unaligned_float*)(a2 + 4) - a1[15];
...
void nox_xxx_updateTelekinesis_53D330(int a1) {
	...
	if (*(uint32_t*)(v1 + 16) & 0x8020 ||
		...
		v5.field_0 = *(unaligned_float*)(v1 + 56);
		v5.field_4 = *(unaligned_float*)(v1 + 60);
...
void nox_xxx_updateFist_53D400(int a1) {
	...
	if (*(unaligned_float*)(a1 + 104) <= 0.0 && (int)*(uint32_t*)(a1 + 16) >= 0) {
		nox_xxx_aud_501960(48, a1, 0, 0);
		nox_xxx_sMakeScorch_537AF0((int*)(a1 + 56), 2);
		v1 = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 56);
		*(uint32_t*)(a1 + 16) |= 0x80000000;
		a2.field_4 = *(unaligned_float*)(a1 + 60);
		a2.field_0 = v1;
		nox_xxx_netSendPointFx_522FF0(138, &a2);
		v2 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a1 + 176);
		a2.field_4 = *(unaligned_float*)(a1 + 60);
		a2.field_0 = v2;
		nox_xxx_netSendPointFx_522FF0(138, &a2);
		v3 = *(unaligned_float*)(a1 + 176) + *(unaligned_float*)(a1 + 60);
		a2.field_0 = *(unaligned_float*)(a1 + 56);
		a2.field_4 = v3;
		nox_xxx_netSendPointFx_522FF0(138, &a2);
		nox_xxx_earthquakeSend_4D9110((unaligned_float*)(a1 + 56), 30);
	}
	if (*(unaligned_float*)(a1 + 104) >= 200.0 && *(int*)(a1 + 16) < 0) {
		nox_xxx_delayedDeleteObject_4E5CC0(a1);
	}
...
void nox_xxx_updateFlameCleanse_53D510(int a1) {
	...
	if (gameFrame() >= *(int*)(a1 + 136) ||
		(v1 = *(unaligned_float*)(a1 + 156), v2 = *(unaligned_float*)(a1 + 56), v4.field_4 = *(unaligned_float*)(a1 + 160), v4.field_0 = v1,
		 v3 = *(unaligned_float*)(a1 + 60), v4.field_8 = v2, v4.field_C = v3, !nox_xxx_mapTraceRay_535250(&v4, 0, 0, 65)) ||
		(unsigned int)(gameFrame() - *(uint32_t*)(a1 + 128)) > 3 &&
			*(unaligned_float*)(a1 + 72) == *(unaligned_float*)(a1 + 56) && *(unaligned_float*)(a1 + 76) == *(unaligned_float*)(a1 + 60)) {
		nox_xxx_delayedDeleteObject_4E5CC0(a1);
	}
}
...
void nox_xxx_meteorExplode_53D6E0(int a6) {
	...
	if (*(unaligned_float*)(a6 + 104) <= 0.0) {
		v1 = *(int**)(a6 + 748);
		nox_xxx_aud_501960(87, a6, 0, 0);
		v2 = (unaligned_float*)(a6 + 56);
		nox_xxx_sMakeScorch_537AF0((int*)(a6 + 56), 2);
		nox_xxx_earthquakeSend_4D9110((unaligned_float*)(a6 + 56), 10);
		v3 = nox_xxx_newObjectByTypeID_4E3810("MeteorExplode");
		if (v3) {
			nox_xxx_createAt_4DAA50((int)v3, 0, *v2, *(unaligned_float*)(a6 + 60));
		}
		v4 = nox_xxx_findParentChainPlayer_4EC580(a6);
		nox_xxx_mapDamageUnitsAround_4E25B0(a6 + 56, 80.0, 30.0, *v1, 7, v4, 0);
		v5 = *v2 - 80.0;
		v6 = *(unaligned_float*)(a6 + 60) - 80.0;
		v7 = *v2 + 80.0;
		v8 = *(unaligned_float*)(a6 + 60) + 80.0;
...
void sub_53D8C0(int a1, int a2) {
	...
	if (*(uint8_t*)(a1 + 8) & 6) {
		v2 = *(unaligned_float*)(a1 + 56);
		v3 = *(unaligned_float*)(a2 + 56);
		v8.field_4 = *(unaligned_float*)(a2 + 60);
		v8.field_0 = v3;
		v4 = *(unaligned_float*)(a1 + 60);
		v8.field_8 = v2;
		v8.field_C = v4;
...
void nox_xxx_toxicCloudPoison_53D9D0(int a1, int a2) {
	...
	if (*(uint8_t*)(a1 + 8) & 6) {
		v2 = *(unaligned_float*)(a1 + 56);
		v3 = *(unaligned_float*)(a2 + 56);
		v7.field_4 = *(unaligned_float*)(a2 + 60);
		v7.field_0 = v3;
		v4 = *(unaligned_float*)(a1 + 60);
		v7.field_8 = v2;
		v7.field_C = v4;
...
void nox_xxx_updateArachnaphobia_53DA60(int* a1) {
	...
	if ((unsigned int)a1[34] < gameFrame()) {
		...
		if (v3) {
			nox_xxx_createAt_4DAA50((int)v3, a1[127], *((unaligned_float*)a1 + 14), *((unaligned_float*)a1 + 15));
		}
		...
		if (!*(uint8_t*)(v2 + 24)) {
			...
			if (v6 && ((v7 = *(uint32_t*)(v6 + 16), v7 & 0x20) || (v7 & 0x8000) != 0)) {
				...
				*(uint8_t*)(v2 + 24) = 1;
				...
				v8 = *(unaligned_float*)(v2 + 16) - *(unaligned_float*)(a1 + 56);
				v9 = *(unaligned_float*)(v2 + 20) - *(unaligned_float*)(a1 + 60);
				v11 = v9;
				v10 = sqrt(v9 * v11 + v8 * v8) + *(unaligned_double*)&qword_581450_10176;
				*(unaligned_float*)(v1 + 80) = v8 * *(unaligned_float*)(v1 + 544) / v10;
				*(unaligned_float*)(v1 + 84) = v11 * *(unaligned_float*)(v1 + 544) / v10;
			}
		}
	}
LABEL_19:
...
void nox_xxx_updateGameBall_53DF40(int a3) {
	...
	*(uint32_t*)(a3 + 112) = 1008981770;
	...
	v11.field_4 = *((unaligned_float*)&v2 + 1);
	if (v2 <= 20000) {
		v3 = *(uint32_t*)(a3 + 508);
		if (v3) {
			if (v3 != *(uint32_t*)v1 ||
				...
				*(uint64_t*)(v1 + 8) = nox_platform_get_ticks();
				...
				if (*(uint32_t*)(v5 + 16) & 0x8020) {
					...
					v6 = *(unaligned_float*)(v5 + 176) + *(unaligned_float*)(a3 + 176);
					v11.field_0 = *(unaligned_float*)(v5 + 56);
					v11.field_4 = *(unaligned_float*)(v5 + 60);
					v7 = v6 + 10.0;
					v11.field_8 = v7 * *getMemFloatPtr(0x587000, 194136 + 8 * *(short*)(v5 + 124)) + *(unaligned_float*)(v5 + 56);
					v11.field_C = v7 * *getMemFloatPtr(0x587000, 194140 + 8 * *(short*)(v5 + 124)) + *(unaligned_float*)(v5 + 60);
				...
				*(uint32_t*)(a3 + 520) = 0;
				...
				v11.field_0 = *(unaligned_float*)(a3 + 56) - *getMemFloatPtr(0x587000, 194136 + 8 * v4) * 20.0;
				v11.field_4 = *(unaligned_float*)(a3 + 60) - *getMemFloatPtr(0x587000, 194140 + 8 * v4) * 20.0;
			...
			v8 = *(unaligned_float*)(a3 + 84);
			v9 = *(unaligned_float*)(a3 + 80);
			v10 = *(uint32_t*)(a3 + 16);
			LOBYTE(v10) = v10 & 0xBF;
			*(uint32_t*)(a3 + 16) = v10;
			if (*(unaligned_float*)(v1 + 24) > sqrt(v9 * v9 + v8 * v8)) {
				*(uint32_t*)v1 = 0;
			}
		}
	} else {
	...
	if (!v2 || *(uint32_t*)(v2 + 16) & 0x8020) {
		...
		if (v3) {
			if (*(uint32_t*)(v3 + 16) & 0x8020) {
				...
				v4 = *(unaligned_float*)(v3 + 176) + *(unaligned_float*)(a1 + 176);
				v6.field_0 = *(unaligned_float*)(v3 + 56);
				v6.field_4 = *(unaligned_float*)(v3 + 60);
				v5 = v4 + 10.0;
				v6.field_8 = v5 * *getMemFloatPtr(0x587000, 194136 + 8 * *(short*)(v3 + 124)) + *(unaligned_float*)(v3 + 56);
				v6.field_C = v5 * *getMemFloatPtr(0x587000, 194140 + 8 * *(short*)(v3 + 124)) + *(unaligned_float*)(v3 + 60);
...
int nox_xxx_recalculateArmorVal_53E300(uint32_t* a1) {
	...
	if (v4 > *(unaligned_double*)&qword_581450_9512) {
		v4 = 1.0;
	}
	result = a1[2];
	if (result & 4) {
		result = a1[187];
		*(unaligned_float*)(result + 228) = v4;
	} else if (result & 2) {
		result = LODWORD(v4);
		*(unaligned_float*)(a1[187] + 2072) = v4;
	}
	return result;
}
...
int nox_xxx_useLesserFireballStaff_53F290(int a1, uint32_t* a2) {
	...
	if (!*(uint8_t*)(v2 + 109) || *(uint8_t*)(v2 + 108)) {
		if (gameFrame() - *(uint32_t*)(v2 + 104) >=
			...
			v7 = *(unaligned_float*)(a1 + 60);
			v13.field_0 = *(unaligned_float*)(a1 + 56);
			v13.field_4 = v7;
			v13.field_8 = v6 + *(unaligned_float*)(a1 + 56);
			v8 = v4 * *getMemFloatPtr(0x587000, 194140 + v5) + *(unaligned_float*)(a1 + 60);
			v13.field_8 = v13.field_8 + *(unaligned_float*)(a1 + 80);
			v13.field_C = v8 + *(unaligned_float*)(a1 + 84);
...
uint32_t* nox_xxx_wandShot_53F480(int a1, int a2, int* a3, uint32_t* a4) {
	...
	v5 = result;
	if (result) {
		nox_xxx_createAt_4DAA50((int)result, a1, *(unaligned_float*)a3, *((unaligned_float*)a3 + 1));
		result = a4;
		*((uint16_t*)v5 + 62) = (uint16_t)a4;
		*((uint16_t*)v5 + 63) = (uint16_t)a4;
		*((unaligned_float*)v5 + 20) = *getMemFloatPtr(0x587000, 194136 + 8 * (uint32_t)a4) * *((unaligned_float*)v5 + 136);
		*((unaligned_float*)v5 + 21) = *getMemFloatPtr(0x587000, 194140 + 8 * (uint32_t)a4) * *((unaligned_float*)v5 + 136);
		*((unaligned_float*)v5 + 20) = *(unaligned_float*)(a1 + 80) + *((unaligned_float*)v5 + 20);
		*((unaligned_float*)v5 + 21) = *(unaligned_float*)(a1 + 84) + *((unaligned_float*)v5 + 21);
	}
	return result;
}
...
int nox_xxx_useWandCastSpell_53F4F0(int a1, uint32_t* a2) {
	...
	if (*(uint8_t*)(a1 + 8) & 4) {
		v4 = *(uint32_t*)(a1 + 748);
		*(unaligned_float*)&v11[1] = (double)*(int*)(*(uint32_t*)(v4 + 276) + 2284);
		*(unaligned_float*)&v11[2] = (double)*(int*)(*(uint32_t*)(v4 + 276) + 2288);
		v5 = *(uint32_t*)(v4 + 288);
		if (v5) {
			v11[0] = v5;
			goto LABEL_13;
...
int nox_xxx_useFireWand_53F670(int a1, int a2) {
	...
	v8 = 0.0;
	v3 = 8 * *(short*)(a1 + 124);
	v11 = *getMemFloatPtr(0x587000, 194136 + v3) * *(unaligned_float*)(a1 + 176) * 1.5;
	v10 = *getMemFloatPtr(0x587000, 194140 + v3) * *(unaligned_float*)(a1 + 176) * 1.5;
	do {
		...
		v7 = v10 + *(unaligned_float*)(v2 + 60);
		v6 = v11 + *(unaligned_float*)(v2 + 56);
...
int nox_xxx_castPixies_540440(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	v18 = *(unaligned_float*)(a4 + 176) + 4.0;
	...
	if (v8 < (int)(long long)nox_xxx_gamedataGetFloatTable_419D70("PixieCount", a6 - 1)) {
		...
		if (v9 > 0) {
			...
			do {
				...
				v11 = *(unaligned_float*)(v6 + 60);
				v12 = v18 * *getMemFloatPtr(0x587000, 194136 + 8 * v10) + *(unaligned_float*)(v6 + 56);
				v17.field_0 = *(unaligned_float*)(v6 + 56);
				v17.field_4 = v11;
				v17.field_8 = v12;
				v17.field_C = v18 * *getMemFloatPtr(0x587000, 194140 + 8 * v10) + *(unaligned_float*)(v6 + 60);
...
int nox_xxx_mobHealSomeone_5411A0(nox_object_t* a3p) {
	...
	a1.field_0 = *(unaligned_float*)(a3 + 56) - v7;
	a1.field_4 = *(unaligned_float*)(a3 + 60) - v7;
	a1.field_8 = v7 + *(unaligned_float*)(a3 + 56);
	a1.field_C = v7 + *(unaligned_float*)(a3 + 60);
...
void nox_xxx_mobMayHealThis_5412A0(float* a1, int a2) {
	...
	if ((unaligned_float*)a2 != a1 && !nox_xxx_unitIsEnemyTo_5330C0(a2, (int)a1)) {
		if (*((uint32_t*)a1 + 139)) {
			v2 = *((uint32_t*)a1 + 4);
			if ((v2 & 0x8000) == 0) {
...
char nox_xxx_mobCast_541300(int a1, uint32_t* a2, int a3) {
	...
	nox_xxx_mobCalcDir_533CC0((int)a2, (unaligned_float*)(a3 + 4));
	...
	if (!(uint8_t)v4) {
		...
		if ((unsigned char)v4 == *(uint32_t*)(*(uint32_t*)(v2 + 484) + 216)) {
			if (a2) {
				...
				v8[0] = v3[3];
				nox_xxx_mobCastRandomRecoil_541490((int)a1, (unaligned_float*)v8[0], (float2*)&v8[1]);
			}
...
void nox_xxx_mobCastRandomRecoil_541490(int a1, float* a2, float2* a3) {
	...
	v5 = 1.0 - *(unaligned_float*)(*(uint32_t*)(a1 + 748) + 1320);
	*a3 = *((float2*)a2 + 7);
	v4 = v5 + 1.0;
...
char nox_xxx_mobActionMoveTo_5443F0(int a1) {
	...
	if (sub_50A040(a1) == 3) {
		v5 = *(unaligned_float*)(v2 + 1316) * 3.0;
		v14 = v5;
		v6 = v5 + 30.0;
		v7 = *(unaligned_float*)(v4 + 4) - *(unaligned_float*)(v1 + 56);
		v8 = *(unaligned_float*)(v4 + 8) - *(unaligned_float*)(v1 + 60);
		v9 = v8 * v8 + v7 * v7;
		if (v9 >= v14 * v14) {
			if (v9 > v6 * v6) {
				sub_534750(v1);
	...
	if (nox_xxx_creatureSetMovePath_50D5A0(v1) == 1) {
		...
		if (!v10 && !sub_547F10() && !*(uint32_t*)(v4 + 12)) {
			nox_xxx_mobCalcDir_533CC0(v1, (unaligned_float*)(v4 + 4));
...
void nox_xxx_mobActionDodge_544640(int a1) {
	...
	if (nox_xxx_monsterIsMoveing_534320(a1)) {
		if (!nox_xxx_testUnitBuffs_4FF350(a1, 3) && !nox_xxx_testUnitBuffs_4FF350(a1, 5) &&
			...
			v3 = *(unaligned_float*)(v2 + 24 * (*(char*)(v2 + 544) + 23) + 4) - *(unaligned_float*)(a1 + 56);
			v4 = *(unaligned_float*)(v2 + 24 * (*(char*)(v2 + 544) + 23) + 8) - *(unaligned_float*)(a1 + 60);
			v7 = v4;
			v5 = sqrt(v4 * v7 + v3 * v3) + 0.000099999997;
			v8 = v5;
			if (v5 >= 8.0) {
				v6 = *(unaligned_float*)(*(uint32_t*)(v2 + 484) + 96) * v1[136];
				v1[136] = v6;
				v1[22] = v6 * v3 / v8;
				v1[23] = v7 * v1[136] / v8;
			} else {
	...
	if (nox_xxx_monsterIsMoveing_534320(a1)) {
		...
		if (v4) {
			...
			*(uint32_t*)(v3 + 8) = *(uint32_t*)(v4 + 60);
			v5 = *(uint32_t*)(v1 + 1196);
			v6 = *(unaligned_float*)(v5 + 56) - *(unaligned_float*)(a1 + 56);
			v7 = *(unaligned_float*)(v5 + 60) - *(unaligned_float*)(a1 + 60);
			if (*(unaligned_float*)(v1 + 1356) * *(unaligned_float*)(v1 + 1356) > v7 * v7 + v6 * v6 &&
		...
		if (*(uint32_t*)(v1 + 8) || (unsigned int)(v9 - *(uint32_t*)(v1 + 280)) <= 0xA ||
			(v10 = v3 + 4, v11 = nox_xxx_generateRetreatPath_50CA00(v1 + 12, 32, a1, (unaligned_float*)v10),
			 *(uint32_t*)(v1 + 8) = v11, *(uint32_t*)(v1 + 280) = gameFrame(), *(uint32_t*)(v1 + 268) = 0,
			 v11 > 1)) {
			if (nox_xxx_creatureActuallyMove_50D3B0((unaligned_float*)a1)) {
				*(uint32_t*)(v1 + 8) = 0;
			}
...
void sub_544B20(int a1, int a2) {
	...
	if (*(uint32_t*)(a1 + 8) & 0x1000000 && nox_xxx_playerClassCanUseItem_57B3D0(a1, 0) &&
		nox_xxx_unitCanInteractWith_5370E0(a2, a1, 0)) {
		v2 = *(unaligned_float*)(a1 + 56) - *(unaligned_float*)(a2 + 56);
		v3 = *(unaligned_float*)(a1 + 60) - *(unaligned_float*)(a2 + 60);
		v4 = v3 * v3 + v2 * v2;
...
char nox_xxx_mobActionPickupObject_544B90(int a1) {
	...
	if (v3) {
		v4 = *(unaligned_float*)(v3 + 56) - *(unaligned_float*)(a1 + 56);
		v5 = *(unaligned_float*)(v3 + 60) - *(unaligned_float*)(a1 + 60);
...
void nox_xxx_createReleasedSoul_544E60(int a1) {
	...
	v3 = v2;
	if (v2) {
		nox_xxx_createAt_4DAA50((int)v2, 0, *(unaligned_float*)(a1 + 56), *(unaligned_float*)(a1 + 60));
		v4 = *(uint16_t*)(a1 + 124);
		*((uint16_t*)v3 + 63) = v4;
		*((uint16_t*)v3 + 62) = v4;
	}
...
void nox_xxx_mobActionDead2_544EC0(int a1) {
	...
	if (nox_xxx_unitIsZombie_534A40(a1)) {
		v2 = v1[360];
		if (v2 & 0x80000) {
			nox_xxx_netSparkExplosionFx_5231B0((unaligned_float*)(a1 + 56), 100);
