...
void sub_4EC720() {
	...
	for (int v0 = dword_5d4594_1568024; v0; v0 = *(uint32_t*)(v0 + 52)) {
					...
					*(uint32_t*)(v0 + 4) = 0;
					...
					if (*(uint32_t*)(v1 + 492) || !nox_xxx_getUnitDefDd10_4E3BA0(*(unsigned short*)(v1 + 4))) {
						...
						if (gameFrame() > (unsigned int)(5 * gameFPS() + *(uint32_t*)(v10 + 128))) {
							v11 = *(unaligned_float*)(v0 + 8) - *(unaligned_float*)(v10 + 56);
							v12 = *(unaligned_float*)(v0 + 12) - *(unaligned_float*)(v10 + 60);
		...
		v6 = (int)v5;
		if (v5) {
			nox_xxx_createAt_4DAA50((int)v5, 0, *(unaligned_float*)(v0 + 8), *(unaligned_float*)(v0 + 12));
			nox_xxx_netSendPointFx_522FF0(129, (float2*)(v0 + 8));
			v7 = *(uint16_t*)(v0 + 16);
			*(uint16_t*)(v6 + 124) = v7;
			*(uint16_t*)(v6 + 126) = v7;
		...
		do {
			...
			if ((unsigned short)v1 == dword_5d4594_1568300 || v1 == *getMemU32Ptr(0x5D4594, 1568304)) {
				if (*(uint8_t*)(*(uint32_t*)(v0 + 692) + 216) & 0x80) {
					...
					if (v7) {
						nox_xxx_createAt_4DAA50((int)v7, 0, *(unaligned_float*)(v0 + 56), *(unaligned_float*)(v0 + 60));
						if (v7[2] & 0x1000000) {
							if (v7[3] & 0xC) {
