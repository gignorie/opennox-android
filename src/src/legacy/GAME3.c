...
int nox_xxx_wndListBox_4A2D10(int a1, int a2, int a3) {
	...
	if (result) {
		...
		*(unaligned_float*)(result + 8) = (double)(int)(*(uint32_t*)(*(uint32_t*)(v3 + 36) + 12) -
	...
	if (v1) {
		...
		if ((v4 & 0x80u) == 0) {
			if (v4 & 0x200) {
				...
				v11 += 8;
				v13 = v9;
				*(unaligned_float*)(v2 + 56) = v9;
				v10 = (double)v14;
				*(unaligned_float*)(v2 + 60) = v10;
				if (v13 > 60.0) {
...
int nox_xxx_colorLightClientLoad_4AC980(int a1) {
	...
	if ((short)v8 >= 2) {
		...
		*(uint8_t*)(v2 + 274) = -128;
		...
		if (*(unaligned_float*)(v2 + 140) <= 63.0 &&
...
LABEL_13:
	...
	*(uint8_t*)(v2 + 434) = 0;
	...
	a1 = *v4;
	*(uint16_t*)(v2 + 268) = (long long)((double)a1 * *getMemDoublePtr(0x581450, 9752) * *getMemDoublePtr(0x581450, 9736));
LABEL_24:
	*(uint32_t*)(v2 + 288) = 0;
	nox_xxx_spriteSetActiveMB_45A990_drawable(v2);
	return v7;
...
int sub_4ACEF0(int a1) {
	...
	if (v1) {
		...
		*(unaligned_float*)(v2 + 56) = (double)v6;
		v5 += 4;
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v6, 4u);
		*(unaligned_float*)(v2 + 60) = (double)v6;
		v5 += 4;
		nox_shape_box_calc((nox_shape*)(v2 + 44));
		v4[4] = 10;
		*v4 = 90;
	...
	do {
		result =
			(long long)(sin((double)(v0 + 192) * *getMemDoublePtr(0x581450, 9768) * *getMemDoublePtr(0x581450, 9760)) *
						*(unaligned_double*)&qword_581450_9552);
		*(uint32_t*)v1 = result;
		v1 += 4;
		++v0;
		...
		case 203:
			...
			*(uint32_t*)(v4 + 12) = v14;
			...
			nox_window_setPos_46A9B0(
				*(uint32_t**)(a1 + 400),
				(long long)((double)(int)(*(uint32_t*)(v4 + 12) - *(uint32_t*)v4) * *(unaligned_float*)(v4 + 8)), 0);
			return 1;
		case 205:
			if (a4 != 2) {
				return 1;
	...
	case 21:
		...
		case 0xC8u:
			...
			*(uint32_t*)(v4 + 12) = v12;
			...
			nox_window_setPos_46A9B0(
				*(uint32_t**)(a1 + 400), 0,
				(long long)((double)(int)(*(uint32_t*)(v4 + 4) - *(uint32_t*)(v4 + 12)) * *(unaligned_float*)(v4 + 8)));
			return 1;
		case 0xCBu:
			if (a4 == 2) {
				nox_xxx_wndRetNULL_0_46A8B0();
...
nox_window* nox_gui_newSlider_4B4EE0(int a1, int a2, int a3, int a4, int a5, int a6, uint32_t* a7, float* a8) {
	...
	if (v10) {
		...
		a8[2] = v12;
		v13 = (unaligned_float*)calloc(1, 0x10u);
		*v13 = *a8;
		v13[1] = a8[1];
		v13[2] = a8[2];
		v13[3] = a8[3];
...
int sub_4B5010(int a1, unsigned int a2, int a3, int a4) {
	...
	if (a2 > 0x4000) {
		if (a2 == 16394) {
			if (a3 >= *(int*)v5 && a3 <= *(int*)(v5 + 4)) {
				v17 = (double)a3;
				*(uint32_t*)(v5 + 12) = a3;
				nox_window_setPos_46A9B0(*(uint32_t**)(v4 + 400), (long long)(v17 * *(unaligned_float*)(v5 + 8)), 0);
			}
		} else if (a2 == 16395) {
			v14 = a3;
			v15 = a4;
			...
			*(uint32_t*)(v5 + 12) = v14;
			a3 = v15 - v14;
			*(unaligned_float*)(v5 + 8) = (double)v16 / (double)(v15 - v14);
	...
	if (a2 == 0x4000) {
		...
		if (v10 < v12 + a3) {
			a4 = v10 - a3;
			v13 = (long long)((double)(v10 - a3) / *(unaligned_float*)(v5 + 8));
			v11 = *(uint32_t*)(v5 + 4);
			*(uint32_t*)(v5 + 12) = v13;
			if ((int)v13 > v11) {
				*(uint32_t*)(v5 + 12) = v11;
...
int nox_xxx_wndScrollBoxProc_4B5320(int a1, unsigned int a2, int a3, unsigned int a4) {
		...
		if (a2 == 16394) {
			if (a3 >= *(int*)v5) {
				...
				if (a3 <= v18) {
					...
					*(uint32_t*)(v5 + 12) = a3;
					a3 = v19;
					nox_window_setPos_46A9B0(*(uint32_t**)(v4 + 400), 0, (long long)((double)v19 * *(unaligned_float*)(v5 + 8)));
				}
			}
		} else if (a2 == 16395) {
			v14 = a4;
			...
			*(uint32_t*)(v5 + 12) = v15;
			v17 = (double)a3;
			a3 = v16 - 10;
			*(unaligned_float*)(v5 + 8) = (double)(v16 - 10) / v17;
			nox_window_setPos_46A9B0(*(uint32_t**)(v4 + 400), 0, (long long)(v17 * *(unaligned_float*)(v5 + 8)));
			return 0;
		}
		return 0;
	}
	...
	if (v6 >= a3) {
		...
		if (v6 < v7 + a3) {
			a4 = v6 - a3;
			v8 = (long long)((double)(v6 - a3) / *(unaligned_float*)(v5 + 8));
			v9 = *(uint32_t*)(v5 + 4);
			*(uint32_t*)(v5 + 12) = v8;
			if ((int)v8 > v9) {
				*(uint32_t*)(v5 + 12) = v9;
